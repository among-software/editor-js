import Ze, { useDebugValue as zs, createElement as Ca, useRef as to, useContext as Ba, useState as Go, useEffect as Zo, memo as Ta } from "react";
...
`), Pe = K.stack.split(`
`), ve = Z.length - 1, fe = Pe.length - 1; ve >= 1 && fe >= 0 && Z[ve] !== Pe[fe]; )
            fe--;
          for (; ve >= 1 && fe >= 0; ve--, fe--)
            if (Z[ve] !== Pe[fe]) {
              if (ve !== 1 || fe !== 1)
                do
                  if (ve--, fe--, fe < 0 || Z[ve] !== Pe[fe]) {
                    var De = `
` + Z[ve].replace(" at new ", " at ");
          ...
          if (ae(p, ee)) {
            ...
            try {
              if (typeof p[ee] != "function") {
                var Pe = Error((K || "React class") + ": " + M + " type `" + ee + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof p[ee] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
    ...
    function Is(p) {
      if (ca(p))
        return E("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", aa(p)), Ps(p);
    }
    var Os = L.ReactCurrentOwner, la = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function ga(p, T) {
      typeof p.ref == "string" && Os.current;
    }
    function pa(p, T) {
      {
        var M = function() {
          As || (As = !0, E("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", T));
        };
    ...
    function ha(p, T) {
      {
        var M = function() {
          Ls || (Ls = !0, E("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", T));
        };
    ...
    var ma = function(p, T, M, K, te, ae, ee) {
      var Z = {
    ...
    function va(p, T, M, K, te) {
      {
        var ae, ee = {}, Z = null, Pe = null;
        M !== void 0 && (Is(M), Z = "" + M), ua(T) && (Is(T.key), Z = "" + T.key), da(T) && (Pe = T.ref, ga(T, te));
        for (ae in T)
          Fe.call(T, ae) && !la.hasOwnProperty(ae) && (ee[ae] = T[ae]);
        if (p && p.defaultProps) {
        ...
        if (Z || Pe) {
          ...
          Z && pa(ee, fe), Pe && ha(ee, fe);
        }
        return ma(p, Z, Pe, te, K, Os.current, ee);
      }
    }
    var Hi = L.ReactCurrentOwner, Ns = L.ReactDebugCurrentFrame;
    function ko(p) {
      if (p) {
        var T = p._owner, M = be(p.type, p._source, T ? T.type : null);
    ...
    function Hs(p, T, M, K, te, ae) {
      {
        ...
        if (Fe.call(T, "key")) {
          var no = y(p), Ae = Object.keys(T).filter(function(Ea) {
            return Ea !== "key";
          }), qi = Ae.length > 0 ? "{key: someKey, " + Ae.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!$s[no + qi]) {
            var Sa = Ae.length > 0 ? "{" + Ae.join(": ..., ") + ": ...}" : "{}";
            E(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, qi, no, Sa, no), $s[no + qi] = !0;
          }
        }
...
var La = /^((children|dangerouslySetInnerHTML|key|ref|autoFocus|defaultValue|defaultChecked|innerHTML|suppressContentEditableWarning|suppressHydrationWarning|valueLink|abbr|accept|acceptCharset|accessKey|action|allow|allowUserMedia|allowPaymentRequest|allowFullScreen|allowTransparency|alt|async|autoComplete|autoPlay|capture|cellPadding|cellSpacing|challenge|charSet|checked|cite|classID|className|cols|colSpan|content|contentEditable|contextMenu|controls|controlsList|coords|crossOrigin|data|dateTime|decoding|default|defer|dir|disabled|disablePictureInPicture|disableRemotePlayback|download|draggable|encType|enterKeyHint|form|formAction|formEncType|formMethod|formNoValidate|formTarget|frameBorder|headers|height|hidden|high|href|hrefLang|htmlFor|httpEquiv|id|inputMode|integrity|is|keyParams|keyType|kind|label|lang|list|loading|loop|low|marginHeight|marginWidth|max|maxLength|media|mediaGroup|method|min|minLength|multiple|muted|name|nonce|noValidate|open|optimum|pattern|placeholder|playsInline|poster|preload|profile|radioGroup|readOnly|referrerPolicy|rel|required|reversed|role|rows|rowSpan|sandbox|scope|scoped|scrolling|seamless|selected|shape|size|sizes|slot|span|spellCheck|src|srcDoc|srcLang|srcSet|start|step|style|summary|tabIndex|target|title|translate|type|useMap|value|width|wmode|wrap|about|datatype|inlist|prefix|property|resource|typeof|vocab|autoCapitalize|autoCorrect|autoSave|color|incremental|fallback|inert|itemProp|itemScope|itemType|itemID|itemRef|on|option|results|security|unselectable|accentHeight|accumulate|additive|alignmentBaseline|allowReorder|alphabetic|amplitude|arabicForm|ascent|attributeName|attributeType|autoReverse|azimuth|baseFrequency|baselineShift|baseProfile|bbox|begin|bias|by|calcMode|capHeight|clip|clipPathUnits|clipPath|clipRule|colorInterpolation|colorInterpolationFilters|colorProfile|colorRendering|contentScriptType|contentStyleType|cursor|cx|cy|d|decelerate|descent|diffuseConstant|direction|display|divisor|dominantBaseline|dur|dx|dy|edgeMode|elevation|enableBackground|end|exponent|externalResourcesRequired|fill|fillOpacity|fillRule|filter|filterRes|filterUnits|floodColor|floodOpacity|focusable|fontFamily|fontSize|fontSizeAdjust|fontStretch|fontStyle|fontVariant|fontWeight|format|from|fr|fx|fy|g1|g2|glyphName|glyphOrientationHorizontal|glyphOrientationVertical|glyphRef|gradientTransform|gradientUnits|hanging|horizAdvX|horizOriginX|ideographic|imageRendering|in|in2|intercept|k|k1|k2|k3|k4|kernelMatrix|kernelUnitLength|kerning|keyPoints|keySplines|keyTimes|lengthAdjust|letterSpacing|lightingColor|limitingConeAngle|local|markerEnd|markerMid|markerStart|markerHeight|markerUnits|markerWidth|mask|maskContentUnits|maskUnits|mathematical|mode|numOctaves|offset|opacity|operator|order|orient|orientation|origin|overflow|overlinePosition|overlineThickness|panose1|paintOrder|pathLength|patternContentUnits|patternTransform|patternUnits|pointerEvents|points|pointsAtX|pointsAtY|pointsAtZ|preserveAlpha|preserveAspectRatio|primitiveUnits|r|radius|refX|refY|renderingIntent|repeatCount|repeatDur|requiredExtensions|requiredFeatures|restart|result|rotate|rx|ry|scale|seed|shapeRendering|slope|spacing|specularConstant|specularExponent|speed|spreadMethod|startOffset|stdDeviation|stemh|stemv|stitchTiles|stopColor|stopOpacity|strikethroughPosition|strikethroughThickness|string|stroke|strokeDasharray|strokeDashoffset|strokeLinecap|strokeLinejoin|strokeMiterlimit|strokeOpacity|strokeWidth|surfaceScale|systemLanguage|tableValues|targetX|targetY|textAnchor|textDecoration|textRendering|textLength|to|transform|u1|u2|underlinePosition|underlineThickness|unicode|unicodeBidi|unicodeRange|unitsPerEm|vAlphabetic|vHanging|vIdeographic|vMathematical|values|vectorEffect|version|vertAdvY|vertOriginX|vertOriginY|viewBox|viewTarget|visibility|widths|wordSpacing|writingMode|x|xHeight|x1|x2|xChannelSelector|xlinkActuate|xlinkArcrole|xlinkHref|xlinkRole|xlinkShow|xlinkTitle|xlinkType|xmlBase|xmlns|xmlnsXlink|xmlLang|xmlSpace|y|y1|y2|yChannelSelector|z|zoomAndPan|for|class|autofocus)|(([Dd][Aa][Tt][Aa]|[Aa][Rr][Ii][Aa]|x)-.*))$/, Na = /* @__PURE__ */ Aa(
  ...
  /* Z+1 */
), ce = "-ms-", Vo = "-moz-", se = "-webkit-", Bn = "comm", Ti = "rule", Bt = "decl", Ma = "@import", Tn = "@keyframes", Fa = "@layer", Pn = Math.abs, Tt = String.fromCharCode, nt = Object.assign;
function Da(t, e) {
...
function di(t, e, o, i, s, n, r, a, c) {
  for (var l = 0, d = 0, u = r, g = 0, v = 0, h = 0, f = 1, I = 1, L = 1, E = 0, H = "", D = s, A = n, B = i, C = H; I; )
    switch (h = E, E = ze()) {
      case 40:
        if (h != 108 && ke(C, u - 1) == 58) {
          ci(C += J(Wi(E), "&", "&\f"), "&\f", Pn(l ? a[l - 1] : 0)) != -1 && (L = -1);
          break;
        }
      case 34:
      case 39:
      ...
      case 0:
        switch (E) {
          ...
          case 125:
            I = 0;
          case 59 + d:
            L == -1 && (C = J(C, /\f/g, "")), v > 0 && We(C) - u && Uo(v > 32 ? Ks(C + ";", i, o, u - 1, c) : Ks(J(C, " ", "") + ";", i, o, u - 2, c), c);
            break;
          case 59:
            C += ";";
          default:
            if (Uo(B = Vs(C, e, o, l, d, s, a, H, D = [], A = [], u, n), n), E === 123)
              if (d === 0)
                di(C, e, B, B, D, n, u, a, A);
              else
                switch (g === 99 && ke(C, 3) === 110 ? 100 : g) {
                  ...
                  case 109:
                  case 115:
                    di(t, B, B, i && Uo(Vs(t, B, B, 0, 0, s, a, H, s, D = [], u, A), A), s, A, u, a, i ? D : A);
                    break;
                  default:
                    di(C, B, B, B, [""], A, 0, a, A);
                }
        }
        l = d = v = 0, f = L = 1, H = C = "", u = r;
        break;
      case 58:
        u = 1 + We(C), v = h;
      default:
...
function Vs(t, e, o, i, s, n, r, a, c, l, d, u) {
  for (var g = s - 1, v = s === 0 ? n : [""], h = On(v), f = 0, I = 0, L = 0; f < i; ++f)
    for (var E = 0, H = Bo(t, g + 1, g = Pn(I = r[f])), D = t; E < h; ++E)
      (D = In(I > 0 ? v[E] + " " + H : J(H, /&\f/g, v[E]))) && (c[L++] = D);
  return Ii(t, e, o, s === 0 ? Ti : a, c, l, d, u);
}
function Ga(t, e, o, i) {
  return Ii(t, e, o, Bn, Tt($a()), Bo(t, 2, -2), 0, i);
}
function Ks(t, e, o, i, s) {
  return Ii(t, e, o, Bt, Bo(t, 0, i), Bo(t, i + 1, -1), i, s);
}
function Ln(t, e, o) {
  switch (Da(t, e)) {
    case 5103:
        ...
        if (t.length)
          return Ra(o = t.props, function(s) {
            switch (Ye(s, i = /(::plac\w+|:read-\w+)/)) {
              case ":read-only":
              case ":read-write":
                jo(oo(t, { props: [J(s, /:(read-\w+)/, ":" + Vo + "$1")] })), jo(oo(t, { props: [s] })), nt(t, { props: Ws(o, i) });
                break;
              case "::placeholder":
                jo(oo(t, { props: [J(s, /:(plac\w+)/, ":" + se + "input-$1")] })), jo(oo(t, { props: [J(s, /:(plac\w+)/, ":" + Vo + "$1")] })), jo(oo(t, { props: [J(s, /:(plac\w+)/, ce + "input-$1")] })), jo(oo(t, { props: [s] })), nt(t, { props: Ws(o, i) });
                break;
            }
            return "";
          });
...
var ec = {
  ...
  strokeOpacity: 1,
  strokeWidth: 1
}, _o = typeof process < "u" && process.env !== void 0 && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", Nn = "active", Mn = "data-styled-version", Ai = "6.1.13", Pt = `/*!sc*/
`, bi = typeof window < "u" && "HTMLElement" in window, oc = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : process.env.NODE_ENV !== "production"), Ys = /invalid hook call/i, ti = /* @__PURE__ */ new Set(), ic = function(t, e) {
...
To resolve this only create new StyledComponents outside of any render method and function component.`, s = console.error;
    try {
      ...
      console.error = function(r) {
        ...
        Ys.test(r) ? (n = !1, ti.delete(i)) : s.apply(void 0, Co([r], a, !1));
      }, to(), n && !ti.has(i) && (console.warn(i), ti.add(i));
    } catch (r) {
      Ys.test(r.message) && ti.delete(i);
    } finally {
      console.error = s;
    }
  }
...
var rc = /(a)(d)/gi, si = 52, Xs = function(t) {
  return String.fromCharCode(t + (t > 25 ? 39 : 97));
};
function lt(t) {
  var e, o = "";
  for (e = Math.abs(t); e > si; e = e / si | 0) o = Xs(e % si) + o;
  return (Xs(e % si) + o).replace(rc, "$1-$2");
}
...
var gc = Object.defineProperty, pc = Object.getOwnPropertyNames, Zs = Object.getOwnPropertySymbols, hc = Object.getOwnPropertyDescriptor, mc = Object.getPrototypeOf, Qs = Object.prototype;
function Un(t, e, o) {
  if (typeof e != "string") {
    if (Qs) {
      var i = mc(e);
    ...
    var s = pc(e);
    Zs && (s = s.concat(Zs(e)));
    for (var n = Js(t), r = Js(e), a = 0; a < s.length; ++a) {
      var c = s[a];
...
var fc = function() {
  ...
  return t.prototype.indexOfGroup = function(e) {
    ...
    for (var i = this.groupSizes[e], s = this.indexOfGroup(e), n = s + i, r = s; r < n; r++) o += "".concat(this.tag.getRule(r)).concat(Pt);
    return o;
  }, t;
  ...
  for (var o, i = ((o = e.textContent) !== null && o !== void 0 ? o : "").split(Pt), s = [], n = 0, r = i.length; n < r; n++) {
    var a = i[n].trim();
    if (a) {
      var c = a.match(wc);
      if (c) {
...
var qn = function(t) {
...
}(), tn = bi, Tc = { isServer: !bi, useCSSOMInjection: !oc }, Wn = function() {
  function t(e, o, i) {
    e === void 0 && (e = Po), o === void 0 && (o = {});
    var s = this;
    this.options = Le(Le({}, Tc), e), this.gs = o, this.names = new Map(i), this.server = !!e.isServer, !this.server && bi && tn && (tn = !1, on(this)), Ot(this, function() {
      return function(n) {
        for (var r = n.getTag(), a = r.length, c = "", l = function(u) {
          ...
          }), c += "".concat(h).concat(f, '{content:"').concat(I, '"}').concat(Pt);
        }, d = 0; d < a; d++) l(d);
        return c;
      }(s);
    });
  ...
  return t.registerId = function(e) {
    ...
    !this.server && bi && on(this);
  }, t.prototype.reconstructWithOptions = function(e, o) {
    return o === void 0 && (o = !0), new t(Le(Le({}, this.options), e), this.gs, o && this.names || void 0);
...
function Oc(t) {
  ...
  var u = function(g, v, h, f) {
    ...
    var I = g.replace(Ic, ""), L = Ya(h || v ? "".concat(h, " ").concat(v, " { ").concat(I, " }") : I);
    r.namespace && (L = Vn(L, r.namespace));
    var E = [];
    return yi(L, Ja(d.concat(Za(function(H) {
      return E.push(H);
    })))), E;
  };
...
var nn = function() {
  function t(e, o) {
    ...
    }, this.name = e, this.id = "sc-keyframes-".concat(e), this.rules = o, Ot(this, function() {
...
var Yn = function(t) {
  ...
  for (var s in t) {
    var n = t[s];
    t.hasOwnProperty(s) && !Yn(n) && (Array.isArray(n) && n.isCss || Io(n) ? i.push("".concat(rn(s), ":"), n, ";") : Oo(n) ? i.push.apply(i, Co(Co(["".concat(s, " {")], Gn(n), !1), ["}"], !1)) : i.push("".concat(rn(s), ": ").concat((e = s, (o = n) == null || typeof o == "boolean" || o === "" ? "" : typeof o != "number" || o === 0 || e in ec || e.startsWith("--") ? String(o).trim() : "".concat(o, "px")), ";")));
  }
  return i;
};
function mo(t, e, o, i) {
  if (Yn(t)) return [];
  if (It(t)) return [".".concat(t.styledComponentId)];
  if (Io(t)) {
    if (!Io(n = t) || n.prototype && n.prototype.isReactComponent || !e) return [t];
    var s = t(e);
    return process.env.NODE_ENV === "production" || typeof s != "object" || Array.isArray(s) || s instanceof nn || Oo(s) || s === null || console.error("".concat(Rn(t), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), mo(s, e, o, i);
  }
  var n;
  return t instanceof nn ? o ? (t.inject(o, i), [t.getName(i)]) : [t] : Oo(t) ? Gn(t) : Array.isArray(t) ? Array.prototype.concat.apply(Li, t.map(function(r) {
    return mo(r, e, o, i);
  })) : [t.toString()];
}
function Nc(t) {
...
var Mc = Dn(Ai), Fc = function() {
  ...
  return t.prototype.generateAndInjectStyles = function(e, o, i) {
    ...
    if (this.isStatic && !i.hash) if (this.staticRulesId && o.hasNameForId(this.componentId, this.staticRulesId)) s = go(s, this.staticRulesId);
      ...
      var n = en(mo(this.rules, e, o, i)), r = lt(ro(this.baseHash, n) >>> 0);
...
Xn.Consumer;
var Yi = {}, an = /* @__PURE__ */ new Set();
function Dc(t, e, o) {
  var i = It(t), s = t, n = !Ki(t), r = e.attrs, a = r === void 0 ? Li : r, c = e.componentId, l = c === void 0 ? function(D, A) {
    var B = typeof D != "string" ? "sc" : Gs(D);
    Yi[B] = (Yi[B] || 0) + 1;
  ...
  }(t) : d, g = e.displayName && e.componentId ? "".concat(Gs(e.displayName), "-").concat(e.componentId) : e.componentId || l, v = i && s.attrs ? s.attrs.concat(a).filter(Boolean) : a, h = e.shouldForwardProp;
  ...
  var L = new Fc(o, g, i ? s.componentStyle : void 0);
  function E(D, A) {
    return function(B, C, x) {
      var j = B.attrs, _ = B.componentStyle, m = B.defaultProps, k = B.foldedComponentIds, y = B.styledComponentId, P = B.target, N = Ze.useContext(Xn), q = sn(), oe = B.shouldForwardProp || q.shouldForwardProp;
      process.env.NODE_ENV !== "production" && zs(y);
      var V = tc(C, N, m) || Po, re = function(Se, le, S) {
        for (var w, O = Le(Le({}, le), { className: void 0, theme: S }), U = 0; U < Se.length; U += 1) {
          var F = Io(w = Se[U]) ? w(O) : w;
          for (var X in F) O[X] = X === "className" ? go(O[X], F[X]) : X === "style" ? Le(Le({}, O[X]), F[X]) : F[X];
        }
        return le.className && (O.className = go(O.className, le.className)), O;
      }(j, C, V), ue = re.as || P, pe = {};
      for (var W in re) re[W] === void 0 || W[0] === "$" || W === "as" || W === "theme" && re.theme === V || (W === "forwardedAs" ? pe.as = re.forwardedAs : oe && !oe(W, ue) || (pe[W] = re[W], oe || process.env.NODE_ENV !== "development" || Na(W) || an.has(W) || !ct.has(ue) || (an.add(W), console.warn('styled-components: it looks like an unknown prop "'.concat(W, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      var ie = function(Se, le) {
        var S = sn(), w = Se.generateAndInjectStyles(le, S.styleSheet, S.stylis);
        return process.env.NODE_ENV !== "production" && zs(w), w;
      }(_, re);
  ...
  return H.attrs = v, H.componentStyle = L, H.displayName = u, H.shouldForwardProp = h, H.foldedComponentIds = i ? go(s.foldedComponentIds, s.styledComponentId) : "", H.styledComponentId = g, H.target = i ? s.target : t, Object.defineProperty(H, "defaultProps", { get: function() {
    return this._foldedDefaultProps;
  }, set: function(D) {
    this._foldedDefaultProps = i ? function(A) {
      for (var B = [], C = 1; C < arguments.length; C++) B[C - 1] = arguments[C];
      for (var x = 0, j = B; x < j.length; x++) dt(A, j[x], !0);
      return A;
    }({}, s.defaultProps, D) : D;
  } }), process.env.NODE_ENV !== "production" && (ic(u, g), H.warnTooManyClasses = /* @__PURE__ */ function(D, A) {
    var B = {}, C = !1;
    return function(x) {
...
function Rc(t) {
  for (var e = [], o = 1; o < arguments.length; o++) e[o - 1] = arguments[o];
  if (Io(t) || Oo(t)) return ln(mo(cn(Li, Co([t], e, !0))));
  var i = t;
  return e.length === 0 && i.length === 1 && typeof i[0] == "string" ? mo(i) : ln(mo(cn(i, e)));
}
function gt(t, e, o) {
  ...
  return i.attrs = function(s) {
    return gt(t, e, Le(Le({}, o), { attrs: Array.prototype.concat(o.attrs, s).filter(Boolean) }));
  }, i.withConfig = function(s) {
    return gt(t, e, Le(Le({}, o), s));
  }, i;
}
var Jn = function(t) {
  return gt(Dc, t);
...
function Yc() {
  const { editor: t, align: e, setAlign: o } = Be(), i = (n) => {
...
function fl({ addBlock: t }) {
  const [e, o] = Go([]), [i, s] = Go(0), n = 150, { closeModal: r } = Be(), a = (l) => {
    t("emoji", {
      emoji: l.emoji
    }), r();
  };
...
function Hl({ addBlock: t }) {
  const [e, o] = Go(""), [i, s] = Go([]), { closeModal: n } = Be(), r = async (d) => {
    const u = await $l(d);
    s(u);
  }, a = () => {
    o("");
...
function ql({ top: t, children: e }) {
  const { activeModal: o, closeModal: i } = Be(), { $ref: s } = Ul(
    () => {
      i();
    },
...
const Kl = G.button`
  ...
  width: 66px;
  height: 30px;
  border: 1px solid ${Ce.gray_primary};
  font-size: 12px;
  color: ${Ce.dark_gray};
  background-color: ${Ce.white_primary};
  z-index: 100;
`;
function Yl({ toolbarTop: t, onUpload: e }) {
  const { editor: o, activeModal: i, currentBlockIndex: s, setCurrentBlockIndex: n } = Be(), r = () => {
    if (!o) return;
    ...
    if (!o) return;
    const u = o.blocks.getBlockByIndex(s);
    (u == null ? void 0 : u.name) === "paragraph" && u.isEmpty ? (o.blocks.delete(s), o.blocks.insert(l, d, void 0, s)) : o.blocks.insert(l, d, void 0, s + 1);
  }, c = () => {
    o == null || o.save().then((l) => console.log("Article data: ", { ...l })).catch((l) => console.log("Saving failed: ", l));
  };
  return /* @__PURE__ */ $.jsxs($.Fragment, { children: [
    ...
    /* @__PURE__ */ $.jsxs(Vl, { position: { top: t, right: 0 }, children: [
      ...
      /* @__PURE__ */ $.jsx(Yc, {}),
      /* @__PURE__ */ $.jsx(Kl, { id: "save-btn", onClick: c, children: "저장" })
    ] })
  ] });
}
const Gl = G.div`
...
let Jl = (t = 21) => crypto.getRandomValues(new Uint8Array(t)).reduce((e, o) => (o &= 63, o < 36 ? e += o.toString(36) : o < 62 ? e += (o - 26).toString(36).toUpperCase() : o > 62 ? e += "-" : e += "_", e), "");
...
async function od(t, e = () => {
  ...
  async function i(s, n, r) {
    try {
      await s.function(s.data), await n(hn(s.data) ? {} : s.data);
    } catch {
      r(hn(s.data) ? {} : s.data);
    }
  }
...
class b {
  ...
  static isElement(e) {
    return pn(e) ? !1 : e && e.nodeType && e.nodeType === Node.ELEMENT_NODE;
  }
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static isFragment(e) {
    return pn(e) ? !1 : e && e.nodeType && e.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  /**
...
function lr(t, e) {
  return Object.entries(t).some(([o, i]) => e[o] && ld(e[o], i));
}
...
class we extends ei {
  ...
  async exportDataAsString() {
    ...
    return _d(e, this.tool.conversionConfig);
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (o) => {
      const { mutations: i } = o;
      i.some((s) => vd(s, this.toolRenderedElement)) && this.didMutated(i);
...
class Lt extends Q {
  ...
  getMethodsForTool(e, o) {
    return Object.assign(
      this.methods,
      {
        t: (i) => Oe.t(Lt.getNamespace(e, o), i)
      }
    );
  }
}
...
`);
      ...
      function E(x) {
        ...
        return x.attrs.type === void 0 && (x.attrs.type = "text/css"), H(j, x.attrs), I(x, j), j;
      }
      function H(x, j) {
      ...
      function D(x, j) {
        ...
        if (j.singleton) {
          ...
          x.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (_ = function(N) {
            ...
            return N.attrs.type === void 0 && (N.attrs.type = "text/css"), N.attrs.rel = "stylesheet", H(q, N.attrs), I(N, q), q;
          }(j), m = (function(N, q, oe) {
...
`);
      ...
      o.exports = (n = "cdx-notifies", r = "cdx-notify", a = "cdx-notify__cross", c = "cdx-notify__button--confirm", l = "cdx-notify__button--cancel", d = "cdx-notify__input", u = "cdx-notify__button", g = "cdx-notify__btns-wrapper", { alert: v = function(h) {
        ...
        var f = v(h), I = document.createElement("div"), L = document.createElement("button"), E = document.createElement("button"), H = f.querySelector("." + a), D = h.cancelHandler, A = h.okHandler;
        return I.classList.add(g), L.innerHTML = h.okText || "Confirm", E.innerHTML = h.cancelText || "Cancel", L.classList.add(u), E.classList.add(u), L.classList.add(c), E.classList.add(l), D && typeof D == "function" && (E.addEventListener("click", D), H.addEventListener("click", D)), A && typeof A == "function" && L.addEventListener("click", A), L.addEventListener("click", f.remove.bind(f)), E.addEventListener("click", f.remove.bind(f)), I.appendChild(L), I.appendChild(E), f.appendChild(I), f;
      }, prompt: function(h) {
        var f = v(h), I = document.createElement("div"), L = document.createElement("button"), E = document.createElement("input"), H = f.querySelector("." + a), D = h.cancelHandler, A = h.okHandler;
        return I.classList.add(g), L.innerHTML = h.okText || "Ok", L.classList.add(u), L.classList.add(c), E.classList.add(d), h.placeholder && E.setAttribute("placeholder", h.placeholder), h.default && (E.value = h.default), h.inputType && (E.type = h.inputType), D && typeof D == "function" && H.addEventListener("click", D), A && typeof A == "function" && L.addEventListener("click", function() {
          A(E.value);
    ...
    o.prototype.clean = function(u) {
      ...
      if (h)
        do {
          ...
          var L = !!g.parentNode, E = s(g) && s(h) && L, H = h.nodeName.toLowerCase(), D = c(this.config, H, h), A = f && I;
...
var Pd = gr.exports;
const Id = /* @__PURE__ */ Ni(Pd);
function Nt(t, e) {
  return t.map((o) => {
    const i = ge(e) ? e(o.tool) : e;
    return He(i) || (o.data = Mt(o.data, i)), o;
  });
}
function Ve(t, e = {}) {
  const o = {
  ...
  return new Id(o).clean(t);
}
function Mt(t, e) {
  return Array.isArray(t) ? Od(t, e) : je(t) ? Ad(t, e) : Qe(t) ? Ld(t, e) : t;
}
function Od(t, e) {
  return t.map((o) => Mt(o, e));
}
function Ad(t, e) {
  const o = {};
  for (const i in t) {
...
var zd = pr.exports;
const Ud = /* @__PURE__ */ Ni(zd);
let Ue = null;
function Ft() {
  Ue || (Ue = new Ud());
}
function qd(t, e, o) {
  Ft(), Ue == null || Ue.show(t, e, o);
}
function Si(t = !1) {
  Ft(), Ue == null || Ue.hide(t);
}
function Ei(t, e, o) {
  Ft(), Ue == null || Ue.onHover(t, e, o);
}
function Wd() {
...
const Gd = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 12L9 7.1C9 7.04477 9.04477 7 9.1 7H10.4C11.5 7 14 7.1 14 9.5C14 9.5 14 12 11 12M9 12V16.8C9 16.9105 9.08954 17 9.2 17H12.5C14 17 15 16 15 14.5C15 11.7046 11 12 11 12M9 12H11"/></svg>', Xd = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', Jd = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.5 17.5L9.64142 12.6414C9.56331 12.5633 9.56331 12.4367 9.64142 12.3586L14.5 7.5"/></svg>', Zd = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9.58284 17.5L14.4414 12.6414C14.5195 12.5633 14.5195 12.4367 14.4414 12.3586L9.58284 7.5"/></svg>', Qd = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 15L11.8586 10.1414C11.9367 10.0633 12.0633 10.0633 12.1414 10.1414L17 15"/></svg>', eu = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>', ou = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>', iu = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13.34 10C12.4223 12.7337 11 17 11 17"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.21 7H14.2"/></svg>', fn = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.69998 12.6L7.67896 12.62C6.53993 13.7048 6.52012 15.5155 7.63516 16.625V16.625C8.72293 17.7073 10.4799 17.7102 11.5712 16.6314L13.0263 15.193C14.0703 14.1609 14.2141 12.525 13.3662 11.3266L13.22 11.12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16.22 11.12L16.3564 10.9805C17.2895 10.0265 17.3478 8.5207 16.4914 7.49733V7.49733C15.5691 6.39509 13.9269 6.25143 12.8271 7.17675L11.3901 8.38588C10.0935 9.47674 9.95706 11.4241 11.0888 12.6852L11.12 12.72"/></svg>', tu = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 7.29999H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 7.29999H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.30999 12H9.3"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 12H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 16.7H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 16.7H14.59"/></svg>', su = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>', vr = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M11.5 17.5L5 11M5 11V15.5M5 11H9.5"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12.5 6.5L19 13M19 13V8.5M19 13H14.5"/></svg>', nu = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="5.5" stroke="currentColor" stroke-width="2"/><line x1="15.4142" x2="19" y1="15" y2="18.5858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', ru = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15.7795 11.5C15.7795 11.5 16.053 11.1962 16.5497 10.6722C17.4442 9.72856 17.4701 8.2475 16.5781 7.30145V7.30145C15.6482 6.31522 14.0873 6.29227 13.1288 7.25073L11.8796 8.49999"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8.24517 12.3883C8.24517 12.3883 7.97171 12.6922 7.47504 13.2161C6.58051 14.1598 6.55467 15.6408 7.44666 16.5869V16.5869C8.37653 17.5731 9.93744 17.5961 10.8959 16.6376L12.1452 15.3883"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17.7802 15.1032L16.597 14.9422C16.0109 14.8624 15.4841 15.3059 15.4627 15.8969L15.4199 17.0818"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6.39064 9.03238L7.58432 9.06668C8.17551 9.08366 8.6522 8.58665 8.61056 7.99669L8.5271 6.81397"/><line x1="12.1142" x2="11.7" y1="12.2" y2="11.7858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', au = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><line x1="12" x2="12" y1="9" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 15.02V15.01"/></svg>', cu = "__", lu = "--";
function so(t) {
  return (e, o) => [[t, e].filter((i) => !!i).join(cu), o].filter((i) => !!i).join(lu);
}
...
const Ne = so("ce-popover-item"), he = {
  container: Ne(),
...
const Ie = so("ce-popover"), _e = {
  popover: Ie(),
  popoverContainer: Ie("container"),
  popoverOpenTop: Ie(null, "open-top"),
  popoverOpenLeft: Ie(null, "open-left"),
  popoverOpened: Ie(null, "opened"),
  search: Ie("search"),
  nothingFoundMessage: Ie("nothing-found-message"),
  nothingFoundMessageDisplayed: Ie("nothing-found-message", "displayed"),
  items: Ie("items"),
  overlay: Ie("overlay"),
  overlayHidden: Ie("overlay", "hidden"),
  popoverNested: Ie(null, "nested"),
  getPopoverNestedClass: (t) => Ie(null, `nested-level-${t.toString()}`),
  popoverInline: Ie(null, "inline"),
  popoverHeader: Ie("header")
};
...
const yn = so("ce-popover-item-html"), bn = {
  root: yn(),
  hidden: yn(null, "hidden")
};
class Jo extends Dt {
  /**
   * Constructs the instance
  ...
  toggleHidden(e) {
    var o;
    (o = this.nodes.root) == null || o.classList.toggle(bn.hidden, e);
  }
  /**
...
var gu = Object.defineProperty, pu = Object.getOwnPropertyDescriptor, hu = (t, e, o, i) => {
...
class _u {
  ...
  constructor({ text: e, onBackButtonClick: o }) {
    ...
    }, this.nodes.backButton.innerHTML = Jd, this.nodes.root.appendChild(this.nodes.backButton), this.listeners.on(this.nodes.backButton, "click", this.onBackButtonClick), this.nodes.text.innerText = this.text, this.nodes.root.appendChild(this.nodes.text);
  }
  /**
...
class wr extends fr {
  ...
  constructor(e) {
    ...
    }), this.scrollLocker = new vu(), this.history = new fu(), this.isHidden = !0, this.nodes.overlay = b.make("div", [_e.overlay, _e.overlayHidden]), this.nodes.popover.insertBefore(this.nodes.overlay, this.nodes.popover.firstChild), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
...
class yu extends Q {
  ...
  async open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.popover = new n({
      ...
      messages: {
        nothingFound: Oe.ui(Me.ui.popover, "Nothing found"),
        search: Oe.ui(Me.ui.popover, "Filter")
      }
  ...
  async getTunesItems(e, o, i) {
    ...
    const n = Array.from(this.Editor.Tools.blockTools.values()), r = (await dr(e, n)).reduce((a, c) => (c.toolbox.forEach((l) => {
      a.push({
        icon: l.icon,
        title: Oe.t(Me.toolNames, l.title),
        name: c.name,
        closeOnActivate: !0,
        onActivate: async () => {
    ...
    return r.length > 0 && (s.push({
      icon: vr,
      name: "convert-to",
      title: Oe.ui(Me.ui.popover, "Convert to"),
      children: {
        searchable: !0,
        items: r
      }
...
const Ao = new wu();
var ju = Object.defineProperty, xu = Object.getOwnPropertyDescriptor, xr = (t, e, o, i) => {
...
const $t = class Sr extends ei {
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (o, i) => ({
      icon: o.icon,
      title: Oe.t(Me.toolNames, o.title || ji(i.name)),
      name: i.name,
      onActivate: () => {
        this.toolButtonActivated(i.name, o.data);
      },
      secondaryLabel: i.shortcut ? At(i.shortcut) : ""
    });
...
xr([
  Mo
], $t.prototype, "toolsToBeDisplayed");
xr([
  Mo
], $t.prototype, "toolboxItemsToBeDisplayed");
let Su = $t;
...
class Cu extends Q {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    if (i)
      ...
      const u = ud(r), g = parseInt(window.getComputedStyle(this.nodes.plusButton).height, 10);
  ...
  async make() {
    ...
    const e = b.make("div");
    e.appendChild(document.createTextNode(Oe.ui(Me.ui.toolbar.toolbox, "Add"))), e.appendChild(b.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    ...
    const o = b.make("div"), i = b.text(Oe.ui(Me.ui.blockTunes.toggler, "Click to tune")), s = await Eu("Slash", "/");
    o.appendChild(i), o.appendChild(b.make("div", this.CSS.plusButtonShortcut, {
      textContent: At(`CMD + ${s}`)
   ...
   */
  makeToolbox() {
    return this.toolboxInstance = new Su({
      api: this.Editor.API.methods,
      tools: this.Editor.Tools.blockTools,
      i18nLabels: {
        filter: Oe.ui(Me.ui.popover, "Filter"),
        nothingFound: Oe.ui(Me.ui.popover, "Nothing found")
      }
...
class Bu extends Q {
  ...
  async getInlineTools() {
    ...
    for (let n = 0; n < i.length; n++) {
      ...
      const d = l !== void 0 ? At(l) : void 0, u = Oe.t(
        Me.toolNames,
        r.title || ji(r.name)
      );
      [c].flat().forEach((g) => {
  ...
  backspace(e) {
    ...
    if (!(s === void 0 || !z.isCollapsed || !s.currentInput || !mi(s.currentInput))) {
      ...
      if (n !== null) {
        ...
        vn(n, s) ? this.mergeBlocks(n, s) : i.setToBlock(n, i.positions.END);
      }
    }
  }
  /**
  ...
  delete(e) {
    ...
    if (!(!z.isCollapsed || !vi(s.currentInput))) {
      ...
      if (n !== null) {
        ...
        vn(s, n) ? this.mergeBlocks(s, n) : i.setToBlock(n, i.positions.START);
      }
    }
  }
  /**
...
const kn = "block-removed", wn = "block-added", Pu = "block-moved", jn = "block-changed";
class Iu {
  constructor() {
...
class Ou extends Q {
  ...
  insert({
    ...
    return r && this.blockDidMutated(kn, this.getBlockByIndex(c), {
      index: c
    }), this._blocks.insert(c, l, r), this.blockDidMutated(wn, l, {
      index: c
  ...
  async update(e, o, i) {
    ...
    return this._blocks.replace(r, n), this.blockDidMutated(jn, n, {
      index: r
    }), n;
  }
  /**
  ...
  insertDefaultBlockAtIndex(e, o = !1) {
    ...
    return this._blocks[e] = i, this.blockDidMutated(wn, i, {
      index: e
  ...
  removeBlock(e, o = !0) {
    return new Promise((i) => {
      ...
      e.destroy(), this._blocks.remove(s), this.blockDidMutated(kn, e, {
        index: s
  ...
  move(e, o = this.currentBlockIndex) {
    ...
    this._blocks.move(e, o), this.currentBlockIndex = e, this.blockDidMutated(Pu, this.currentBlock, {
      fromIndex: o,
      toIndex: e
    });
  }
  ...
  bindBlockEvents(e) {
    ...
    this.readOnlyMutableListeners.on(e.holder, "keydown", (i) => {
      ...
      o.dragLeave(i);
    }), e.on("didMutated", (i) => this.blockDidMutated(jn, i, {
...
class Du extends Q {
  ...
  constructor({ config: e, eventsDispatcher: o }) {
    super({
      config: e,
      eventsDispatcher: o
    }), this.disabled = !1, this.batchingTimeout = null, this.batchingOnChangeQueue = /* @__PURE__ */ new Map(), this.batchTime = Fu, this.mutationObserver = new MutationObserver((i) => {
...
const Pr = class Ir extends Q {
  ...
  getFilesConfig(e) {
    ...
    !i && !s || (i && !Array.isArray(i) && (ne(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), s && !Array.isArray(s) && (ne(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), s = []), s && (s = s.filter((n) => td(n) ? !0 : (ne(`MIME type value «${n}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: i || [],
      mimeTypes: s || []
    });
  }
   ...
   */
  async processFile(e) {
    const o = id(e), i = Object.entries(this.toolsFiles).find(([n, { mimeTypes: r, extensions: a }]) => {
...
class zu extends Q {
  ...
  async save() {
    ...
    try {
      ...
      const n = await Promise.all(s), r = await Nt(n, (a) => o.blockTools.get(a).sanitizeConfig);
...
const Uu = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
function qu(t) {
...
class Ut {
  ...
  constructor({ data: e, config: o, api: i, readOnly: s }) {
    ...
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = o.placeholder ? o.placeholder : Ut.DEFAULT_PLACEHOLDER, this._data = e ?? {}, this._element = null, this._preserveBlank = o.preserveBlank ?? !1;
  }
  /**
...
class Wt {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = iu, this.nodes.button;
  }
  /**
...
class Vt {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = fn, this.nodes.button;
  }
  /**
   * Input for the link
   */
  ...
  checkState() {
    ...
    if (e) {
      this.nodes.button.innerHTML = ru, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
      const o = e.getAttribute("href");
      this.nodes.input.value = o !== "null" ? o : "", this.selection.save();
    } else
      this.nodes.button.innerHTML = fn, this.nodes.button.classList.remove(this.CSS.buttonUnlink), this.nodes.button.classList.remove(this.CSS.buttonActive);
    return !!e;
  }
  /**
  ...
  async render() {
    ...
    const n = s.reduce((l, d) => {
      ...
      return (u = d.toolbox) == null || u.forEach((g) => {
        l.push({
          icon: g.icon,
          title: Oe.t(Me.toolNames, g.title),
          name: d.name,
          closeOnActivate: !0,
          onActivate: async () => {
...
class Ar {
   ...
   */
  make() {
    const e = b.make("div", this.CSS.wrapper), o = au, i = b.make("div", this.CSS.info), s = b.make("div", this.CSS.title, {
...
class Wu extends zt {
   ...
   */
  get title() {
    return this.constructable[Ht.Title];
  }
  /**
...
var Ku = Object.defineProperty, Yu = Object.getOwnPropertyDescriptor, Lr = (t, e, o, i) => {
...
Lr([
  Mo
], Kt.prototype, "sanitizeConfig");
Lr([
  Mo
], Kt.prototype, "baseSanitizeConfig");
class Gu {
  /**
   * @class
...
Fr.isTune = !0;
var Xu = Object.defineProperty, Ju = Object.getOwnPropertyDescriptor, Zu = (t, e, o, i) => {
...
class Dr extends Q {
  ...
  async prepare() {
    ...
    this.factory = new Gu(e, this.config, this.Editor.API);
...
class eg extends Q {
  ...
  redactorClicked(e) {
    ...
    if (b.isAnchor(o) && i) {
      ...
      const s = o.getAttribute("href"), n = nd(s);
      ad(n);
      return;
    }
...
class ig {
  ...
  set configuration(e) {
    ...
    je(e) ? this.config = {
      ...
      holder: e
    }, mt(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = Zn.VERBOSE), Ql(this.config.logLevel), mt(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const s = {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (He(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [s] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && Oe.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
...
`, ""]);
      ...
      function l(u, g) {
        for (var v = {}, h = [], f = 0; f < u.length; f++) {
          var I = u[f], L = g.base ? I[0] + g.base : I[0], E = v[L] || 0, H = "".concat(L, " ").concat(E);
          v[L] = E + 1;
          var D = c(H), A = { css: I[1], media: I[2], sourceMap: I[3], supports: I[4], layer: I[5] };
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(f)))), " */")), u.styleTagTransform(v, d, u.options);
    ...
    return (() => {
      s.d(n, { default: () => C });
      var r = s(72), a = s.n(r), c = s(825), l = s.n(c), d = s(659), u = s.n(d), g = s(56), v = s.n(g), h = s(540), f = s.n(h), I = s(113), L = s.n(I), E = s(523), H = {};
      function D(x) {
      ...
      H.styleTagTransform = L(), H.setAttributes = v(), H.insert = u().bind(null, "head"), H.domAPI = l(), H.insertStyleElement = f(), a()(E.A, H), E.A && E.A.locals && E.A.locals;
      var C = function() {
    ...
    var o = { 917: function(r, a) {
      ...
      function d() {
        ...
        var u, g = {}, v = Object.prototype, h = v.hasOwnProperty, f = Object.defineProperty || function(S, w, O) {
          S[w] = O.value;
        }, I = typeof Symbol == "function" ? Symbol : {}, L = I.iterator || "@@iterator", E = I.asyncIterator || "@@asyncIterator", H = I.toStringTag || "@@toStringTag";
        function D(S, w, O) {
        ...
        return y.prototype = P, f(V, "constructor", { value: P, configurable: !0 }), f(P, "constructor", { value: y, configurable: !0 }), y.displayName = D(P, H, "GeneratorFunction"), g.isGeneratorFunction = function(S) {
          var w = typeof S == "function" && S.constructor;
          return !!w && (w === y || (w.displayName || w.name) === "GeneratorFunction");
        }, g.mark = function(S) {
          return Object.setPrototypeOf ? Object.setPrototypeOf(S, P) : (S.__proto__ = P, D(S, H, "GeneratorFunction")), S.prototype = Object.create(V), S;
        }, g.awrap = function(S) {
          return { __await: S };
        ...
        }, re(V), D(V, H, "Generator"), D(V, L, function() {
          return this;
          ...
          for (var U = this.tryEntries.length - 1; U >= 0; --U) {
            ...
            if (F.tryLoc <= this.prev) {
              var me = h.call(F, "catchLoc"), Te = h.call(F, "finallyLoc");
              if (me && Te) {
                ...
                if (!Te) throw Error("try statement without catch or finally");
                if (this.prev < F.finallyLoc) return O(F.finallyLoc);
              }
            }
          }
    ...
    return (() => {
      ...
      var D = function() {
        return g(function _(m) {
          ...
          }, config: { debounceTimer: 200, shortcuts: { undo: ["CMD+Z"], redo: ["CMD+Y", "CMD+SHIFT+Z"] } } }, re = y.blocks, ue = y.caret, pe = y.configuration, W = pe.holder, ie = pe.defaultBlock, xe = V.config.shortcuts, Se = N.shortcuts, le = H(H({}, xe), Se), S = Array.isArray(le.undo) ? le.undo : [le.undo], w = Array.isArray(le.redo) ? le.redo : [le.redo], O = V.config.debounceTimer, U = N.debounceTimer, F = U === void 0 ? O : U;
...
const ug = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M19 17V10.2135C19 10.1287 18.9011 10.0824 18.836 10.1367L16 12.5"/></svg>', gg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 11C16 10 19 9.5 19 12C19 13.9771 16.0684 13.9997 16.0012 16.8981C15.9999 16.9533 16.0448 17 16.1 17L19.3 17"/></svg>', pg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 11C16 10.5 16.8323 10 17.6 10C18.3677 10 19.5 10.311 19.5 11.5C19.5 12.5315 18.7474 12.9022 18.548 12.9823C18.5378 12.9864 18.5395 13.0047 18.5503 13.0063C18.8115 13.0456 20 13.3065 20 14.8C20 16 19.5 17 17.8 17C17.8 17 16 17 16 16.3"/></svg>', hg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M18 10L15.2834 14.8511C15.246 14.9178 15.294 15 15.3704 15C16.8489 15 18.7561 15 20.2 15M19 17C19 15.7187 19 14.8813 19 13.6"/></svg>', mg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 15.9C16 15.9 16.3768 17 17.8 17C19.5 17 20 15.6199 20 14.7C20 12.7323 17.6745 12.0486 16.1635 12.9894C16.094 13.0327 16 12.9846 16 12.9027V10.1C16 10.0448 16.0448 10 16.1 10H19.8"/></svg>', vg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6 7L6 12M6 17L6 12M6 12L12 12M12 7V12M12 17L12 12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M19.5 10C16.5 10.5 16 13.3285 16 15M16 15V15C16 16.1046 16.8954 17 18 17H18.3246C19.3251 17 20.3191 16.3492 20.2522 15.3509C20.0612 12.4958 16 12.6611 16 15Z"/></svg>', _g = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', fg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 7L9 12M9 17V12M9 12L15 12M15 7V12M15 17L15 12"/></svg>', xn = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><line x1="9" x2="19" y1="7" y2="7" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="9" x2="19" y1="12" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="9" x2="19" y1="17" y2="17" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 17H4.99002"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 12H4.99002"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 7H4.99002"/></svg>', yg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><line x1="12" x2="19" y1="7" y2="7" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="12" x2="19" y1="12" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="12" x2="19" y1="17" y2="17" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.79999 14L7.79999 7.2135C7.79999 7.12872 7.7011 7.0824 7.63597 7.13668L4.79999 9.5"/></svg>', bg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 10.8182L9 10.8182C8.80222 10.8182 8.60888 10.7649 8.44443 10.665C8.27998 10.5651 8.15181 10.4231 8.07612 10.257C8.00043 10.0909 7.98063 9.90808 8.01922 9.73174C8.0578 9.55539 8.15304 9.39341 8.29289 9.26627C8.43275 9.13913 8.61093 9.05255 8.80491 9.01747C8.99889 8.98239 9.19996 9.00039 9.38268 9.0692C9.56541 9.13801 9.72159 9.25453 9.83147 9.40403C9.94135 9.55353 10 9.72929 10 9.90909L10 12.1818C10 12.664 9.78929 13.1265 9.41421 13.4675C9.03914 13.8084 8.53043 14 8 14"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 10.8182L15 10.8182C14.8022 10.8182 14.6089 10.7649 14.4444 10.665C14.28 10.5651 14.1518 10.4231 14.0761 10.257C14.0004 10.0909 13.9806 9.90808 14.0192 9.73174C14.0578 9.55539 14.153 9.39341 14.2929 9.26627C14.4327 9.13913 14.6109 9.05255 14.8049 9.01747C14.9989 8.98239 15.2 9.00039 15.3827 9.0692C15.5654 9.13801 15.7216 9.25453 15.8315 9.40403C15.9414 9.55353 16 9.72929 16 9.90909L16 12.1818C16 12.664 15.7893 13.1265 15.4142 13.4675C15.0391 13.8084 14.5304 14 14 14"/></svg>', kg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.5 8.50001C13.5 7 10.935 6.66476 9.75315 7.79706C9.27092 8.25909 9 8.88574 9 9.53915C9 10.1926 9.27092 10.8192 9.75315 11.2812C10.9835 12.46 13.0165 11.5457 14.2468 12.7244C14.7291 13.1865 15 13.8131 15 14.4665C15 15.1199 14.7291 15.7466 14.2468 16.2086C12.8659 17.5317 10 17.5 9 16"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 12H18"/></svg>', wg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>', jg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7.5V11.5C9 12.2956 9.31607 13.0587 9.87868 13.6213C10.4413 14.1839 11.2044 14.5 12 14.5C12.7956 14.5 13.5587 14.1839 14.1213 13.6213C14.6839 13.0587 15 12.2956 15 11.5V7.5"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.71429 18H16.2857"/></svg>';
class xg {
  constructor({ data: e, config: o = {}, api: i, readOnly: s }) {
...
class Yt {
  ...
  constructor({ data: e, config: o = {}, api: i, readOnly: s }) {
    this.api = i, this.readOnly = s, this._CSS = {
      block: this.api.styles.block,
      wrapper: "ce-paragraph"
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = o.placeholder ? o.placeholder : Yt.DEFAULT_PLACEHOLDER;
    const { align: n } = Be.getState();
    this._data = {
      ...e,
      align: n
...
const Rg = () => typeof window < "u" && window.navigator !== null && rs(window.navigator.platform) && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
function $g(t) {
  const e = qr();
  return t = t.replace(/shift/gi, "⇧").replace(/backspace/gi, "⌫").replace(/enter/gi, "⏎").replace(/up/gi, "↑").replace(/left/gi, "→").replace(/down/gi, "↓").replace(/right/gi, "←").replace(/escape/gi, "⎋").replace(/insert/gi, "Ins").replace(/delete/gi, "␡").replace(/\+/gi, "+"), e.mac ? t = t.replace(/ctrl|cmd/gi, "⌘").replace(/alt/gi, "⌥") : t = t.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN"), t;
}
...
const tp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  throttle: ip,
  typeOf: io
}, Symbol.toStringTag, { value: "Module" })), as = /* @__PURE__ */ Pa(tp);
Object.defineProperty(ns, "__esModule", { value: !0 });
ns.containsOnlyInlineElements = rp;
var sp = as, np = Qt;
function rp(t) {
  var e;
  (0, sp.isString)(t) ? (e = document.createElement("div"), e.innerHTML = t) : e = t;
  var o = function(i) {
    return !(0, np.blockElements)().includes(i.tagName.toLowerCase()) && Array.from(i.children).every(o);
  };
...
ds.getContentLength = up;
var dp = bo;
function up(t) {
  var e, o;
  return (0, dp.isNativeInput)(t) ? t.value.length : t.nodeType === Node.TEXT_NODE ? t.length : (o = (e = t.textContent) === null || e === void 0 ? void 0 : e.length) !== null && o !== void 0 ? o : 0;
}
(function(t) {
...
var us = {}, gs = {}, Sn = fi && fi.__spreadArray || function(t, e, o) {
  if (o || arguments.length === 2) for (var i = 0, s = e.length, n; i < s; i++)
    (n || !(i in e)) && (n || (n = Array.prototype.slice.call(e, 0, i)), n[i] = e[i]);
  return t.concat(n || Array.prototype.slice.call(e));
};
Object.defineProperty(gs, "__esModule", { value: !0 });
gs.getDeepestBlockElements = Yr;
var gp = Mi;
function Yr(t) {
  return (0, gp.containsOnlyInlineElements)(t) ? [t] : Array.from(t.children).reduce(function(e, o) {
    return Sn(Sn([], e, !0), Yr(o), !0);
  }, []);
}
(function(t) {
...
ps.getDeepestNode = Xr;
var mp = bo, vp = Di, _p = Ri;
function Xr(t, e) {
  e === void 0 && (e = !1);
  var o = e ? "lastChild" : "firstChild", i = e ? "previousSibling" : "nextSibling";
  if (t.nodeType === Node.ELEMENT_NODE && t[o]) {
    var s = t[o];
    if ((0, _p.isSingleTag)(s) && !(0, mp.isNativeInput)(s) && !(0, vp.isLineBreakTag)(s))
      if (s[i])
        s = s[i];
...
var Jr = {}, vs = {}, ai = fi && fi.__spreadArray || function(t, e, o) {
  if (o || arguments.length === 2) for (var i = 0, s = e.length, n; i < s; i++)
    (n || !(i in e)) && (n || (n = Array.prototype.slice.call(e, 0, i)), n[i] = e[i]);
  return t.concat(n || Array.prototype.slice.call(e));
};
...
vs.findAllInputs = wp;
var fp = Mi, yp = us, bp = Gt, kp = bo;
function wp(t) {
  return Array.from(t.querySelectorAll((0, bp.allInputsSelector)())).reduce(function(e, o) {
    return (0, kp.isNativeInput)(o) || (0, fp.containsOnlyInlineElements)(o) ? ai(ai([], e, !0), [o], !1) : ai(ai([], e, !0), (0, yp.getDeepestBlockElements)(o), !0);
  }, []);
}
(function(t) {
...
var xp = as;
function Sp(t) {
  return (0, xp.isNumber)(t) ? !1 : !!t && !!t.nodeType && t.nodeType === Node.ELEMENT_NODE;
}
(function(t) {
...
xs.isNodeEmpty = Ip;
var Cp = Di, Bp = fs, Tp = bo, Pp = Ri;
function Ip(t, e) {
  var o = "";
  return (0, Pp.isSingleTag)(t) && !(0, Cp.isLineBreakTag)(t) ? !1 : ((0, Bp.isElement)(t) && (0, Tp.isNativeInput)(t) ? o = t.value : t.textContent !== null && (o = t.textContent.replace("​", "")), e !== void 0 && (o = o.replace(new RegExp(e, "g"), "")), o.trim().length === 0);
}
(function(t) {
...
function Lp(t, e) {
  ...
  for (var o = [t]; o.length > 0; ) {
    var i = o.shift();
    if (i) {
      if (t = i, (0, Op.isLeaf)(t) && !(0, Ap.isNodeEmpty)(t, e))
        return !1;
...
var Np = as;
function Mp(t) {
  return (0, Np.isNumber)(t) ? !1 : !!t && !!t.nodeType && t.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
}
(function(t) {
...
const Xe = class Xe {
  ...
  render() {
    ...
    return i.classList.add("dropdown-icon"), i.innerHTML = `${_g}`, e.appendChild(this.button), e.appendChild(i), e;
  }
  renderActions() {
...
const zp = {
  ...
  const { setEditor: e } = Be(), o = to(null);
  return Zo(() => {
    if (!o.current) {
      const i = new tg({
        holder: "editorjs",
        ...
        tools: zp,
        onReady: () => {
          console.log("✅ Editor is ready"), new ag({ editor: i }), new ng(i), e(i);
        },
        onChange: async () => {
          console.log("📝 EditorJS: change detected");
          try {
            const s = await i.save();
            console.log("✅ Saved editor data:", s), t == null || t(s);
          } catch (s) {
  ...
  }, [t]), /* @__PURE__ */ $.jsx(Gl, { id: "editorjs", style: { cursor: "pointer" } });
});
function qp({
  onUpload: t,
  width: e,
  ...
  const i = to(null), [s, n] = Go(0), { editor: r } = Be();
  return Zo(() => {
    const a = () => {
      if (i.current) {
    ...
    /* @__PURE__ */ $.jsx(Up, { onChange: o }),
    /* @__PURE__ */ $.jsx(Yl, { toolbarTop: s, onUpload: t })
  ] });
}
const Vp = {
  EditorSection: qp,
