...
export default function TitleCoverImageTool() {
    ...
    return (_jsxs(S.ImageInputWrapper, { children: [_jsx(S.ImageFileInput, { id: "file-upload", type: "file", accept: "image/*", ref: fileInputRef, onChange: handleFileChange }), _jsx(S.ImageInputIcon, { onClick: handleIconClick, "$hasCoverBg": !!titleCoverImage || !!titleCoverColor })] }));
}
