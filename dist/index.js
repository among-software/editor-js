...
function Wa() {
  ...
  function r(a, c, l) {
    ...
    if (a && a.defaultProps)
      for (d in ((c = a.defaultProps), c)) p[d] === void 0 && (p[d] = c[d]);
    return {
      $$typeof: e,
      type: a,
      key: u,
  ...
  return (Ro.Fragment = o), (Ro.jsx = r), (Ro.jsxs = r), Ro;
}
var Ho = {};
/**
 * @license React
    ...
    en ||
      ...
      process.env.NODE_ENV !== "production" &&
        (function () {
          ...
          function T(h, j, F) {
            {
              var z = w.ReactDebugCurrentFrame,
                Q = z.getStackAddendum();
              Q !== "" && ((j += "%s"), (F = F.concat([Q])));
              var ie = F.map(function (Z) {
                return String(Z);
              });
              ie.unshift("Warning: " + j),
                Function.prototype.apply.call(console[h], console, ie);
            }
          }
          var O = !1,
            A = !1,
          ...
          function N(h) {
            ...
            if (typeof h == "object")
              switch (h.$$typeof) {
                ...
                case r:
                  var F = h;
                  return P(F._context) + ".Provider";
                case c:
                  return C(h, h.render, "ForwardRef");
                case p:
                  var z = h.displayName || null;
                  return z !== null ? z : N(h.type) || "Memo";
                case u: {
                  var Q = h,
                    ie = Q._payload,
                    Z = Q._init;
          ...
          function le() {
            {
              if ((E--, E === 0)) {
                ...
                Object.defineProperties(console, {
                  ...
                  error: y({}, h, { value: K }),
                  group: y({}, h, { value: ve }),
                  groupCollapsed: y({}, h, { value: te }),
                  groupEnd: y({}, h, { value: X }),
                });
              }
              E < 0 &&
                b(
          ...
          var ke = w.ReactCurrentDispatcher,
            Ce;
          function ae(h, j, F) {
            {
              if (Ce === void 0)
...
` +
          ...
          function Be(h, j) {
            ...
            var ie;
            (ie = ke.current), (ke.current = null), be();
            try {
              if (j) {
                var Z = function () {
                  throw Error();
              ...
              if (Te && z && typeof Te.stack == "string") {
                for (
                  var Y = Te.stack.split(`
`),
                    xe = z.stack.split(`
`),
                    de = Y.length - 1,
                    pe = xe.length - 1;
                  de >= 1 && pe >= 0 && Y[de] !== xe[pe];
...
` + Y[de].replace(" at new ", " at ");
                          return (
                            h.displayName &&
                              ...
                              (Le = Le.replace("<anonymous>", h.displayName)),
                            typeof h == "function" && $e.set(h, Le),
                            Le
                          );
                        }
                      while (de >= 1 && pe >= 0);
              ...
              (J = !1), (ke.current = ie), le(), (Error.prepareStackTrace = Q);
            }
            var wo = h ? h.displayName || h.name : "",
              so = wo ? ae(wo) : "";
            return typeof h == "function" && $e.set(h, so), so;
          }
          function Ve(h, j, F) {
            return Be(h, !1);
          }
          ...
          function ei(h, j, F) {
            if (h == null) return "";
            if (typeof h == "function") return Be(h, Vi(h));
            if (typeof h == "string") return ae(h);
            switch (h) {
              case l:
                return ae("Suspense");
              case d:
          ...
          var Do = Object.prototype.hasOwnProperty,
            Rs = {},
            Hs = w.ReactDebugCurrentFrame;
          function oi(h) {
            if (h) {
              var j = h._owner,
                F = ei(h.type, h._source, j ? j.type : null);
              Hs.setExtraStackFrame(F);
            } else Hs.setExtraStackFrame(null);
          }
          function ja(h, j, F, z, Q) {
            {
              var ie = Function.call.bind(Do);
              for (var Z in h)
                if (ie(h, Z)) {
                  var Y = void 0;
                  try {
          ...
          function Ia(h, j) {
            {
              ...
              (F.isReactWarning = !0),
                Object.defineProperty(h, "key", { get: F, configurable: !0 });
            }
          }
          function Oa(h, j) {
            {
              ...
              (F.isReactWarning = !0),
                Object.defineProperty(h, "ref", { get: F, configurable: !0 });
            }
          }
          var Aa = function (h, j, F, z, Q, ie, Z) {
            var Y = {
              $$typeof: e,
              type: h,
              key: j,
          ...
          function La(h, j, F, z, Q) {
            {
              var ie,
                ...
                xe = null;
              F !== void 0 && (zs(F), (Y = "" + F)),
                Ta(j) && (zs(j.key), (Y = "" + j.key)),
                Ba(j) && ((xe = j.ref), Pa(j, Q));
              for (ie in j)
                Do.call(j, ie) && !Ca.hasOwnProperty(ie) && (Z[ie] = j[ie]);
              if (h && h.defaultProps) {
                var de = h.defaultProps;
                for (ie in de) Z[ie] === void 0 && (Z[ie] = de[ie]);
              }
              if (Y || xe) {
                var pe =
                  typeof h == "function"
                    ...
                    : h;
                Y && Ia(Z, pe), xe && Oa(Z, pe);
              }
              return Aa(h, Y, xe, Q, z, Us.current, Z);
            }
          }
          var Ki = w.ReactCurrentOwner,
            Ws = w.ReactDebugCurrentFrame;
          function ko(h) {
            if (h) {
              var j = h._owner,
                F = ei(h.type, h._source, j ? j.type : null);
              Ws.setExtraStackFrame(F);
...
Check the top-level render call using <` +
          ...
          function Gs(h, j) {
            {
              ...
              h &&
                h._owner &&
                h._owner !== Ki.current &&
                (z = " It was passed a child from " + N(h._owner.type) + "."),
                ko(h),
                b(
          ...
          function Xs(h, j) {
            {
              ...
              else if (Gi(h)) h._store && (h._store.validated = !0);
              else if (h) {
                var Q = x(h);
                if (typeof Q == "function" && Q !== h.entries)
                  for (var ie = Q.call(h), Z; !(Z = ie.next()).done; )
                    Gi(Z.value) && Gs(Z.value, j);
              }
            }
          }
          function Ma(h) {
            {
              ...
              var F;
              if (typeof j == "function") F = j.propTypes;
              else if (
                typeof j == "object" &&
                (j.$$typeof === c || j.$$typeof === p)
              )
                F = j.propTypes;
              else return;
              if (F) {
                var z = N(j);
                ja(F, h.props, "prop", z, h);
          ...
          function Da(h) {
            {
              for (var j = Object.keys(h.props), F = 0; F < j.length; F++) {
                var z = j[F];
                if (z !== "children" && z !== "key") {
                  ko(h),
                    b(
          ...
          function Js(h, j, F, z, Q, ie) {
            {
              ...
              if (Z) {
                ...
                if (Le !== void 0)
                  if (z)
                    if (Wi(Le)) {
                      for (var wo = 0; wo < Le.length; wo++) Xs(Le[wo], h);
              ...
              if (Do.call(j, "key")) {
                var so = N(h),
                  Te = Object.keys(j).filter(function (qa) {
                    return qa !== "key";
                  }),
                  Xi =
                    Te.length > 0
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
          ...
          var $a = Ha,
            za = Ra;
          (Ho.Fragment = i), (Ho.jsx = $a), (Ho.jsxs = za);
        })()),
    Ho
  );
}
...
function Qa(t, e) {
  return me(t, 0) ^ 45
    ? (((((((e << 2) ^ me(t, 0)) << 2) ^ me(t, 1)) << 2) ^ me(t, 2)) << 2) ^
        me(t, 3)
    : 0;
}
function Kn(t) {
...
function eo(t, e) {
  return ut(
    Fi("", null, null, "", null, null, 0, t.siblings),
    t,
    { length: -t.length },
    e
  );
...
function jo(t) {
  for (; t.root; ) t = eo(t.root, { children: [t] });
  qo(t, t.siblings);
}
function oc() {
  return ge;
...
function ic() {
  return (
    (ge = Re > 0 ? me(Lo, --Re) : 0), To--, ge === 10 && ((To = 1), Ni--), ge
  );
}
function ze() {
  return (
    (ge = Re < Gn ? me(Lo, Re++) : 0), To++, ge === 10 && ((To = 1), Ni++), ge
  );
}
function ho() {
  return me(Lo, Re);
...
function tc(t) {
  return (Ni = To = 1), (Gn = We((Lo = t))), (Re = 0), [];
}
function sc(t) {
  return (Lo = ""), t;
}
function Zi(t) {
  return Kn(Mi(Re - 1, gt(t === 91 ? t + 2 : t === 40 ? t + 1 : t)));
}
function nc(t) {
  for (; (ge = ho()) && ge < 33; ) ze();
  return pt(t) > 2 || pt(ge) > 3 ? "" : " ";
}
function rc(t, e) {
  for (
    ;
  ...
  return Mi(t, li() + (e < 6 && ho() == 32 && ze() == 32));
}
function gt(t) {
  for (; ze(); )
    switch (ge) {
...
function ac(t, e) {
  for (; ze() && t + ge !== 57; ) if (t + ge === 84 && ho() === 47) break;
  return "/*" + Mi(e, Re - 1) + "*" + Dt(t === 47 ? t : ze());
}
function cc(t) {
  for (; !pt(ho()); ) ze();
  return Mi(t, Re);
...
function lc(t) {
  return sc(di("", null, null, null, [""], (t = tc(t)), 0, [0], t));
}
function di(t, e, o, i, s, n, r, a, c) {
  for (
    var l = 0,
      d = 0,
      p = r,
    ...
    switch (((m = b), (b = ze()))) {
      case 40:
        if (m != 108 && me(I, p - 1) == 58) {
          ci((I += W(Zi(b), "&", "&\f")), "&\f", Wn(l ? a[l - 1] : 0)) != -1 &&
            (w = -1);
          break;
        }
      case 34:
      ...
      case 0:
        switch (b) {
          ...
          default:
            if (
              (qo(
                (B = tn(I, e, o, l, d, s, a, T, (O = []), (A = []), p, n)),
                n
              ),
              b === 123)
            )
              if (d === 0) di(I, e, B, B, O, n, p, a, A);
              else
                switch (u === 99 && me(I, 3) === 110 ? 100 : u) {
                  case 100:
                  case 108:
                  case 109:
                  case 115:
                    di(
                      ...
                      B,
                      B,
                      i && qo(tn(t, B, B, 0, 0, s, a, T, s, (O = []), p, A), A),
                      s,
                      A,
                      p,
                      a,
      ...
      default:
        if (f < 1) {
          if (b == 123) --f;
          else if (b == 125 && f++ == 0 && ic() == 125) continue;
        }
        switch (((I += Dt(b)), b * f)) {
          case 38:
            w = d > 0 ? 1 : ((I += "\f"), -1);
...
function tn(t, e, o, i, s, n, r, a, c, l, d, p) {
  for (
    var u = s - 1, g = s === 0 ? n : [""], m = Yn(g), f = 0, x = 0, w = 0;
    f < i;
    ++f
  )
    for (var b = 0, T = Bo(t, u + 1, (u = Wn((x = r[f])))), O = t; b < m; ++b)
      (O = Kn(x > 0 ? g[b] + " " + T : W(T, /&\f/g, g[b]))) && (c[w++] = O);
  return Fi(t, e, o, s === 0 ? Li : a, c, l, d, p);
}
function dc(t, e, o, i) {
  return Fi(t, e, o, qn, Dt(oc()), Bo(t, 2, -2), 0, i);
}
function sn(t, e, o, i, s) {
  return Fi(t, e, o, Mt, Bo(t, 0, i), Bo(t, i + 1, -1), i, s);
}
function Xn(t, e, o) {
  switch (Qa(t, e)) {
    case 5103:
    ...
    case 6968:
    case 2756:
      return ee + t + Ko + t + se + t + t;
    case 5936:
      switch (me(t, e + 11)) {
        case 114:
          return ee + t + se + W(t, /[svh]\w+-[tblr]{2}/, "tb") + t;
        case 108:
          return ee + t + se + W(t, /[svh]\w+-[tblr]{2}/, "tb-rl") + t;
        case 45:
          return ee + t + se + W(t, /[svh]\w+-[tblr]{2}/, "lr") + t;
      }
    case 6828:
    case 4268:
    case 2903:
      return ee + t + se + t + t;
    case 6165:
      return ee + t + se + "flex-" + t + t;
    case 5187:
      return (
        ee + t + W(t, /(\w+).+(:[^]+)/, ee + "box-$1$2" + se + "flex-$1$2") + t
      );
    case 5443:
      return (
        ee +
    ...
    case 5548:
      return ee + t + se + W(t, "shrink", "negative") + t;
    case 5292:
      return ee + t + se + W(t, "basis", "preferred-size") + t;
    case 6060:
      return (
        ee +
        "box-" +
    ...
    case 6187:
      return (
        W(W(W(t, /(zoom-|grab)/, ee + "$1"), /(image-set)/, ee + "$1"), t, "") +
        t
      );
    case 5495:
    case 3959:
    ...
    case 4968:
      return (
        W(
          W(t, /(.+:)(flex-)?(.*)/, ee + "box-pack:$3" + se + "flex-pack:$3"),
          /s.+-b[^;]+/,
          "justify"
        ) +
        ee +
    ...
    case 4200:
      if (!Ge(t, /flex-|baseline/))
        return se + "grid-column-align" + Bo(t, e) + t;
      break;
    case 2592:
    case 3360:
      return se + W(t, "template-", "") + t;
    case 4384:
    case 3616:
      return o &&
        o.some(function (i, s) {
          return (e = s), Ge(i.props, /grid-\w+-end/);
        })
        ? ~ci(t + (o = o[e].value), "span", 0)
          ? t
          : se +
            W(t, "-start", "") +
            t +
            se +
            "grid-row-span:" +
            (~ci(o, "span", 0) ? Ge(o, /\d+/) : +Ge(o, /\d+/) - +Ge(t, /\d+/)) +
            ";"
        : se + W(t, "-start", "") + t;
    case 4896:
    case 4128:
      return o &&
        o.some(function (i) {
          return Ge(i.props, /grid-\w+-start/);
        })
        ? t
        : se + W(W(t, "-end", "-span"), "span ", "") + t;
    case 4095:
    case 3583:
    case 4068:
    case 2532:
    ...
    case 4765:
      if (We(t) - 1 - e > 6)
        switch (me(t, e + 1)) {
          ...
          case 115:
            return ~ci(t, "stretch", 0)
              ? Xn(W(t, "stretch", "fill-available"), e, o) + t
              : t;
        }
      break;
    case 5152:
      ...
      return W(
        ...
        function (i, s, n, r, a, c, l) {
          return (
            ...
            n +
            l +
            (r ? se + s + "-span:" + (a ? c : +c - +n) + l : "") +
            t
          );
        }
      );
    case 4949:
      if (me(t, e + 6) === 121) return W(t, ":", ":" + ee) + t;
      break;
    case 6444:
...
function yi(t, e) {
  for (var o = "", i = 0; i < t.length; i++) o += e(t[i], i, t, e) || "";
  return o;
}
function uc(t, e, o, i) {
  switch (t.type) {
    ...
    case qn:
      return "";
    case Vn:
      return (t.return = t.value + "{" + yi(t.children, i) + "}");
    case Li:
      if (!We((t.value = t.props.join(",")))) return "";
  }
  return We((o = yi(t.children, i)))
    ? (t.return = t.value + "{" + o + "}")
    : "";
}
function pc(t) {
  ...
  return function (o, i, s, n) {
    for (var r = "", a = 0; a < e; a++) r += t[a](o, i, s, n) || "";
    return r;
  };
}
function gc(t) {
...
function hc(t, e, o, i) {
  if (t.length > -1 && !t.return)
    switch (t.type) {
      case Mt:
        t.return = Xn(t.value, t.length, o);
        return;
      case Vn:
        return yi([eo(t, { value: W(t.value, "@", "@" + ee) })], i);
      case Li:
        if (t.length)
          return ec((o = t.props), function (s) {
            switch (Ge(s, (i = /(::plac\w+|:read-\w+)/))) {
              case ":read-only":
              case ":read-write":
                jo(eo(t, { props: [W(s, /:(read-\w+)/, ":" + Ko + "$1")] })),
                  jo(eo(t, { props: [s] })),
                  ut(t, { props: on(o, i) });
                break;
              case "::placeholder":
                jo(
                  eo(t, { props: [W(s, /:(plac\w+)/, ":" + ee + "input-$1")] })
                ),
                  jo(eo(t, { props: [W(s, /:(plac\w+)/, ":" + Ko + "$1")] })),
                  jo(eo(t, { props: [W(s, /:(plac\w+)/, se + "input-$1")] })),
                  jo(eo(t, { props: [s] })),
                  ut(t, { props: on(o, i) });
                break;
            }
...
var mc = {
  ...
  fo =
    ...
    "data-styled",
  Zn = "active",
  Jn = "data-styled-version",
  Di = "6.1.13",
  Rt = `/*!sc*/
`,
  bi = typeof window < "u" && "HTMLElement" in window,
  vc = !!(typeof SC_DISABLE_SPEEDY == "boolean"
    ? SC_DISABLE_SPEEDY
    : typeof process < "u" &&
      process.env !== void 0 &&
    ...
    : process.env.NODE_ENV !== "production"),
  nn = /invalid hook call/i,
  ii = new Set(),
  fc = function (t, e) {
    if (process.env.NODE_ENV !== "production") {
      var o = e ? ' with the id of "'.concat(e, '"') : "",
        i =
          "The component ".concat(t).concat(
            o,
...
To resolve this only create new StyledComponents outside of any render method and function component.`,
      ...
      try {
        ...
        (console.error = function (r) {
          ...
          nn.test(r)
            ? ((n = !1), ii.delete(i))
            : s.apply(void 0, Co([r], a, !1));
        }),
          R.useRef(),
          n && !ii.has(i) && (console.warn(i), ii.add(i));
      } catch (r) {
        nn.test(r.message) && ii.delete(i);
      } finally {
        console.error = s;
      }
    }
...
function _c(t, e, o) {
  return (
    o === void 0 && (o = Po), (t.theme !== o.theme && t.theme) || e || o.theme
  );
}
var ht = new Set([
    "a",
  ...
  bc = /(^-|-$)/g;
function rn(t) {
  return t.replace(yc, "-").replace(bc, "");
}
var kc = /(a)(d)/gi,
  ti = 52,
  an = function (t) {
...
function mt(t) {
  var e,
    o = "";
  for (e = Math.abs(t); e > ti; e = (e / ti) | 0) o = an(e % ti) + o;
  return (an(e % ti) + o).replace(kc, "$1-$2");
}
var Ji,
  Qn = 5381,
  ro = function (t, e) {
...
function or(t) {
  return (
    (process.env.NODE_ENV !== "production" && typeof t == "string" && t) ||
    t.displayName ||
    t.name ||
    "Component"
  );
...
function Qi(t) {
  return (
    typeof t == "string" &&
    (process.env.NODE_ENV === "production" ||
      t.charAt(0) === t.charAt(0).toLowerCase())
  );
}
var ir = typeof Symbol == "function" && Symbol.for,
  tr = ir ? Symbol.for("react.memo") : 60115,
  jc = ir ? Symbol.for("react.forward_ref") : 60112,
  xc = {
    childContextTypes: !0,
    contextType: !0,
    contextTypes: !0,
  ...
  Ec =
    ...
    Ji);
function cn(t) {
  return ("type" in (e = t) && e.type.$$typeof) === tr
    ? sr
    : "$$typeof" in t
    ? Ec[t.$$typeof]
    : xc;
...
function nr(t, e, o) {
  if (typeof e != "string") {
    ...
    var s = Bc(e);
    ln && (s = s.concat(ln(e)));
    for (var n = cn(t), r = cn(e), a = 0; a < s.length; ++a) {
      var c = s[a];
      if (!(c in Sc || (o && o[c]) || (r && c in r) || (n && c in n))) {
        var l = Tc(e, c);
        try {
          Cc(t, c, l);
        } catch {}
...
function vt(t, e, o) {
  ...
  if (Array.isArray(e))
    for (var i = 0; i < e.length; i++) t[i] = vt(t[i], e[i]);
  else if (Oo(e)) for (var i in e) t[i] = vt(t[i], e[i]);
  return t;
}
function $t(t, e) {
...
function No(t) {
  ...
  return process.env.NODE_ENV === "production"
    ...
    : new Error(Oc.apply(void 0, Co([Ic[t]], e, !1)).trim());
}
var Ac = (function () {
    function t(e) {
    ...
    return (
      ...
      (t.prototype.insertRules = function (e, o) {
        if (e >= this.groupSizes.length) {
          for (var i = this.groupSizes, s = i.length, n = s; e >= n; )
            if ((n <<= 1) < 0) throw No(16, "".concat(e));
        ...
        for (
          var a = this.indexOfGroup(e + 1), c = ((r = 0), o.length);
          r < c;
          r++
        )
          this.tag.insertRule(a, o[r]) && (this.groupSizes[e]++, a++);
      }),
      (t.prototype.clearGroup = function (e) {
        if (e < this.length) {
          var o = this.groupSizes[e],
      ...
      (t.prototype.getGroup = function (e) {
        ...
        for (
          ...
          o += "".concat(this.tag.getRule(r)).concat(Rt);
        return o;
      }),
      t
    );
  ...
  si = function (t) {
    ...
    for (; ki.has(pi); ) pi++;
    var e = pi++;
    if (process.env.NODE_ENV !== "production" && ((0 | e) < 0 || e > Lc))
      throw No(16, "".concat(e));
    return ui.set(t, e), ki.set(e, t), e;
  },
  Nc = function (t, e) {
    (pi = e + 1), ui.set(t, e), ki.set(e, t);
  },
  Fc = "style[".concat(fo, "][").concat(Jn, '="').concat(Di, '"]'),
  Mc = new RegExp(
    "^".concat(fo, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')
  ),
  Dc = function (t, e, o) {
    for (var i, s = o.split(","), n = 0, r = s.length; n < r; n++)
      (i = s[n]) && t.registerName(e, i);
  },
  Rc = function (t, e) {
    for (
      var o,
        i = ((o = e.textContent) !== null && o !== void 0 ? o : "").split(Rt),
        s = [],
        n = 0,
        r = i.length;
      n < r;
      ...
      if (a) {
        ...
        if (c) {
          var l = 0 | parseInt(c[1], 10),
            d = c[2];
          l !== 0 && (Nc(d, l), Dc(t, d, c[3]), t.getTag().insertRules(l, s)),
            (s.length = 0);
        } else s.push(a);
      }
    }
  ...
  pn = function (t) {
    for (
      var e = document.querySelectorAll(Fc), o = 0, i = e.length;
      o < i;
      o++
    ) {
      var s = e[o];
      s &&
        s.getAttribute(fo) !== Zn &&
        (Rc(t, s), s.parentNode && s.parentNode.removeChild(s));
    }
  };
function Hc() {
...
var rr = function (t) {
    var e = document.head,
      ...
      n = s !== void 0 ? s.nextSibling : null;
    i.setAttribute(fo, Zn), i.setAttribute(Jn, Di);
    var r = Hc();
  ...
  $c = (function () {
    ...
    return (
      (t.prototype.insertRule = function (e, o) {
        try {
  ...
  Uc = (function () {
    ...
    return (
      (t.prototype.insertRule = function (e, o) {
        return (
          e <= this.length && (this.rules.splice(e, 0, o), this.length++, !0)
        );
      }),
      (t.prototype.deleteRule = function (e) {
  ...
  gn = bi,
  qc = { isServer: !bi, useCSSOMInjection: !vc },
  ar = (function () {
    function t(e, o, i) {
      e === void 0 && (e = Po), o === void 0 && (o = {});
      var s = this;
      (this.options = Pe(Pe({}, qc), e)),
        (this.gs = o),
        (this.names = new Map(i)),
        (this.server = !!e.isServer),
        !this.server && bi && gn && ((gn = !1), pn(this)),
        $t(this, function () {
          return (function (n) {
            for (
              var r = n.getTag(),
    ...
    return (
      ...
      (t.prototype.getTag = function () {
        return (
          ...
          (this.tag =
            ((e = (function (o) {
              var i = o.useCSSOMInjection,
                s = o.target;
              return o.isServer ? new Uc(s) : i ? new $c(s) : new zc(s);
            })(this.options)),
            new Ac(e)))
        );
        var e;
...
function cr(t, e) {
  return t.map(function (o) {
    return (
      o.type === "rule" &&
        ((o.value = "".concat(e, " ").concat(o.value)),
        (o.value = o.value.replaceAll(",", ",".concat(e, " "))),
        (o.props = o.props.map(function (i) {
          return "".concat(e, " ").concat(i);
        }))),
      Array.isArray(o.children) &&
        o.type !== "@keyframes" &&
        (o.children = cr(o.children, e)),
      o
    );
  });
}
function Kc(t) {
  var e,
    ...
    c = a === void 0 ? Ri : a,
    l = function (u, g, m) {
      return m.startsWith(o) && m.endsWith(o) && m.replaceAll(o, "").length > 0
        ? ".".concat(e)
        : u;
    },
    d = c.slice();
  d.push(function (u) {
    u.type === Li &&
      u.value.includes("&") &&
      (u.props[0] = u.props[0].replace(Vc, o).replace(i, l));
  }),
    r.prefix && d.push(hc),
    d.push(uc);
  var p = function (u, g, m, f) {
    g === void 0 && (g = ""),
      m === void 0 && (m = ""),
      f === void 0 && (f = "&"),
      (e = f),
      (o = g),
      (i = new RegExp("\\".concat(o, "\\b"), "g"));
    var x = u.replace(Wc, ""),
      w = lc(m || g ? "".concat(m, " ").concat(g, " { ").concat(x, " }") : x);
    r.namespace && (w = cr(w, r.namespace));
    var b = [];
    return (
      yi(
        w,
  ...
  return (
    (p.hash = c.length
      ? c
          .reduce(function (u, g) {
            return g.name || No(15), ro(u, g.name);
          }, Qn)
          .toString()
      : ""),
    p
...
var mn = (function () {
    function t(e, o) {
      ...
      (this.inject = function (s, n) {
        n === void 0 && (n = ft);
        var r = i.name + n.hash;
        s.hasNameForId(i.id, r) ||
          s.insertRules(i.id, r, n(i.rules, r, "@keyframes"));
      }),
        (this.name = e),
...
var dr = function (t) {
  ...
  ur = function (t) {
    ...
    for (var s in t) {
      ...
      t.hasOwnProperty(s) &&
        !dr(n) &&
        ((Array.isArray(n) && n.isCss) || Io(n)
          ? i.push("".concat(vn(s), ":"), n, ";")
          : Oo(n)
          ? i.push.apply(i, Co(Co(["".concat(s, " {")], ur(n), !1), ["}"], !1))
          : i.push(
              ""
                .concat(vn(s), ": ")
                .concat(
                  ((e = s),
                  (o = n) == null || typeof o == "boolean" || o === ""
                    ? ""
                    : typeof o != "number" ||
                      o === 0 ||
                      e in mc ||
...
function mo(t, e, o, i) {
  ...
  if (Io(t)) {
    if (!Io((n = t)) || (n.prototype && n.prototype.isReactComponent) || !e)
      return [t];
    var s = t(e);
    return (
      process.env.NODE_ENV === "production" ||
    ...
    function t(e, o, i) {
      (this.rules = e),
        ...
        (this.isStatic =
          ...
          Xc(e)),
        (this.componentId = o),
        (this.baseHash = ro(Zc, o)),
        (this.baseStyle = i),
        ar.registerId(o);
    }
    return (
      (t.prototype.generateAndInjectStyles = function (e, o, i) {
        var s = this.baseStyle
          ? this.baseStyle.generateAndInjectStyles(e, o, i)
          : "";
        if (this.isStatic && !i.hash)
          if (
            ...
            s = po(s, this.staticRulesId);
          else {
            var n = un(mo(this.rules, e, o, i)),
              r = mt(ro(this.baseHash, n) >>> 0);
            if (!o.hasNameForId(this.componentId, r)) {
              var a = i(n, ".".concat(r), void 0, this.componentId);
              o.insertRules(this.componentId, r, a);
            }
            (s = po(s, r)), (this.staticRulesId = r);
          }
        else {
          for (
            var c = ro(this.baseHash, i.hash), l = "", d = 0;
            d < this.rules.length;
            d++
          ) {
            var p = this.rules[d];
            if (typeof p == "string")
              (l += p), process.env.NODE_ENV !== "production" && (c = ro(c, p));
            else if (p) {
              var u = un(mo(p, e, o, i));
              (c = ro(c, u + d)), (l += u);
            }
          ...
          if (l) {
            var g = mt(c >>> 0);
            o.hasNameForId(this.componentId, g) ||
              o.insertRules(
                this.componentId,
                g,
                i(l, ".".concat(g), void 0, this.componentId)
              ),
              (s = po(s, g));
          }
        }
...
function Qc(t, e, o) {
  var i = Ht(t),
    ...
    l =
      c === void 0
        ? (function (O, A) {
            var B = typeof O != "string" ? "sc" : rn(O);
            et[B] = (et[B] || 0) + 1;
            var I = "".concat(B, "-").concat(wc(Di + B + et[B]));
    ...
    p =
      d === void 0
        ? (function (O) {
            return Qi(O) ? "styled.".concat(O) : "Styled(".concat(or(O), ")");
          })(t)
        : d,
    u =
      e.displayName && e.componentId
        ? "".concat(rn(e.displayName), "-").concat(e.componentId)
        : e.componentId || l,
    g = i && s.attrs ? s.attrs.concat(a).filter(Boolean) : a,
  ...
  var w = new Jc(o, u, i ? s.componentStyle : void 0);
  function b(O, A) {
    return (function (B, I, S) {
      var k = B.attrs,
        L = B.componentStyle,
        C = B.defaultProps,
        P = B.foldedComponentIds,
        N = B.styledComponentId,
        y = B.target,
        E = R.useContext(pr),
        $ = hn(),
        q = B.shouldForwardProp || $.shouldForwardProp;
      process.env.NODE_ENV !== "production" && R.useDebugValue(N);
      var V = _c(I, E, C) || Po,
        K = (function (le, ke, Ce) {
          for (
            var ae,
              J = Pe(Pe({}, ke), { className: void 0, theme: Ce }),
              $e = 0;
            $e < le.length;
            $e += 1
          ) {
            var qe = Io((ae = le[$e])) ? ae(J) : ae;
            for (var Be in qe)
              J[Be] =
                Be === "className"
                  ? po(J[Be], qe[Be])
          ...
          return (
            ke.className && (J.className = po(J.className, ke.className)), J
          );
        })(k, I, V),
        ve = K.as || y,
        te = {};
      ...
      var ye = (function (le, ke) {
        var Ce = hn(),
          ae = le.generateAndInjectStyles(ke, Ce.styleSheet, Ce.stylis);
        return process.env.NODE_ENV !== "production" && R.useDebugValue(ae), ae;
      })(L, K);
      process.env.NODE_ENV !== "production" &&
        B.warnTooManyClasses &&
        B.warnTooManyClasses(ye);
      var be = po(P, N);
      return (
        ye && (be += " " + ye),
        K.className && (be += " " + K.className),
        (te[Qi(ve) && !ht.has(ve) ? "class" : "className"] = be),
        (te.ref = S),
        R.createElement(ve, te)
      );
    })(T, O, A);
  }
  b.displayName = p;
  ...
  return (
    ...
    (T.componentStyle = w),
    (T.displayName = p),
    (T.shouldForwardProp = m),
    (T.foldedComponentIds = i
      ? po(s.foldedComponentIds, s.styledComponentId)
      : ""),
    (T.styledComponentId = u),
    (T.target = i ? s.target : t),
    Object.defineProperty(T, "defaultProps", {
      ...
      set: function (O) {
        this._foldedDefaultProps = i
          ? (function (A) {
              for (var B = [], I = 1; I < arguments.length; I++)
                B[I - 1] = arguments[I];
              for (var S = 0, k = B; S < k.length; S++) vt(A, k[S], !0);
              return A;
            })({}, s.defaultProps, O)
          : O;
      },
    ...
    process.env.NODE_ENV !== "production" &&
      (fc(p, u),
      (T.warnTooManyClasses = (function (O, A) {
        var B = {},
          I = !1;
        return function (S) {
          if (!I && ((B[S] = !0), Object.keys(B).length >= 200)) {
...
function _n(t, e) {
  for (var o = [t[0]], i = 0, s = e.length; i < s; i += 1)
    o.push(e[i], t[i + 1]);
  return o;
}
var yn = function (t) {
...
function el(t) {
  for (var e = [], o = 1; o < arguments.length; o++) e[o - 1] = arguments[o];
  if (Io(t) || Oo(t)) return yn(mo(_n(Ri, Co([t], e, !0))));
  var i = t;
  return e.length === 0 && i.length === 1 && typeof i[0] == "string"
    ? mo(i)
    : yn(mo(_n(i, e)));
}
function _t(t, e, o) {
  ...
  var i = function (s) {
    ...
    return t(e, o, el.apply(void 0, Co([s], n, !1)));
  };
  return (
    (i.attrs = function (s) {
      return _t(
...
var ni = "__sc-".concat(fo, "__");
process.env.NODE_ENV !== "production" &&
  process.env.NODE_ENV !== "test" &&
  typeof window < "u" &&
  (window[ni] || (window[ni] = 0),
  window[ni] === 1 &&
...
`,
  ...
  background-size: ${({ $align: t }) =>
    t === "justify" ? "24px 24px" : "auto"};
  ...
  background-image: ${({ $align: t }) =>
    t === "justify"
      ? "url('https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_96c6313b6d6a405b9511658326418a69/lotte-foundation/justify.svg')"
      : t === "right"
      ? "url('https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_96c6313b6d6a405b9511658326418a69/lotte-foundation/right.svg')"
      : t === "left"
      ? "url('https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_96c6313b6d6a405b9511658326418a69/lotte-foundation/left.svg')"
      : t === "center"
      ? "url('https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_96c6313b6d6a405b9511658326418a69/lotte-foundation/center.svg')"
      : "url('https://t1.daumcdn.net/brunch/static/img/help/pc/editor/btn_side.v2.png')"};
  ...
  bn = (t) => {
    ...
    const o = new Set(),
      ...
      a = {
        ...
        getState: s,
        getInitialState: () => c,
        subscribe: (l) => (o.add(l), () => o.delete(l)),
      },
      c = (e = t(i, s, a));
    return a;
  },
...
const kn = (t) => {
  ...
  he = al((t) => ({
    ...
    toggleModal: (e) => {
      t((o) => ({ activeModal: o.activeModal === e ? null : e }));
    },
    ...
    addSelectedBlockId: (e) =>
      t((o) => ({
        selectedBlockIds: Array.from(new Set([...o.selectedBlockIds, e])),
      })),
    removeSelectedBlockId: (e) =>
      t((o) => ({
...
function cl() {
  const {
    ...
    n = async () => {
      ...
      const d = await r.save(),
        p = d.blocks.filter((f) => typeof f.id == "string" && a.includes(f.id));
      console.log(d.blocks), console.log(p.at(-1));
      const u = s(((g = p.at(-1)) == null ? void 0 : g.data.align) || "left");
      console.log("asdf2", (m = p.at(-1)) == null ? void 0 : m.data.align),
        console.log("asdf", u);
      for (const f of p) {
        const x = f.data.align || "left";
        console.log(`[정렬] ${f.id} → ${x} → ${u}`),
          await r.blocks.update(f.id, { ...f.data, align: u });
      }
      setTimeout(() => {
        l(a);
      }, 0),
  ...
  return v.jsxs(tl, {
    children: [
      v.jsx(il, { $align: e, onClick: n }),
      v.jsx(io, { children: "정렬" }),
    ],
  });
}
const ll = M.div`
...
`;
function ul({ handleBlockIndex: t }) {
  const { toggleModal: e } = he(),
    o = () => {
      t(), e("emoji");
    };
  return v.jsxs(ll, {
    children: [
      v.jsx(dl, { className: "modal-active-icon", onClick: o }),
      v.jsx(io, { children: "이모지" }),
    ],
  });
}
const pl = M.div`
...
`,
  ...
  display: none;
`;
function ml({ handleBlockIndex: t, addBlock: e, onUpload: o }) {
    ...
    s = async (r) => {
      ...
      if (a) {
        ...
        if (o) {
          ...
          l = { url: p, name: d, type: a.type, size: a.size };
        } else
          l = {
...
`;
function _l({ handleBlockIndex: t, addBlock: e, onUpload: o }) {
  const i = R.useRef(null),
    s = async (a) => {
        ...
        const l = await Promise.all(
            Array.from(c).map(async (u) => {
              ...
              if (o) {
                const w = await o(u);
                (g = w.path), (m = w.name);
              } else (g = URL.createObjectURL(u)), (m = u.name);
              const { width: f, height: x } = await n(g);
              return {
                url: g,
                name: m,
                type: u.type,
...
`,
  ...
  display: none;
`;
function wl({ handleBlockIndex: t, addBlock: e, onUpload: o }) {
  const i = R.useRef(null),
    s = async (a) => {
      var l;
      ...
      if (c) {
        let d, p;
        if (o) {
          const { name: f, path: x } = await o(c);
          (d = x), (p = f);
        } else (d = URL.createObjectURL(c)), (p = c.name);
        const { width: u, height: g } = await n(d),
          m = {
            url: d,
            name: p,
            size: c.size,
...
`;
function Sl({ handleBlockIndex: t }) {
  const { toggleModal: e } = he(),
    o = () => {
      t(), e("line");
    };
  return v.jsxs(jl, {
    children: [
      v.jsx(xl, { className: "modal-active-icon", onClick: o }),
      v.jsx(io, { children: "구분선" }),
    ],
  });
}
M.div`
...
`,
  ...
  pointer-events: none;
`;
function Tl({ handleBlockIndex: t, addBlock: e, onUpload: o }) {
  const i = R.useRef(null),
    s = async (r) => {
      var l;
      ...
      if (o) {
        const d = await o(a);
        c = { url: d.path, name: d.name, type: a.type, size: a.size };
      } else {
...
`;
function Ll({ handleBlockIndex: t, addBlock: e }) {
  const [o, i] = R.useState(!1),
    ...
    a = () => {
      ...
      e("iframe", { url: l, name: "iframe", type: "iframe" }), n(""), i(!1);
    };
  return v.jsxs(Pl, {
    children: [
      v.jsx(Il, { onClick: r }),
      v.jsx(io, { children: "유튜브" }),
      o &&
        v.jsx(Ol, {
          children: v.jsxs(Al, {
            children: [
              ...
              v.jsxs("p", {
                ...
                children: [
                  ...
                  v.jsx("br", {}),
                  v.jsx("code", {
                    children: "https://www.youtube.com/watch?v=abc123XYZ",
                  }),
                  v.jsx("br", {}),
                  v.jsx("b", { children: "→ 영상 ID: abc123XYZ" }),
                  " 만 입력해주세요",
                ],
              }),
              v.jsxs("div", {
              ...
              v.jsxs("div", {
                ...
                children: [
                  v.jsx("button", { onClick: a, children: "확인" }),
                  v.jsx("button", { onClick: () => i(!1), children: "취소" }),
                ],
              }),
            ],
          }),
...
`,
  ...
  margin: 0 5px;
  padding: 8px 12px;
  color: ${Ae.white_primary};
  background-color: ${Ae.primary};
  border: none;
  cursor: pointer;

  &:disabled {
    background-color: ${Ae.light_gray};
    cursor: not-allowed;
  }
`,
  Rl = [
...
function Hl({ addBlock: t }) {
  const [e, o] = R.useState([]),
    [i, s] = R.useState(0),
    n = 150,
    { closeModal: r } = he(),
    a = (l) => {
      t("emoji", { emoji: l.emoji }), r();
    };
  R.useEffect(() => {
    o(Rl);
  }, []);
  const c = e.slice(i * n, (i + 1) * n);
  return v.jsxs(Nl, {
    children: [
      v.jsx(Fl, {
        children: c.map((l, d) =>
          v.jsx(
            ...
            {
              onClick: () => a(l),
              children: v.jsx("span", { children: l.emoji }),
            },
            d
          )
        ),
  ...
  Ul = [
    {
      ...
      inBlockImageURL:
        "https://t1.daumcdn.net/brunch/static/img/line/pc_line_type_01.png",
      inBlockImagePosition: "0 50%",
    },
    {
      modalImagePosition: "0 -15px",
      inBlockImageURL:
        "https://t1.daumcdn.net/brunch/static/img/line/pc_line_type_02.png",
      inBlockImagePosition: "0 50%",
    },
    {
      modalImagePosition: "0 -80px",
      inBlockImageURL:
        "https://t1.daumcdn.net/brunch/static/img/line/pc_line_type_04.png",
      inBlockImagePosition: "50% 50%",
    },
    {
      modalImagePosition: "0 -45px",
      inBlockImageURL:
        "https://t1.daumcdn.net/brunch/static/img/line/pc_line_type_03.png",
      inBlockImagePosition: "50% 50%",
    },
    {
      modalImagePosition: "0 -137px",
      inBlockImageURL:
        "https://t1.daumcdn.net/brunch/static/img/line/pc_line_type_06.png",
      inBlockImagePosition: "0 50%",
    },
    {
      modalImagePosition: "0 -112px",
      inBlockImageURL:
        "https://t1.daumcdn.net/brunch/static/img/line/pc_line_type_05.png",
      inBlockImagePosition: "0 50%",
    },
  ];
function ql({ addBlock: t }) {
  const { closeModal: e } = he(),
    o = (i) => {
      const s = {
  ...
  return v.jsx($l, {
    children: Ul.map((i, s) =>
      v.jsx(
        zl,
        { $imagePosition: i.modalImagePosition, onClick: () => o(i) },
        s
      )
    ),
  });
...
`,
  Wl = M.div`
  width: calc(100% - 40px);
  border-bottom: 1px solid ${Ae.dark_gray};
...
`,
  ...
  border-bottom: 1px solid ${Ae.light_gray};
  display: flex;
  flex-direction: column;
  gap: 4px;
`,
    ...
    try {
      const e = await fetch(
        `https://dapi.kakao.com/v2/local/search/keyword.json?query=${t}`,
        {
          method: "GET",
          headers: {
            Authorization: `KakaoAK ${ad}`,
            "Content-Type": "application/json",
          },
        }
      );
      if (!e.ok) throw new Error("네트워크 응답이 정상이 아닙니다.");
...
function ld({ addBlock: t }) {
  const [e, o] = R.useState(""),
    ...
    c = (d) =>
      e
        ? d
            .split(new RegExp(`(${e})`, "gi"))
            .map((u, g) =>
              u.toLowerCase() === e.toLowerCase()
                ? v.jsx(od, { children: u }, g)
                : u
            )
        : d,
    l = (d) => {
    ...
    v.jsxs(Vl, {
      children: [
        ...
        i.length === 0
          ? v.jsx(td, {
              children: v.jsxs(sd, {
                children: [v.jsx(nd, {}), v.jsx(rd, { children: "장소 첨부" })],
              }),
            })
          : v.jsx(Zl, {
              children: i.map((d) =>
                v.jsx(
                  Jl,
                  {
                    children: v.jsxs(Ql, {
                      onClick: () => l(d),
                      children: [
                        v.jsx(ed, { children: c(d.name) }),
                        v.jsx(id, { children: d.address }),
                      ],
                    }),
                  },
                  d.id
...
const dd = M.div`
  ...
  border: 1px solid ${Ae.modal_border_color};
  border-radius: 1px;
  background-color: ${Ae.white_primary};
  z-index: 9999;
`,
  ud = (t, e) => {
    ...
    return (
      R.useEffect(() => {
        const i = (s) => {
          const n = s.target;
          o.current && !o.current.contains(n) && !(e && e(n)) && t();
        };
        return (
...
function pd({ top: t, children: e }) {
  const { activeModal: o, closeModal: i } = he(),
    { $ref: s } = ud(
      () => {
        i();
      },
  ...
  return v.jsx(dd, { $top: t, ref: s, children: e });
}
const gd = M.div`
  display: flex;
  flex-direction: row;
...
`;
function hd({ position: t, children: e }) {
  return v.jsx(gd, { $top: 0, $right: t.right, $width: t.width, children: e });
}
function md({ toolbarTop: t, onUpload: e, width: o }) {
  const {
      editor: i,
      activeModal: s,
      currentBlockIndex: n,
      setCurrentBlockIndex: r,
    } = he(),
    a = () => {
      if (!i) return;
      const d = i.blocks.getCurrentBlockIndex(),
        p = i.blocks.getBlocksCount();
      if (d > -1) {
        r(d);
        return;
      }
      if (p === 1) {
        const u = i.blocks.getBlockByIndex(0),
          g = (u == null ? void 0 : u.name) === "paragraph" && u.isEmpty;
        r(g ? 0 : 1);
        return;
      }
      r(Math.max(0, p - 1));
    ...
    c = (d, p) => {
      ...
      (u == null ? void 0 : u.name) === "paragraph" && u.isEmpty
        ? (i.blocks.delete(n), i.blocks.insert(d, p, void 0, n))
        : i.blocks.insert(d, p, void 0, n + 1);
    },
    l = (() => {
      if (!o) return "768px";
    ...
    children: [
      s &&
        v.jsxs(pd, {
          top: 40,
          children: [
            s === "place" && v.jsx(ld, { addBlock: c }),
            s === "emoji" && v.jsx(Hl, { addBlock: c }),
            s === "line" && v.jsx(ql, { addBlock: c }),
          ],
        }),
      v.jsxs(hd, {
        position: { top: t, right: 0, width: l ?? "768px" },
        children: [
          v.jsx(wl, { handleBlockIndex: a, addBlock: c, onUpload: e }),
          v.jsx(_l, { handleBlockIndex: a, addBlock: c, onUpload: e }),
          v.jsx(Tl, { handleBlockIndex: a, addBlock: c, onUpload: e }),
          v.jsx(ml, { handleBlockIndex: a, addBlock: c, onUpload: e }),
          v.jsx(ul, { handleBlockIndex: a }),
          v.jsx(Sl, { handleBlockIndex: a }),
          v.jsx(cl, {}),
          v.jsx(Ll, { addBlock: c, handleBlockIndex: a }),
        ],
      }),
    ],
  });
...
Element.prototype.scrollIntoViewIfNeeded ||
  (Element.prototype.scrollIntoViewIfNeeded = function (t) {
    t = arguments.length === 0 ? !0 : !!t;
    const e = this.parentNode,
      o = window.getComputedStyle(e, null),
      i = parseInt(o.getPropertyValue("border-top-width")),
      s = parseInt(o.getPropertyValue("border-left-width")),
      n = this.offsetTop - e.offsetTop < e.scrollTop,
      r =
        this.offsetTop - e.offsetTop + this.clientHeight - i >
        e.scrollTop + e.clientHeight,
      a = this.offsetLeft - e.offsetLeft < e.scrollLeft,
      c =
        this.offsetLeft - e.offsetLeft + this.clientWidth - s >
    ...
    (n || r) &&
      ...
      (a || c) &&
        ...
        (e.scrollLeft =
          ...
          s +
          this.clientWidth / 2),
      (n || r || a || c) && !t && this.scrollIntoView(l);
  });
...
function Zo(t, e, o = "log", i, s = "color: inherit") {
  if (!("console" in window) || !window.console[o]) return;
  const n = ["info", "log", "warn", "error"].includes(o),
    r = [];
  switch (Zo.logLevel) {
    case "ERROR":
      if (o !== "error") return;
      break;
    case "WARN":
      if (!["error", "warn"].includes(o)) return;
      break;
    case "INFO":
      if (!n || t) return;
      break;
...
async function wd(t, e = () => {}, o = () => {}) {
  async function i(s, n, r) {
    try {
      await s.function(s.data), await n(xn(s.data) ? {} : s.data);
    } catch {
      r(xn(s.data) ? {} : s.data);
    }
  }
    ...
    return (
      ...
      d <= 0 || d > e
        ? (r && (clearTimeout(r), (r = null)),
          ...
          (n = t.apply(i, s)),
          r || (i = s = null))
        : !r && o.trailing !== !1 && (r = setTimeout(c, d)),
      n
    );
  };
}
function Sd() {
  const t = { win: !1, mac: !1, x11: !1, linux: !1 },
    e = Object.keys(t).find(
      (o) => window.navigator.appVersion.toLowerCase().indexOf(o) !== -1
    );
  return e && (t[e] = !0), t;
}
function ji(t) {
...
function bt(t, ...e) {
  ...
  if (_e(t) && _e(o))
    for (const i in o)
      _e(o[i])
        ? (t[i] || Object.assign(t, { [i]: {} }), bt(t[i], o[i]))
        : Object.assign(t, { [i]: o[i] });
  return bt(t, ...e);
}
function zt(t) {
  const e = Sd();
  return (
    (t = t
      ...
      .replace(/\+/gi, " + ")),
    e.mac
      ? (t = t.replace(/ctrl|cmd/gi, "⌘").replace(/alt/gi, "⌥"))
      : (t = t.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN")),
    t
  );
}
function Ed(t) {
...
function Pd(t, e) {
  const o = Array.isArray(t) || _e(t),
    i = Array.isArray(e) || _e(e);
...
class _ {
  ...
  static prepend(e, o) {
    Array.isArray(o)
      ? ((o = o.reverse()), o.forEach((i) => e.prepend(i)))
      : e.prepend(o);
  }
  static swap(e, o) {
  ...
  static findAllInputs(e) {
    return vr(e.querySelectorAll(_.allInputsSelector)).reduce(
      (o, i) =>
        _.isNativeInput(i) || _.containsOnlyInlineElements(i)
          ? [...o, i]
          : [...o, ..._.getDeepestBlockElements(i)],
      []
    );
  }
  static getDeepestNode(e, o = !1) {
    const i = o ? "lastChild" : "firstChild",
    ...
    if (e && e.nodeType === Node.ELEMENT_NODE && e[i]) {
      ...
      if (_.isSingleTag(n) && !_.isNativeInput(n) && !_.isLineBreakTag(n))
        if (n[s]) n = n[s];
        else if (n.parentNode[s]) n = n.parentNode[s];
  ...
  static isElement(e) {
    return jn(e) ? !1 : e && e.nodeType && e.nodeType === Node.ELEMENT_NODE;
  }
  static isFragment(e) {
    return jn(e)
      ? !1
  ...
  static isEmpty(e, o) {
    ...
    for (; i.length > 0; )
      if (((e = i.shift()), !!e)) {
        if (this.isLeaf(e) && !this.isNodeEmpty(e, o)) return !1;
  ...
  static containsOnlyInlineElements(e) {
    ...
    const i = (s) =>
      !_.blockElements.includes(s.tagName.toLowerCase()) &&
      Array.from(s.children).every(i);
    return Array.from(o.children).every(i);
  }
  static getDeepestBlockElements(e) {
    return _.containsOnlyInlineElements(e)
      ? [e]
      : Array.from(e.children).reduce(
          (o, i) => [...o, ..._.getDeepestBlockElements(i)],
          []
        );
  }
  static getHolder(e) {
  ...
  static offset(e) {
    const o = e.getBoundingClientRect(),
      ...
      n = o.top + s,
      r = o.left + i;
    return { top: n, left: r, bottom: n + o.height, right: r + o.width };
  }
}
function Id(t) {
  return !/[^\t\n\r ]/.test(t);
...
function Od(t) {
  const e = window.getComputedStyle(t),
    ...
    i = parseFloat(e.lineHeight) || o * 1.2,
...
const Ad = {
  ...
  yr = { ui: Ad, toolNames: Ld, tools: Nd, blockTunes: Fd },
  br = class xo {
    static ui(e, o) {
      return xo._t(e, o);
    }
    ...
    static getNamespace(e) {
      return e
        ...
        .reduce(
          ...
          xo.currentDictionary
        );
    }
  };
br.currentDictionary = yr;
let Ee = br;
...
class Jo {
  ...
  once(e, o) {
    ...
    const i = (s) => {
      const n = o(s),
        r = this.subscribers[e].indexOf(i);
...
class Qo {
  ...
  on(e, o, i, s = !1) {
    const n = Td("l"),
      r = { id: n, element: e, eventType: o, handler: i, options: s };
  ...
  findAll(e, o, i) {
    ...
    return (
      e && o && i
        ? (s = n.filter((r) => r.eventType === o && r.handler === i))
        : e && o
        ? (s = n.filter((r) => r.eventType === o))
        : (s = n),
      s
    );
  }
  ...
  findByType(e) {
    return this.allListeners.filter((o) => {
      if (o.eventType === e) return o;
    });
  }
  findByHandler(e) {
    return this.allListeners.filter((o) => {
      if (o.handler === e) return o;
    });
  }
  findById(e) {
...
class G {
  constructor({ config: e, eventsDispatcher: o }) {
    if (
      ((this.nodes = {}),
      (this.listeners = new Qo()),
      (this.readOnlyMutableListeners = {
        on: (i, s, n, r = !1) => {
          this.mutableListenerIds.push(this.listeners.on(i, s, n, r));
        },
        clearAll: () => {
          for (const i of this.mutableListenerIds) this.listeners.offById(i);
...
class H {
  ...
  static get anchorElement() {
    ...
    return o ? (_.isElement(o) ? o : o.parentElement) : null;
  }
  ...
  static isSelectionAtEditor(e) {
    ...
    let i = null;
    return (
      o && o instanceof Element && (i = o.closest(`.${H.CSS.editorZone}`)),
      i ? i.nodeType === Node.ELEMENT_NODE : !1
    );
  }
  ...
  static get rect() {
    ...
    if (e && e.type !== "Control")
      return (
        ...
        (i.x = o.boundingLeft),
        (i.y = o.boundingTop),
        (i.width = o.boundingWidth),
        (i.height = o.boundingHeight),
        i
      );
    if (!window.getSelection)
      return oe("Method window.getSelection is not supported", "warn"), i;
    if (
      ((e = window.getSelection()),
      e.rangeCount === null || isNaN(e.rangeCount))
    )
      return oe("Method SelectionUtils.rangeCount is not supported", "warn"), i;
    if (e.rangeCount === 0) return i;
    if (
      ((o = e.getRangeAt(0).cloneRange()),
      o.getBoundingClientRect && (i = o.getBoundingClientRect()),
      i.x === 0 && i.y === 0)
    ) {
  ...
  static addFakeCursor() {
    const e = H.range;
    if (e === null) return;
    const o = _.make("span", "codex-editor__fake-cursor");
  ...
  static removeFakeCursor(e = document.body) {
    const o = _.find(e, ".codex-editor__fake-cursor");
    o && o.remove();
  }
  ...
  collapseToEnd() {
    ...
    o.selectNodeContents(e.focusNode),
      o.collapse(!1),
      e.removeAllRanges(),
      e.addRange(o);
  }
  findParentTag(e, o, i = 10) {
    ...
    let n = null;
    return !s || !s.anchorNode || !s.focusNode
      ? null
      : ([s.anchorNode, s.focusNode].forEach((r) => {
          let a = i;
          for (
            ;
            a > 0 &&
            ...
            !(
              r.tagName === e &&
              ((n = r),
              o && r.classList && !r.classList.contains(o) && (n = null),
              n)
            );
...
function Md(t, e) {
  ...
  return t.type === "attributes" && t.attributeName === "data-empty"
    ? !1
    : !!(
        e.contains(i) ||
        (o === "childList" &&
          (Array.from(s).some((r) => r === e) ||
            Array.from(n).some((r) => r === e)))
      );
}
const jt = "redactor dom changed",
  wr = "block changed",
  jr = "fake cursor is about to be toggled",
  xr = "fake cursor have been set",
  Go = "editor mobile layout toggled";
function xt(t, e) {
  if (!t.conversionConfig) return !1;
...
function Sr(t, e) {
  return Object.entries(t).some(([o, i]) => e[o] && Pd(e[o], i));
}
async function Er(t, e) {
  const o = (await t.save()).data,
    i = e.find((s) => s.name === t.name);
  return i !== void 0 && !xt(i, "export")
    ? []
    : e.reduce((s, n) => {
        if (!xt(n, "import") || n.toolbox === void 0) return s;
        const r = n.toolbox.filter((a) => {
          if (He(a) || a.icon === void 0) return !1;
          if (a.data !== void 0) {
            if (Sr(a.data, o)) return !1;
          } else if (n.name === t.name) return !1;
          return !0;
        });
        return s.push({ ...n, toolbox: r }), s;
      }, []);
}
function En(t, e) {
  return t.mergeable
...
var ne = ((t) => (
    (t.Default = "default"), (t.Separator = "separator"), (t.Html = "html"), t
  ))(ne || {}),
  Je = ((t) => (
...
class fe extends Jo {
  constructor(
    { id: e = Cd(), data: o, tool: i, readOnly: s, tunesData: n },
    r
  ) {
    super(),
      (this.cachedInputs = []),
      ...
      (this.didMutated = (a = void 0) => {
        ...
        c || l
          ...
          : (d = !(
              a.length > 0 &&
              a.every((p) => {
                const { addedNodes: u, removedNodes: g, target: m } = p;
                return [...Array.from(u), ...Array.from(g), m].some(
                  (f) => (
                    _.isElement(f) || (f = f.parentElement),
      ...
      (this.config = i.settings.config || {}),
      (this.editorEventBus = r || null),
      (this.blockAPI = new Xe(this)),
      (this.tool = i),
      (this.toolInstance = i.create(o, this.blockAPI, s)),
      (this.tunes = i.tunes),
      this.composeTunes(n),
  ...
  get mergeable() {
    return re(this.toolInstance.merge);
  }
  get focusable() {
    return this.inputs.length !== 0;
  }
  get isEmpty() {
    const e = _.isEmpty(this.pluginsContent, "/"),
      o = !this.hasMedia;
    return e && o;
  }
  get hasMedia() {
  ...
  set selected(e) {
    var o, i;
    this.holder.classList.toggle(fe.CSS.selected, e);
    const s = e === !0 && H.isRangeInsideContainer(this.holder),
      n = e === !1 && H.isFakeCursorInsideContainer(this.holder);
    (s || n) &&
      ((o = this.editorEventBus) == null || o.emit(jr, { state: e }),
      s ? H.addFakeCursor() : H.removeFakeCursor(this.holder),
      (i = this.editorEventBus) == null || i.emit(xr, { state: e }));
  }
  get selected() {
    return this.holder.classList.contains(fe.CSS.selected);
  }
  set stretched(e) {
    this.holder.classList.toggle(fe.CSS.wrapperStretched, e);
  }
  get stretched() {
    return this.holder.classList.contains(fe.CSS.wrapperStretched);
  }
  set dropTarget(e) {
    this.holder.classList.toggle(fe.CSS.dropTarget, e);
  }
  get pluginsContent() {
    return this.toolRenderedElement;
  }
  call(e, o) {
    if (re(this.toolInstance[e])) {
      e === "appendCallback" &&
        oe(
      ...
      try {
        ...
        oe(`Error during '${e}' call: ${i.message}`, "error");
      }
    }
  }
  async mergeWith(e) {
    ...
    return Promise.resolve(e)
      .then(
        (n) => (
          ...
          { id: this.id, tool: this.name, data: n, tunes: o, time: s - i }
        )
      )
      .catch((n) => {
        oe(
  ...
  async validate(e) {
    ...
    return (
      this.toolInstance.validate instanceof Function &&
        (o = await this.toolInstance.validate(e)),
      o
    );
  }
  getTunes() {
    ...
    return (
      ...
      [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()]
        ...
        .forEach((s) => {
          _.isElement(s)
            ? o.push({ type: ne.Html, element: s })
            : Array.isArray(s)
            ? o.push(...s)
            : o.push(s);
        }),
      { toolTunes: e, commonTunes: o }
    );
  }
  updateCurrentInput() {
    this.currentInput =
      _.isNativeInput(document.activeElement) || !H.anchorNode
  ...
  destroy() {
    this.unwatchBlockMutations(),
      ...
      super.destroy(),
      re(this.toolInstance.destroy) && this.toolInstance.destroy();
  }
  async getActiveToolboxEntry() {
    const e = this.tool.toolbox;
    if (e.length === 1) return Promise.resolve(this.tool.toolbox[0]);
    const o = await this.data,
      i = e;
    return i == null ? void 0 : i.find((s) => Sr(s.data, o));
  }
  async exportDataAsString() {
    const e = await this.data;
    return Dd(e, this.tool.conversionConfig);
  }
  compose() {
    const e = _.make("div", fe.CSS.wrapper),
      o = _.make("div", fe.CSS.content),
      i = this.toolInstance.render();
    (e.dataset.id = this.id),
      (this.toolRenderedElement = i),
      o.appendChild(this.toolRenderedElement);
    let s = o;
    return (
      [
  ...
  composeTunes(e) {
    Array.from(this.tunes.values()).forEach((o) => {
      (o.isInternal ? this.defaultTunesInstances : this.tunesInstances).set(
        o.name,
        o.create(e[o.name], this.blockAPI)
      );
    }),
  ...
  addInputEvents() {
    this.inputs.forEach((e) => {
      e.addEventListener("focus", this.handleFocus),
        _.isNativeInput(e) && e.addEventListener("input", this.didMutated);
    });
  }
  removeInputEvents() {
    this.inputs.forEach((e) => {
      e.removeEventListener("focus", this.handleFocus),
        _.isNativeInput(e) && e.removeEventListener("input", this.didMutated);
    });
  }
  watchBlockMutations() {
    var e;
    (this.redactorDomChangedCallback = (o) => {
      const { mutations: i } = o;
      i.some((s) => Md(s, this.toolRenderedElement)) && this.didMutated(i);
    }),
      (e = this.editorEventBus) == null ||
        e.on(jt, this.redactorDomChangedCallback);
  }
  unwatchBlockMutations() {
    var e;
    (e = this.editorEventBus) == null ||
      e.off(jt, this.redactorDomChangedCallback);
  }
...
class Rd extends G {
  constructor() {
    super(...arguments),
      ...
      (this.update = async (e, o, i) => {
        const { BlockManager: s } = this.Editor,
          n = s.getBlockById(e);
        if (n === void 0) throw new Error(`Block with id "${e}" not found`);
      ...
      (this.convert = async (e, o, i) => {
        ...
        const { BlockManager: r, Tools: a } = this.Editor,
          c = r.getBlockById(e);
        if (!c) throw new Error(`Block with id "${e}" not found`);
        const l = a.blockTools.get(c.name),
          d = a.blockTools.get(o);
        if (!d) throw new Error(`Block Tool with type "${o}" not found`);
        const p =
            ((s = l == null ? void 0 : l.conversionConfig) == null
              ? void 0
              : s.export) !== void 0,
          u = ((n = d.conversionConfig) == null ? void 0 : n.import) !== void 0;
        if (p && u) {
          const g = await r.convert(c, o, i);
          return new Xe(g);
        } else {
          const g = [p ? !1 : ji(c.name), u ? !1 : ji(o)]
            .filter(Boolean)
            .join(" and ");
          throw new Error(
            `Conversion from "${c.name}" to "${o}" is not possible. ${g} tool(s) should provide a "conversionConfig"`
          );
        }
      }),
      (this.insertMany = (
        e,
        o = this.Editor.BlockManager.blocks.length - 1
      ) => {
        this.validateIndex(o);
        const i = e.map(({ id: s, type: n, data: r }) =>
        ...
        return (
          this.Editor.BlockManager.insertMany(i, o), i.map((s) => new Xe(s))
        );
      });
  }
  get methods() {
  ...
  getBlockIndex(e) {
    ...
    if (!o) {
      De("There is no block with id `" + e + "`", "warn");
      return;
    }
  ...
  getBlockByIndex(e) {
    ...
    if (o === void 0) {
      De("There is no block at index `" + e + "`", "warn");
      return;
    }
    return new Xe(o);
  }
  getById(e) {
    const o = this.Editor.BlockManager.getBlockById(e);
    return o === void 0
      ? (De("There is no block with id `" + e + "`", "warn"), null)
      : new Xe(o);
  }
  getBlockByElement(e) {
    const o = this.Editor.BlockManager.getBlock(e);
    if (o === void 0) {
      De("There is no block corresponding to element `" + e + "`", "warn");
      return;
    }
    return new Xe(o);
  }
  ...
  stretchBlock(e, o = !0) {
    kt(!0, "blocks.stretchBlock()", "BlockAPI");
...
function Hd(t, e) {
  return typeof t == "number"
    ? e.BlockManager.getBlockByIndex(t)
    : typeof t == "string"
    ? e.BlockManager.getBlockById(t)
    : e.BlockManager.getBlockById(t.id);
}
class $d extends G {
  constructor() {
    super(...arguments),
      (this.setToFirstBlock = (
        ...
        this.Editor.BlockManager.firstBlock
          ? (this.Editor.Caret.setToBlock(
            ...
            !0)
          : !1),
      (this.setToLastBlock = (e = this.Editor.Caret.positions.DEFAULT, o = 0) =>
      ...
      (this.setToPreviousBlock = (
        ...
        this.Editor.BlockManager.previousBlock
          ? (this.Editor.Caret.setToBlock(
            ...
            !0)
          : !1),
      (this.setToNextBlock = (e = this.Editor.Caret.positions.DEFAULT, o = 0) =>
      ...
      (this.setToBlock = (
        e,
        o = this.Editor.Caret.positions.DEFAULT,
        i = 0
      ) => {
        const s = Hd(e, this.Editor);
...
class Ut extends G {
  ...
  get methods() {
    return {
      t: () => {
        De("I18n.t() method can be accessed only from Tools", "warn");
      },
    };
  }
  getMethodsForTool(e, o) {
    return Object.assign(this.methods, {
      t: (i) => Ee.t(Ut.getNamespace(e, o), i),
    });
  }
}
class Ud extends G {
                  ...
                  if (l && typeof btoa == "function") {
                    var u =
                        ...
                        "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," +
                          btoa(
                            unescape(encodeURIComponent(JSON.stringify(m)))
                          ) +
                          " */"),
                      g = p.sources.map(function (f) {
                        return "/*# sourceURL=" + p.sourceRoot + f + " */";
                      });
                    return [d].concat(g).concat([u]).join(`
`);
                  }
                  var m;
                  return [d].join(`
      ...
      function (o, i, s) {
        ...
        function m(S, k) {
          for (var L = 0; L < S.length; L++) {
            ...
            if (P) {
              P.refs++;
              for (var N = 0; N < P.parts.length; N++) P.parts[N](C.parts[N]);
              for (; N < C.parts.length; N++) P.parts.push(O(C.parts[N], k));
            } else {
              var y = [];
              for (N = 0; N < C.parts.length; N++) y.push(O(C.parts[N], k));
              a[C.id] = { id: C.id, refs: 1, parts: y };
            }
          }
        }
        function f(S, k) {
          for (var L = [], C = {}, P = 0; P < S.length; P++) {
            var N = S[P],
              y = k.base ? N[0] + k.base : N[0],
              E = { css: N[1], media: N[2], sourceMap: N[3] };
            C[y] ? C[y].parts.push(E) : L.push((C[y] = { id: y, parts: [E] }));
          }
          return L;
        }
        function x(S, k) {
          var L = l(S.insertInto);
          if (!L)
            throw new Error(
          ...
          if (S.insertAt === "top")
            C
              ? C.nextSibling
                ? L.insertBefore(k, C.nextSibling)
                : L.appendChild(k)
              : L.insertBefore(k, L.firstChild),
              u.push(k);
          else if (S.insertAt === "bottom") L.appendChild(k);
          else {
...
`);
            var P = l(S.insertInto + " " + S.insertAt.before);
            L.insertBefore(k, P);
          }
        }
        function w(S) {
        ...
        function b(S) {
          ...
          return (
            S.attrs.type === void 0 && (S.attrs.type = "text/css"),
            T(k, S.attrs),
            x(S, k),
            k
          );
        ...
        function T(S, k) {
          Object.keys(k).forEach(function (L) {
            S.setAttribute(L, k[L]);
          });
        }
        function O(S, k) {
          var L, C, P, N;
          if (k.transform && S.css) {
            if (!(N = k.transform(S.css))) return function () {};
            S.css = N;
          }
          if (k.singleton) {
            var y = p++;
            ...
            typeof btoa == "function"
              ? ((L = (function (E) {
                  ...
                  return (
                    E.attrs.type === void 0 && (E.attrs.type = "text/css"),
                ...
                (C = function (E, $, q) {
                  var V = q.css,
                    K = q.sourceMap,
                    ve = $.convertToAbsoluteUrls === void 0 && K;
                  ($.convertToAbsoluteUrls || ve) && (V = g(V)),
                    K &&
                      (V +=
                        `
/*# sourceMappingURL=data:application/json;base64,` +
                        btoa(unescape(encodeURIComponent(JSON.stringify(K)))) +
                        " */");
                  var te = new Blob([V], { type: "text/css" }),
                    X = E.href;
                  (E.href = URL.createObjectURL(te)),
                    X && URL.revokeObjectURL(X);
                }.bind(null, L, k)),
                (P = function () {
                  w(L), L.href && URL.revokeObjectURL(L.href);
                }))
              : ((L = b(k)),
                (C = function (E, $) {
                  var q = $.css,
                    V = $.media;
                  if ((V && E.setAttribute("media", V), E.styleSheet))
                    E.styleSheet.cssText = q;
                  else {
                    for (; E.firstChild; ) E.removeChild(E.firstChild);
                    E.appendChild(document.createTextNode(q));
                  }
                }.bind(null, L)),
                (P = function () {
                  w(L);
        ...
        o.exports = function (S, k) {
          if (typeof DEBUG < "u" && DEBUG && typeof document != "object")
            throw new Error(
              "The style-loader cannot be used in a non-browser environment"
            );
          ((k = k || {}).attrs = typeof k.attrs == "object" ? k.attrs : {}),
            k.singleton ||
              typeof k.singleton == "boolean" ||
              (k.singleton = c()),
            k.insertInto || (k.insertInto = "head"),
            k.insertAt || (k.insertAt = "bottom");
          var L = f(S, k);
          return (
            m(L, k),
            function (C) {
              for (var P = [], N = 0; N < L.length; N++) {
                var y = L[N];
                (E = a[y.id]).refs--, P.push(E);
              }
              for (C && m(f(C, k), k), N = 0; N < P.length; N++) {
                var E;
                if ((E = P[N]).refs === 0) {
                  for (var $ = 0; $ < E.parts.length; $++) E.parts[$]();
                  delete a[E.id];
                }
              }
            }
...
`)
        ...
        function I(S, k, L, C) {
          var P = L ? "" : C.css;
          if (S.styleSheet) S.styleSheet.cssText = B(k, P);
          else {
            var N = document.createTextNode(P),
              y = S.childNodes;
            y[k] && S.removeChild(y[k]),
              y.length ? S.insertBefore(N, y[k]) : S.appendChild(N);
          }
        }
      },
      function (o, i) {
        o.exports = function (s) {
          ...
          return s.replace(
            ...
            function (c, l) {
              ...
              return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(p)
                ? c
                : ((d =
                    p.indexOf("//") === 0
                      ? p
      ...
      function (o, i, s) {
        var n, r, a, c, l, d, p, u, g;
        o.exports =
          ((n = "cdx-notifies"),
          (r = "cdx-notify"),
          (a = "cdx-notify__cross"),
          (c = "cdx-notify__button--confirm"),
          (l = "cdx-notify__button--cancel"),
          (d = "cdx-notify__input"),
          (p = "cdx-notify__button"),
          (u = "cdx-notify__btns-wrapper"),
          {
            alert: (g = function (m) {
              ...
              return (
                f.classList.add(r),
                b && f.classList.add(r + "--" + b),
                (f.innerHTML = w),
                x.classList.add(a),
                x.addEventListener("click", f.remove.bind(f)),
                f.appendChild(x),
                f
              );
            }),
            confirm: function (m) {
              ...
              return (
                ...
                (b.innerHTML = m.cancelText || "Cancel"),
                w.classList.add(p),
                b.classList.add(p),
                w.classList.add(c),
                b.classList.add(l),
                ...
                A && typeof A == "function" && w.addEventListener("click", A),
                w.addEventListener("click", f.remove.bind(f)),
                b.addEventListener("click", f.remove.bind(f)),
                x.appendChild(w),
                x.appendChild(b),
                f.appendChild(x),
                f
            ...
            prompt: function (m) {
              ...
              return (
                ...
                w.classList.add(c),
                b.classList.add(d),
                m.placeholder && b.setAttribute("placeholder", m.placeholder),
                m.default && (b.value = m.default),
                m.inputType && (b.type = m.inputType),
                O && typeof O == "function" && T.addEventListener("click", O),
                A &&
                  typeof A == "function" &&
...
class Gd extends G {
  constructor({ config: e, eventsDispatcher: o }) {
    super({ config: e, eventsDispatcher: o }), (this.notifier = new Yd());
  }
  get methods() {
...
(function (t, e) {
  (function (o, i) {
    ...
    (o.prototype.clean = function (p) {
      ...
      return (g.innerHTML = p), this._sanitize(u, g), g.innerHTML;
    }),
        ...
        if (m)
          do {
            if (m.nodeType === Node.TEXT_NODE)
              if (
                m.data.trim() === "" &&
                ((m.previousElementSibling && s(m.previousElementSibling)) ||
                  (m.nextElementSibling && s(m.nextElementSibling)))
              ) {
            ...
            var f = r(m),
              x;
            f && (x = Array.prototype.some.call(m.childNodes, s));
            var w = !!u.parentNode,
              b = s(u) && s(m) && w,
              T = m.nodeName.toLowerCase(),
              O = c(this.config, T, m),
              A = f && x;
            if (A || l(m, O) || (!this.config.keepNestedBlockElements && b)) {
            ...
            for (var B = 0; B < m.attributes.length; B += 1) {
              var I = m.attributes[B];
              d(I, O, m) && (m.removeAttribute(I.name), (B = B - 1));
            }
            this._sanitize(p, m);
          } while ((m = g.nextSibling()));
      });
    function a(p, u) {
    ...
    function c(p, u, g) {
      return typeof p.tags[u] == "function" ? p.tags[u](g) : p.tags[u];
    }
    function l(p, u) {
...
function qt(t, e) {
  return t.map((o) => {
    const i = re(e) ? e(o.tool) : e;
    return He(i) || (o.data = Vt(o.data, i)), o;
  });
}
function Ke(t, e = {}) {
  const o = { tags: e };
  return new Jd(o).clean(t);
}
function Vt(t, e) {
  return Array.isArray(t) ? Qd(t, e) : _e(t) ? eu(t, e) : Qe(t) ? ou(t, e) : t;
}
function Qd(t, e) {
...
function ou(t, e) {
  return _e(e) ? Ke(t, e) : e === !1 ? Ke(t, {}) : t;
}
function iu(t) {
  return _e(t) || kd(t) || re(t);
}
class tu extends G {
  get methods() {
    return { clean: (e, o) => this.clean(e, o) };
  }
  clean(e, o) {
    return Ke(e, o);
  }
...
class su extends G {
  ...
  save() {
    ...
    return this.Editor.ReadOnly.isEnabled
      ? (De(e, "warn"), Promise.reject(new Error(e)))
        ...
        class n {
          ...
          placeBottom(a, c) {
            const l = a.getBoundingClientRect(),
              d =
                l.left + a.clientWidth / 2 - this.nodes.wrapper.offsetWidth / 2,
              p = l.bottom + window.pageYOffset + this.offsetTop + c.marginTop;
          ...
          placeRight(a, c) {
            const l = a.getBoundingClientRect(),
              d = l.right + this.offsetRight + c.marginRight,
              p =
                l.top +
                window.pageYOffset +
                a.clientHeight / 2 -
          ...
          applyPlacement(a, c, l) {
            this.nodes.wrapper.classList.add(this.CSS.placement[a]),
              (this.nodes.wrapper.style.left = c + "px"),
              (this.nodes.wrapper.style.top = l + "px");
          }
          make(a, c = null, l = {}) {
            const d = document.createElement(a);
            Array.isArray(c) ? d.classList.add(...c) : c && d.classList.add(c);
            for (const p in l) l.hasOwnProperty(p) && (d[p] = l[p]);
            return d;
          }
          append(a, c) {
            Array.isArray(c)
              ? c.forEach((l) => a.appendChild(l))
              : a.appendChild(c);
          }
          prepend(a, c) {
            Array.isArray(c)
              ? (c = c.reverse()).forEach((l) => a.prepend(l))
              : a.prepend(c);
          }
        }
      },
...
function uu(t, e, o) {
  Wt(), Ue == null || Ue.show(t, e, o);
}
function Si(t = !1) {
  Wt(), Ue == null || Ue.hide(t);
}
function Ei(t, e, o) {
  Wt(), Ue == null || Ue.onHover(t, e, o);
}
function pu() {
...
class gu extends G {
  constructor({ config: e, eventsDispatcher: o }) {
    super({ config: e, eventsDispatcher: o });
  }
  get methods() {
    return {
...
function Pr(t, e) {
  ...
  return (
    Object.entries(t).forEach(([i, s]) => {
      if (_e(s)) {
        const n = e ? `${e}.${i}` : i;
        Object.values(s).every((r) => Qe(r)) ? (o[i] = n) : (o[i] = Pr(s, n));
        return;
      }
      o[i] = s;
    }),
...
const Ir = class Vo {
  ...
  next() {
    this.cursor = this.leafNodesAndReturnIndex(Vo.directions.RIGHT);
  }
  previous() {
    this.cursor = this.leafNodesAndReturnIndex(Vo.directions.LEFT);
  }
  dropCursor() {
    this.cursor !== -1 &&
  ...
  leafNodesAndReturnIndex(e) {
    ...
    return (
      o === -1
        ? (o = e === Vo.directions.RIGHT ? -1 : 0)
        : this.items[o].classList.remove(this.focusedCssClass),
      e === Vo.directions.RIGHT
        ? (o = (o + 1) % this.items.length)
        : (o = (this.items.length + o - 1) % this.items.length),
      _.canSetCaret(this.items[o]) &&
        wi(() => H.setCursor(this.items[o]), 50)(),
      this.items[o].classList.add(this.focusedCssClass),
      o
    );
  }
};
Ir.directions = { RIGHT: "right", LEFT: "left" };
let $o = Ir;
class yo {
  constructor(e) {
    (this.iterator = null),
      ...
      (this.onKeyDown = (o) => {
        if (this.isEventReadyForHandling(o))
          switch (
            (yo.usedKeys.includes(o.keyCode) && o.preventDefault(), o.keyCode)
          ) {
            case U.TAB:
      ...
      (this.iterator = new $o(e.items, e.focusedItemClass)),
      (this.activateCallback = e.activateCallback),
      (this.allowedKeys = e.allowedKeys || yo.usedKeys);
  }
  get isActivated() {
    return this.activated;
  }
  static get usedKeys() {
    return [U.TAB, U.LEFT, U.RIGHT, U.ENTER, U.UP, U.DOWN];
  }
  activate(e, o) {
    (this.activated = !0),
      e && this.iterator.setItems(e),
      o !== void 0 && this.iterator.setCursor(o),
...
function to(t) {
  return (e, o) =>
    [[t, e].filter((i) => !!i).join(Tu), o].filter((i) => !!i).join(Pu);
}
const zo = to("ce-hint"),
  Uo = {
    root: zo(),
    alignedStart: zo(null, "align-left"),
    alignedCenter: zo(null, "align-center"),
    title: zo("title"),
...
class Iu {
  constructor(e) {
    (this.nodes = {
      ...
      title: _.make("div", Uo.title, { textContent: e.title }),
    }),
      this.nodes.root.appendChild(this.nodes.title),
      e.description !== void 0 &&
        ((this.nodes.description = _.make("div", Uo.description, {
...
class Kt {
  ...
  handleClick() {
    ...
    this.params !== void 0 &&
      ...
      ((o = (e = this.params).onActivate) == null || o.call(e, this.params));
  }
  addHint(e, o) {
    const i = new Iu(o);
    Ei(e, i.getElement(), { placement: o.position, hidingDelay: 100 });
  }
  get children() {
    var e;
...
const Ie = to("ce-popover-item"),
  ce = {
    container: Ie(),
    active: Ie(null, "active"),
    disabled: Ie(null, "disabled"),
    focused: Ie(null, "focused"),
    hidden: Ie(null, "hidden"),
    confirmationState: Ie(null, "confirmation"),
    noHover: Ie(null, "no-hover"),
    noFocus: Ie(null, "no-focus"),
    title: Ie("title"),
    secondaryTitle: Ie("secondary-title"),
    icon: Ie("icon"),
    iconTool: Ie("icon", "tool"),
    iconChevronRight: Ie("icon", "chevron-right"),
    wobbleAnimation: to("wobble")(),
  };
class go extends Kt {
  constructor(e, o) {
    super(e),
      ...
      (this.removeSpecialFocusBehavior = () => {
        var i;
        (i = this.nodes.root) == null || i.classList.remove(ce.noFocus);
      }),
      (this.removeSpecialHoverBehavior = () => {
        var i;
        (i = this.nodes.root) == null || i.classList.remove(ce.noHover);
      }),
      (this.onErrorAnimationEnd = () => {
        var i, s;
        (i = this.nodes.icon) == null || i.classList.remove(ce.wobbleAnimation),
          (s = this.nodes.icon) == null ||
            s.removeEventListener("animationend", this.onErrorAnimationEnd);
      }),
  ...
  get isFocused() {
    return this.nodes.root === null
      ? !1
      : this.nodes.root.classList.contains(ce.focused);
  }
  getElement() {
    return this.nodes.root;
  }
  ...
  toggleActive(e) {
    var o;
    (o = this.nodes.root) == null || o.classList.toggle(ce.active, e);
  }
  toggleHidden(e) {
    var o;
    (o = this.nodes.root) == null || o.classList.toggle(ce.hidden, e);
  }
  reset() {
  ...
  make(e, o) {
    var i, s;
    const n = (o == null ? void 0 : o.wrapperTag) || "div",
      r = _.make(n, ce.container, { type: n === "button" ? "button" : void 0 });
    return (
      e.name && (r.dataset.itemName = e.name),
      (this.nodes.icon = _.make("div", [ce.icon, ce.iconTool], {
        innerHTML: e.icon || wu,
      })),
      r.appendChild(this.nodes.icon),
      e.title !== void 0 &&
        r.appendChild(_.make("div", ce.title, { innerHTML: e.title || "" })),
      e.secondaryLabel &&
        r.appendChild(
          _.make("div", ce.secondaryTitle, { textContent: e.secondaryLabel })
        ),
      this.hasChildren &&
        r.appendChild(
          _.make("div", [ce.icon, ce.iconChevronRight], { innerHTML: yu })
        ),
      this.isActive && r.classList.add(ce.active),
      e.isDisabled && r.classList.add(ce.disabled),
      e.hint !== void 0 &&
        ((i = o == null ? void 0 : o.hint) == null ? void 0 : i.enabled) !==
          !1 &&
        this.addHint(r, {
          ...e.hint,
          position:
            ((s = o == null ? void 0 : o.hint) == null ? void 0 : s.position) ||
            "right",
        }),
      r
    );
  ...
  enableConfirmationMode(e) {
    ...
    const o = {
      ...
      i = this.make(o);
    (this.nodes.root.innerHTML = i.innerHTML),
      this.nodes.root.classList.add(ce.confirmationState),
  ...
  disableConfirmationMode() {
    ...
    (this.nodes.root.innerHTML = e.innerHTML),
      this.nodes.root.classList.remove(ce.confirmationState),
      (this.confirmationState = null),
      this.disableSpecialHoverAndFocusBehavior();
  }
  enableSpecialHoverAndFocusBehavior() {
    var e, o, i;
    (e = this.nodes.root) == null || e.classList.add(ce.noHover),
      (o = this.nodes.root) == null || o.classList.add(ce.noFocus),
      (i = this.nodes.root) == null ||
        i.addEventListener("mouseleave", this.removeSpecialHoverBehavior, {
          once: !0,
        });
  }
  ...
  activateOrEnableConfirmationMode(e) {
    ...
    if (!("confirmation" in e) || e.confirmation === void 0)
      try {
        (o = e.onActivate) == null || o.call(e, e),
  ...
  animateError() {
    ...
    ((e = this.nodes.icon) != null &&
      e.classList.contains(ce.wobbleAnimation)) ||
      ((o = this.nodes.icon) == null || o.classList.add(ce.wobbleAnimation),
      (i = this.nodes.icon) == null ||
        i.addEventListener("animationend", this.onErrorAnimationEnd));
  }
}
const tt = to("ce-popover-item-separator"),
  st = { container: tt(), line: tt("line"), hidden: tt(null, "hidden") };
class Ar extends Kt {
  constructor() {
    super(),
      (this.nodes = {
        root: _.make("div", st.container),
        line: _.make("div", st.line),
      }),
...
var Ye = ((t) => (
  (t.Closed = "closed"), (t.ClosedOnActivate = "closed-on-activate"), t
))(Ye || {});
const Se = to("ce-popover"),
  ue = {
    popover: Se(),
    popoverContainer: Se("container"),
    popoverOpenTop: Se(null, "open-top"),
    popoverOpenLeft: Se(null, "open-left"),
    popoverOpened: Se(null, "opened"),
    search: Se("search"),
    nothingFoundMessage: Se("nothing-found-message"),
    nothingFoundMessageDisplayed: Se("nothing-found-message", "displayed"),
    items: Se("items"),
    overlay: Se("overlay"),
    overlayHidden: Se("overlay", "hidden"),
    popoverNested: Se(null, "nested"),
    getPopoverNestedClass: (t) => Se(null, `nested-level-${t.toString()}`),
    popoverInline: Se(null, "inline"),
    popoverHeader: Se("header"),
  };
var Eo = ((t) => (
  (t.NestingLevel = "--nesting-level"),
  (t.PopoverHeight = "--popover-height"),
  (t.InlinePopoverWidth = "--inline-popover-width"),
  (t.TriggerItemLeft = "--trigger-item-left"),
  (t.TriggerItemTop = "--trigger-item-top"),
  t
))(Eo || {});
const Tn = to("ce-popover-item-html"),
  Pn = { root: Tn(), hidden: Tn(null, "hidden") };
class Xo extends Kt {
  constructor(e, o) {
    var i, s;
    super(e),
      (this.nodes = { root: _.make("div", Pn.root) }),
  ...
  toggleHidden(e) {
    var o;
    (o = this.nodes.root) == null || o.classList.toggle(Pn.hidden, e);
  }
  getControls() {
...
class Lr extends Jo {
  constructor(e, o = {}) {
    super(),
      ...
      (this.nodes = {}),
      (this.nodes.popoverContainer = _.make("div", [ue.popoverContainer])),
      (this.nodes.nothingFoundMessage = _.make(
        "div",
        [ue.nothingFoundMessage],
        { textContent: this.messages.nothingFound }
      )),
      this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage),
      (this.nodes.items = _.make("div", [ue.items])),
      this.items.forEach((i) => {
        const s = i.getElement();
        s !== null && this.nodes.items.appendChild(s);
      }),
      this.nodes.popoverContainer.appendChild(this.nodes.items),
      this.listeners.on(this.nodes.popoverContainer, "click", (i) =>
        this.handleClick(i)
      ),
      (this.nodes.popover = _.make("div", [ue.popover, this.params.class])),
  ...
  show() {
    this.nodes.popover.classList.add(ue.popoverOpened),
      this.search !== void 0 && this.search.focus();
  }
  hide() {
    this.nodes.popover.classList.remove(ue.popoverOpened),
      this.nodes.popover.classList.remove(ue.popoverOpenTop),
    ...
    return e.map((o) => {
      switch (o.type) {
        case ne.Separator:
          return new Ar();
        case ne.Html:
          return new Xo(o, this.itemsRenderParams[ne.Html]);
        default:
          return new go(o, this.itemsRenderParams[ne.Default]);
      }
    });
  }
  getTargetItem(e) {
    return this.items
      .filter((o) => o instanceof go || o instanceof Xo)
      .find((o) => {
  ...
  handleItemClick(e) {
    if (!("isDisabled" in e && e.isDisabled)) {
      ...
      this.itemsDefault.filter((o) => o !== e).forEach((o) => o.reset()),
        "handleClick" in e &&
          typeof e.handleClick == "function" &&
          e.handleClick(),
...
var Ci = ((t) => ((t.Search = "search"), t))(Ci || {});
const nt = to("cdx-search-field"),
  rt = { wrapper: nt(), icon: nt("icon"), input: nt("input") };
class Ou extends Jo {
  constructor({ items: e, placeholder: o }) {
    super(),
      (this.listeners = new Qo()),
      (this.items = e),
      (this.wrapper = _.make("div", rt.wrapper));
    const i = _.make("div", rt.icon, { innerHTML: Eu });
    (this.input = _.make("input", rt.input, { placeholder: o, tabIndex: -1 })),
  ...
  clear() {
    (this.input.value = ""),
      (this.searchQuery = ""),
      this.emit(Ci.Search, { query: "", items: this.foundItems });
  }
  destroy() {
    this.listeners.removeAll();
  }
  ...
  checkItem(e) {
    var o, i;
    const s = ((o = e.title) == null ? void 0 : o.toLowerCase()) || "",
      n = (i = this.searchQuery) == null ? void 0 : i.toLowerCase();
...
var Au = Object.defineProperty,
  ...
  Nu = (t, e, o, i) => {
    for (var s = Lu(e, o), n = t.length - 1, r; n >= 0; n--)
      (r = t[n]) && (s = r(e, o, s) || s);
    return s && Au(e, o, s), s;
  };
const Nr = class Fr extends Lr {
  constructor(e, o) {
    super(e, o),
      (this.nestingLevel = 0),
      ...
      (this.hide = () => {
        ...
        super.hide(),
          ...
          (i = this.flipper) == null || i.deactivate(),
          (this.previouslyHoveredItem = null);
      }),
      (this.onFlip = () => {
      ...
      (this.onSearch = (i) => {
        ...
        this.items.forEach((c) => {
          let l = !1;
          c instanceof go
            ? (l = !i.items.includes(c))
            : (c instanceof Ar || c instanceof Xo) && (l = r || !n),
            c.toggleHidden(l);
        }),
      ...
      this.nestingLevel > 0 &&
        this.nodes.popover.classList.add(ue.popoverNested),
      e.scopeElement !== void 0 && (this.scopeElement = e.scopeElement),
      this.nodes.popoverContainer !== null &&
        this.listeners.on(this.nodes.popoverContainer, "mouseover", (i) =>
          this.handleHover(i)
        ),
      ...
      e.flippable !== !1 &&
        ((this.flipper = new yo({
          ...
          focusedItemClass: ce.focused,
          allowedKeys: [U.TAB, U.UP, U.DOWN, U.ENTER],
        })),
  ...
  show() {
    ...
    this.nodes.popover.style.setProperty(
      ...
      this.shouldOpenBottom ||
        this.nodes.popover.classList.add(ue.popoverOpenTop),
      this.shouldOpenRight ||
        this.nodes.popover.classList.add(ue.popoverOpenLeft),
      super.show(),
  ...
  handleHover(e) {
    const o = this.getTargetItem(e);
    o !== void 0 &&
      this.previouslyHoveredItem !== o &&
      (this.destroyNestedPopoverIfExists(),
      (this.previouslyHoveredItem = o),
      o.hasChildren && this.showNestedPopoverForItem(o));
  }
  setTriggerItemPosition(e, o) {
    const i = o.getElement(),
      s = (i ? i.offsetTop : 0) - this.scrollTop,
      n = this.offsetTop + s;
  ...
  showNestedPopoverForItem(e) {
    ...
    return (
      this.nodes.popover.appendChild(i),
      this.setTriggerItemPosition(i, e),
      i.style.setProperty(
        Eo.NestingLevel,
  ...
  get shouldOpenBottom() {
    ...
    const e = this.nodes.popoverContainer.getBoundingClientRect(),
      o = this.scopeElement.getBoundingClientRect(),
      i = this.size.height,
      s = e.top + i,
      n = e.top - i,
      r = Math.min(window.innerHeight, o.bottom);
    return n < o.top || s <= r;
  }
  get shouldOpenRight() {
    if (this.nodes.popover === void 0 || this.nodes.popover === null) return !1;
    const e = this.nodes.popover.getBoundingClientRect(),
      ...
      s = e.right + i,
      n = e.left - i,
      r = Math.min(window.innerWidth, o.right);
    return n < o.left || s <= r;
  }
  get size() {
    var e;
    const o = { height: 0, width: 0 };
    if (this.nodes.popover === null) return o;
    const i = this.nodes.popover.cloneNode(!0);
    (i.style.visibility = "hidden"),
      (i.style.position = "absolute"),
      (i.style.top = "-1000px"),
      i.classList.add(ue.popoverOpened),
      (e = i.querySelector("." + ue.popoverNested)) == null || e.remove(),
      document.body.appendChild(i);
    const s = i.querySelector("." + ue.popoverContainer);
    return (
      (o.height = s.offsetHeight), (o.width = s.offsetWidth), i.remove(), o
    );
  }
  get flippableElements() {
    return this.items
      .map((e) => {
        if (e instanceof go) return e.getElement();
  ...
  addSearch() {
    (this.search = new Ou({
      ...
      this.search.on(Ci.Search, this.onSearch);
    const e = this.search.getElement();
    e.classList.add(ue.search),
  ...
  toggleNothingFoundMessage(e) {
    this.nodes.nothingFoundMessage.classList.toggle(
      ue.nothingFoundMessageDisplayed,
      e
    );
  }
};
Nu([Fo], Nr.prototype, "size");
let Yt = Nr;
class Fu extends Yt {
  constructor(e) {
    const o = !Mo();
    super(
      { ...e, class: ue.popoverInline },
      {
        [ne.Default]: {
          wrapperTag: "button",
          hint: { position: "top", alignment: "center", enabled: o },
        },
        [ne.Html]: {
          hint: { position: "top", alignment: "center", enabled: o },
        },
      ...
      this.items.forEach((i) => {
        (!(i instanceof go) && !(i instanceof Xo)) ||
          (i.hasChildren && i.isChildrenOpen && this.showNestedItems(i));
      });
  }
  get offsetLeft() {
    return this.nodes.popoverContainer === null
  ...
  setTriggerItemPosition(e, o) {
    const i = o.getElement(),
      s = i ? i.offsetLeft : 0,
      n = this.offsetLeft + s;
    e.style.setProperty(Eo.TriggerItemLeft, n + "px");
  }
  showNestedItems(e) {
  ...
  showNestedPopoverForItem(e) {
    ...
    return (
      o.getElement().classList.add(ue.getPopoverNestedClass(o.nestingLevel)), o
    );
  }
  handleItemClick(e) {
    var o;
    e !== this.nestedPopoverTriggerItem &&
      ((o = this.nestedPopoverTriggerItem) == null || o.handleClick(),
...
const Mr = class Wo {
  ...
  lock() {
    wt ? this.lockHard() : document.body.classList.add(Wo.CSS.scrollLocked);
  }
  unlock() {
    wt
      ? this.unlockHard()
      : document.body.classList.remove(Wo.CSS.scrollLocked);
  }
  lockHard() {
  ...
  unlockHard() {
    document.body.classList.remove(Wo.CSS.scrollLockedHard),
...
let Mu = Mr;
const at = to("ce-popover-header"),
  ct = { root: at(), text: at("text"), backButton: at("back-button") };
class Du {
  constructor({ text: e, onBackButtonClick: o }) {
    (this.listeners = new Qo()),
      (this.text = e),
      (this.onBackButtonClick = o),
      (this.nodes = {
        root: _.make("div", [ct.root]),
        backButton: _.make("button", [ct.backButton]),
        text: _.make("div", [ct.text]),
      }),
      (this.nodes.backButton.innerHTML = _u),
...
class Dr extends Lr {
  constructor(e) {
    super(e, {
      [ne.Default]: { hint: { enabled: !1 } },
      [ne.Html]: { hint: { enabled: !1 } },
    }),
      (this.scrollLocker = new Mu()),
      (this.history = new Ru()),
      (this.isHidden = !0),
      (this.nodes.overlay = _.make("div", [ue.overlay, ue.overlayHidden])),
  ...
  show() {
    this.nodes.overlay.classList.remove(ue.overlayHidden),
      super.show(),
  ...
  hide() {
    this.isHidden ||
      (super.hide(),
      this.nodes.overlay.classList.add(ue.overlayHidden),
...
class Hu extends G {
  constructor() {
    super(...arguments),
      (this.opened = !1),
      (this.selection = new H()),
      (this.popover = null),
      (this.close = () => {
        this.opened &&
          ((this.opened = !1),
          H.isAtEditor || this.selection.restore(),
  ...
  make() {
    (this.nodes.wrapper = _.make("div", [this.CSS.settings])),
      this.eventsDispatcher.on(Go, this.close);
  }
  destroy() {
    this.removeAllNodes(),
      this.listeners.destroy(),
      this.eventsDispatcher.off(Go, this.close);
  }
  async open(e = this.Editor.BlockManager.currentBlock) {
    ...
    (this.popover = new n({
      ...
      messages: {
        nothingFound: Ee.ui(Oe.ui.popover, "Nothing found"),
        search: Ee.ui(Oe.ui.popover, "Filter"),
      },
    })),
      this.popover.on(Ye.Closed, this.onPopoverClose),
      (o = this.nodes.wrapper) == null || o.append(this.popover.getElement()),
      this.popover.show();
  }
  getElement() {
  ...
  async getTunesItems(e, o, i) {
    ...
    i !== void 0 &&
      i.length > 0 &&
      (s.push(...i), s.push({ type: ne.Separator }));
    const n = Array.from(this.Editor.Tools.blockTools.values()),
      r = (await Er(e, n)).reduce(
        (a, c) => (
          c.toolbox.forEach((l) => {
            a.push({
              icon: l.icon,
              title: Ee.t(Oe.toolNames, l.title),
              name: c.name,
              closeOnActivate: !0,
              onActivate: async () => {
                const { BlockManager: d, Caret: p, Toolbar: u } = this.Editor,
                  g = await d.convert(e, c.name, l.data);
                u.close(), p.setToBlock(g, p.positions.END);
              },
            });
          }),
          a
    ...
    return (
      r.length > 0 &&
        (s.push({
          icon: Or,
          name: "convert-to",
          title: Ee.ui(Oe.ui.popover, "Convert to"),
          children: { searchable: !0, items: r },
        }),
        s.push({ type: ne.Separator })),
      s.push(...o),
      s.map((a) => this.resolveTuneAliases(a))
    );
  }
  resolveTuneAliases(e) {
    if (e.type === ne.Separator || e.type === ne.Html) return e;
    const o = mu(e, { label: "title" });
    return (
      e.confirmation &&
        (o.confirmation = this.resolveTuneAliases(e.confirmation)),
      o
    );
  }
}
        ...
        var a = (function () {
          function c(l) {
            ...
            (function (p, u) {
              ...
              (this.keys = {}),
              (this.name = l.name),
              this.parseShortcutName(l.name),
              (this.element = l.on),
              (this.callback = l.callback),
              (this.executeShortcut = function (p) {
                d.execute(p);
              }),
            ...
            r(c, [
              ...
              },
              {
                ...
                value: function (l) {
                  ...
                  var g,
                    m = !0;
                  for (g in this.keys) m = m && l.keyCode === c.keyCodes[g];
                  u && m && this.callback(l);
                },
              },
              {
...
class Uu {
  ...
  add(e) {
    ...
    const o = new zu({ name: e.name, on: e.on, callback: e.handler }),
...
var qu = Object.defineProperty,
  ...
  Hr = (t, e, o, i) => {
    for (var s = Vu(e, o), n = t.length - 1, r; n >= 0; n--)
      (r = t[n]) && (s = r(e, o, s) || s);
    return s && qu(e, o, s), s;
  },
  gi = ((t) => (
    (t.Opened = "toolbox-opened"),
    (t.Closed = "toolbox-closed"),
    (t.BlockAdded = "toolbox-block-added"),
    t
  ))(gi || {});
const Gt = class $r extends Jo {
  constructor({ api: e, tools: o, i18nLabels: i }) {
    super(),
      ...
      (this.nodes = { toolbox: _.make("div", $r.CSS.toolbox) }),
      this.initPopover(),
      this.api.events.on(Go, this.handleMobileLayoutToggle);
  }
  get isEmpty() {
  ...
  destroy() {
    ...
    super.destroy(),
      ...
      this.listeners.destroy(),
      this.api.events.off(Go, this.handleMobileLayoutToggle);
  }
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (o, i) => ({
      icon: o.icon,
      title: Ee.t(Oe.toolNames, o.title || ji(i.name)),
      name: i.name,
      onActivate: () => {
    ...
    return this.toolsToBeDisplayed.reduce(
      (o, i) => (
        Array.isArray(i.toolbox)
          ? i.toolbox.forEach((s) => {
              o.push(e(s, i));
            })
          : i.toolbox !== void 0 && o.push(e(i.toolbox, i)),
        o
      ),
      []
    );
    ...
    Ao.add({
      ...
      handler: async (i) => {
        ...
        const s = this.api.blocks.getCurrentBlockIndex(),
          n = this.api.blocks.getBlockByIndex(s);
        if (n)
          try {
  ...
  async insertNewBlock(e, o) {
    ...
    const a = this.api.blocks.insert(e, r, void 0, n, void 0, s.isEmpty);
    a.call(Je.APPEND_CALLBACK),
      this.api.caret.setToBlock(n),
      this.emit("toolbox-block-added", { block: a }),
      this.api.toolbar.close();
  }
};
Hr([Fo], Gt.prototype, "toolsToBeDisplayed");
Hr([Fo], Gt.prototype, "toolboxItemsToBeDisplayed");
let Wu = Gt;
const zr = "block hovered";
...
class Yu extends G {
  constructor({ config: e, eventsDispatcher: o }) {
    super({ config: e, eventsDispatcher: o }), (this.toolboxInstance = null);
  }
  get CSS() {
    return {
      toolbar: "ce-toolbar",
    ...
    return {
      ...
      open: () => {
        if (this.toolboxInstance === null) {
          oe("toolbox.open() called before initialization is finished", "warn");
          return;
        }
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.hoveredBlock = e;
    const o = e.holder,
      { isMobile: i } = this.Editor.UI;
    let s;
    const n = 20,
      r = e.firstInput,
      a = o.getBoundingClientRect(),
      c = r !== void 0 ? r.getBoundingClientRect() : null,
      l = c !== null ? c.top - a.top : null,
      d = l !== null ? l > n : void 0;
    if (i) s = o.offsetTop + o.offsetHeight;
    else if (r === void 0 || d) {
    ...
    (this.nodes.wrapper.style.top = `${Math.floor(s)}px`),
  ...
  async make() {
    (this.nodes.wrapper = _.make("div", this.CSS.toolbar)),
      ["content", "actions"].forEach((n) => {
        this.nodes[n] = _.make("div", this.CSS[n]);
      }),
      _.append(this.nodes.wrapper, this.nodes.content),
      _.append(this.nodes.content, this.nodes.actions),
      (this.nodes.plusButton = _.make("div", this.CSS.plusButton, {
        innerHTML: Su,
      })),
      _.append(this.nodes.actions, this.nodes.plusButton),
      this.readOnlyMutableListeners.on(
        this.nodes.plusButton,
        "click",
        () => {
          Si(!0), this.plusButtonClicked();
        },
        !1
      );
    const e = _.make("div");
    e.appendChild(document.createTextNode(Ee.ui(Oe.ui.toolbar.toolbox, "Add"))),
      e.appendChild(
        _.make("div", this.CSS.plusButtonShortcut, { textContent: "/" })
      ),
      Ei(this.nodes.plusButton, e, { hidingDelay: 400 }),
      (this.nodes.settingsToggler = _.make("span", this.CSS.settingsToggler, {
        innerHTML: xu,
      })),
      _.append(this.nodes.actions, this.nodes.settingsToggler);
    const o = _.make("div"),
      i = _.text(Ee.ui(Oe.ui.blockTunes.toggler, "Click to tune")),
      s = await Ku("Slash", "/");
    o.appendChild(i),
      o.appendChild(
        _.make("div", this.CSS.plusButtonShortcut, {
          textContent: zt(`CMD + ${s}`),
        })
      ),
      Ei(this.nodes.settingsToggler, o, { hidingDelay: 400 }),
      _.append(this.nodes.actions, this.makeToolbox()),
      _.append(this.nodes.actions, this.Editor.BlockSettings.getElement()),
      _.append(this.Editor.UI.nodes.wrapper, this.nodes.wrapper);
  }
  makeToolbox() {
    return (
      (this.toolboxInstance = new Wu({
        api: this.Editor.API.methods,
        tools: this.Editor.Tools.blockTools,
        i18nLabels: {
          filter: Ee.ui(Oe.ui.popover, "Filter"),
          nothingFound: Ee.ui(Oe.ui.popover, "Nothing found"),
        },
      })),
      ...
      this.toolboxInstance.on(gi.BlockAdded, ({ block: e }) => {
        const { BlockManager: o, Caret: i } = this.Editor,
          s = o.getBlockById(e.id);
        s.inputs.length === 0 &&
          (s === o.lastBlock
            ? (o.insertAtEnd(), i.setToBlock(o.lastBlock))
            : i.setToBlock(o.nextBlock));
      }),
  ...
  enableModuleBindings() {
    this.readOnlyMutableListeners.on(
      ...
      Mo() ||
        this.eventsDispatcher.on(zr, (e) => {
          var o;
          this.Editor.BlockSettings.opened ||
            ((o = this.toolboxInstance) != null && o.opened) ||
...
var vo = ((t) => (
  ...
  Ur = ((t) => ((t.Shortcut = "shortcut"), (t.SanitizeConfig = "sanitize"), t))(
    Ur || {}
  ),
  So = ((t) => (
  ...
  Xt = ((t) => ((t.IsInline = "isInline"), (t.Title = "title"), t))(Xt || {}),
  St = ((t) => ((t.IsTune = "isTune"), t))(St || {});
class Zt {
  constructor({
    name: e,
    constructable: o,
  ...
  reset() {
    if (re(this.constructable.reset)) return this.constructable.reset();
  }
  prepare() {
    if (re(this.constructable.prepare))
...
class Gu extends G {
  constructor({ config: e, eventsDispatcher: o }) {
    super({ config: e, eventsDispatcher: o }),
      ...
      (this.opened = !1),
      (this.popover = null),
      (this.toolbarVerticalMargin = Mo() ? 20 : 6),
  ...
  close() {
    ...
    this.opened &&
      (this.Editor.ReadOnly.isEnabled ||
        (Array.from(this.toolsInstances.entries()).forEach(([i, s]) => {
          const n = this.getToolShortcut(i);
          n && Ao.remove(this.Editor.UI.nodes.redactor, n),
            re(s.clear) && s.clear();
        }),
  ...
  move(e) {
    const o = H.rect,
      i = this.Editor.UI.nodes.wrapper.getBoundingClientRect(),
      s = {
        x: o.x - i.x,
        y: o.y + o.height - i.top + this.toolbarVerticalMargin,
      };
    s.x + e + i.x > this.Editor.UI.contentRect.right &&
      (s.x = this.Editor.UI.contentRect.right - e - i.x),
      (this.nodes.wrapper.style.left = Math.floor(s.x) + "px"),
      (this.nodes.wrapper.style.top = Math.floor(s.y) + "px");
  }
  reset() {
  ...
  allowedToShow() {
    const e = ["IMG", "INPUT"],
      o = H.get(),
      i = H.text;
    if (!o || !o.anchorNode || o.isCollapsed || i.length < 1) return !1;
    const s = _.isElement(o.anchorNode)
      ? o.anchorNode
      : o.anchorNode.parentElement;
    if (
      s === null ||
      (o && e.includes(s.tagName)) ||
      s.closest('[contenteditable="true"]') === null
    )
      return !1;
  ...
  async getInlineTools() {
    const e = H.get(),
      o = this.Editor.BlockManager.getBlock(e.anchorNode),
      i = Array.from(o.tool.inlineTools.values()),
      s = [];
    ...
    for (let n = 0; n < i.length; n++) {
      ...
      const d = l !== void 0 ? zt(l) : void 0,
        p = Ee.t(Oe.toolNames, r.title || ji(r.name));
      [c].flat().forEach((u) => {
        var g, m;
        const f = {
          name: r.name,
          ...
          hint: { title: p, description: d },
        };
        if (_.isElement(u)) {
          const x = { ...f, element: u, type: ne.Html };
          if (re(a.renderActions)) {
            const w = a.renderActions();
            x.children = {
              isOpen: (g = a.checkState) == null ? void 0 : g.call(a, H.get()),
              isFlippable: !1,
              items: [{ type: ne.Html, element: w }],
            };
          } else (m = a.checkState) == null || m.call(a, H.get());
          s.push(x);
        } else if (u.type === ne.Html) s.push({ ...f, ...u, type: ne.Html });
        else if (u.type === ne.Separator) s.push({ type: ne.Separator });
        else {
          const x = { ...f, ...u, type: ne.Default };
          "children" in x && n !== 0 && s.push({ type: ne.Separator }),
            s.push(x),
            "children" in x &&
              n < i.length - 1 &&
              s.push({ type: ne.Separator });
  ...
  getToolShortcut(e) {
    const { Tools: o } = this.Editor,
      i = o.inlineTools.get(e),
      s = o.internal.inlineTools;
    return Array.from(s.keys()).includes(e)
      ? this.inlineTools[e][Ur.Shortcut]
      : i == null
      ? void 0
      : i.shortcut;
  }
  ...
  get inlineTools() {
    const e = {};
    return (
      Array.from(this.Editor.Tools.inlineTools.entries()).forEach(([o, i]) => {
        e[o] = i.create();
      }),
      e
    );
...
function qr() {
  ...
  return e === null
    ...
    : (e.nodeType !== Node.TEXT_NODE &&
        ...
        (e.childNodes[o]
          ? ((e = e.childNodes[o]), (o = 0))
          : ((e = e.childNodes[o - 1]), (o = e.textContent.length))),
      [e, o]);
}
function Vr(t, e, o, i) {
  const s = document.createRange();
  i === "left"
    ? (s.setStart(t, 0), s.setEnd(e, o))
    : (s.setStart(e, o), s.setEnd(t, t.childNodes.length));
  const n = s.cloneContents(),
...
function mi(t) {
  ...
  if (e === null || _.isEmpty(t)) return !0;
  if (_.isNativeInput(e)) return e.selectionEnd === 0;
  if (_.isEmpty(t)) return !0;
  const [o, i] = qr();
  return o === null ? !1 : Vr(t, o, i, "left");
}
function vi(t) {
  const e = _.getDeepestNode(t, !0);
  if (e === null) return !0;
  if (_.isNativeInput(e)) return e.selectionEnd === e.value.length;
  const [o, i] = qr();
  return o === null ? !1 : Vr(t, o, i, "right");
}
class Xu extends G {
  keydown(e) {
  ...
  handleCommandX(e) {
    ...
    o.anyBlockSelected &&
      o.copySelectedBlocks(e).then(() => {
        const n = i.removeSelectedBlocks(),
          r = i.insertDefaultBlockAtIndex(n, !0);
  ...
  enter(e) {
    const { BlockManager: o, UI: i } = this.Editor,
      s = o.currentBlock;
    if (
      s === void 0 ||
      s.tool.isLineBreaksEnabled ||
      (i.someToolbarOpened && i.someFlipperButtonFocused) ||
      (e.shiftKey && !wt)
    )
      return;
    let n = s;
    s.currentInput !== void 0 && mi(s.currentInput) && !s.hasMedia
      ? this.Editor.BlockManager.insertDefaultBlockAtIndex(
          this.Editor.BlockManager.currentBlockIndex
        )
      : s.currentInput && vi(s.currentInput)
      ? (n = this.Editor.BlockManager.insertDefaultBlockAtIndex(
  ...
  backspace(e) {
    const { BlockManager: o, Caret: i } = this.Editor,
      { currentBlock: s, previousBlock: n } = o;
    if (
      !(
        s === void 0 ||
        !H.isCollapsed ||
      ...
      if (n !== null) {
        ...
        En(n, s) ? this.mergeBlocks(n, s) : i.setToBlock(n, i.positions.END);
      }
    }
  }
  delete(e) {
    const { BlockManager: o, Caret: i } = this.Editor,
      { currentBlock: s, nextBlock: n } = o;
    if (!(!H.isCollapsed || !vi(s.currentInput))) {
      if (
        (e.preventDefault(),
        this.Editor.Toolbar.close(),
        s.currentInput !== s.lastInput)
      ) {
        i.navigateNext();
        return;
      }
      if (n !== null) {
        ...
        En(s, n) ? this.mergeBlocks(s, n) : i.setToBlock(n, i.positions.START);
      }
    }
  }
  mergeBlocks(e, o) {
    const { BlockManager: i, Caret: s, Toolbar: n } = this.Editor;
    s.createShadow(e.lastInput),
      i.mergeBlocks(e, o).then(() => {
        s.restoreCaret(e.pluginsContent), n.close();
      });
  }
  arrowRightAndDown(e) {
    const o =
      yo.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === U.TAB);
    if (this.Editor.UI.someToolbarOpened && o) return;
    this.Editor.Toolbar.close();
    const { currentBlock: i } = this.Editor.BlockManager,
      s =
        ((i == null ? void 0 : i.currentInput) !== void 0
          ? vi(i.currentInput)
          : void 0) || this.Editor.BlockSelection.anyBlockSelected;
    if (e.shiftKey && e.keyCode === U.DOWN && s) {
      this.Editor.CrossBlockSelection.toggleBlockSelectedState();
      return;
    }
    if (
      e.keyCode === U.DOWN || (e.keyCode === U.RIGHT && !this.isRtl)
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (
        yo.usedKeys.includes(e.keyCode) &&
        (!e.shiftKey || e.keyCode === U.TAB)
      )
        return;
    ...
    const { currentBlock: o } = this.Editor.BlockManager,
      i =
        ((o == null ? void 0 : o.currentInput) !== void 0
          ? mi(o.currentInput)
          : void 0) || this.Editor.BlockSelection.anyBlockSelected;
    if (e.shiftKey && e.keyCode === U.UP && i) {
      this.Editor.CrossBlockSelection.toggleBlockSelectedState(!1);
      return;
    }
    if (
      e.keyCode === U.UP || (e.keyCode === U.LEFT && !this.isRtl)
        ? this.Editor.Caret.navigatePrevious()
        : this.Editor.Caret.navigateNext()
    ) {
      e.preventDefault();
  ...
  needToolbarClosing(e) {
    const o = e.keyCode === U.ENTER && this.Editor.Toolbar.toolbox.opened,
      i = e.keyCode === U.ENTER && this.Editor.BlockSettings.opened,
      s = e.keyCode === U.ENTER && this.Editor.InlineToolbar.opened,
      n = e.keyCode === U.TAB;
...
class lt {
  ...
  get nodes() {
    return vr(this.workingArea.children);
  }
  static set(e, o, i) {
  ...
  swap(e, o) {
    ...
    _.swap(this.blocks[e].holder, i.holder),
      (this.blocks[o] = this.blocks[e]),
      (this.blocks[e] = i);
  }
  move(e, o) {
    const i = this.blocks.splice(o, 1)[0],
      s = e - 1,
      n = Math.max(0, s),
      r = this.blocks[n];
    e > 0
      ? this.insertToDOM(i, "afterend", r)
      : this.insertToDOM(i, "beforebegin", r),
      this.blocks.splice(e, 0, i);
    const a = this.composeBlockEvent("move", { fromIndex: o, toIndex: e });
    i.call(Je.MOVED, a);
  }
  insert(e, o, i = !1) {
    if (!this.length) {
    ...
    e > this.length && (e = this.length),
      i && (this.blocks[e].holder.remove(), this.blocks[e].call(Je.REMOVED));
    const s = i ? 1 : 0;
  ...
  insertMany(e, o) {
    ...
    for (const s of e) i.appendChild(s.holder);
    if (this.length > 0) {
      if (o > 0) {
        const s = Math.min(o - 1, this.length - 1);
        this.blocks[s].holder.after(i);
      } else o === 0 && this.workingArea.prepend(i);
      this.blocks.splice(o, 0, ...e);
    } else this.blocks.push(...e), this.workingArea.appendChild(i);
    e.forEach((s) => s.call(Je.RENDERED));
  }
  remove(e) {
    isNaN(e) && (e = this.length - 1),
      this.blocks[e].holder.remove(),
      this.blocks[e].call(Je.REMOVED),
      this.blocks.splice(e, 1);
  }
  removeAll() {
    (this.workingArea.innerHTML = ""),
      this.blocks.forEach((e) => e.call(Je.REMOVED)),
  ...
  insertToDOM(e, o, i) {
    o
      ? i.holder.insertAdjacentElement(o, e.holder)
      : this.workingArea.appendChild(e.holder),
      e.call(Je.RENDERED);
  }
  composeBlockEvent(e, o) {
    return new CustomEvent(e, { detail: o });
  }
}
const In = "block-removed",
  On = "block-added",
  Zu = "block-moved",
  An = "block-changed";
class Ju {
...
class Qu extends G {
  ...
  prepare() {
    ...
    (this._blocks = new Proxy(e, { set: lt.set, get: lt.get })),
      this.listeners.on(document, "copy", (o) =>
        this.Editor.BlockEvents.handleCommandC(o)
      );
  }
  toggleReadOnly(e) {
    e ? this.disableModuleBindings() : this.enableModuleBindings();
  }
  composeBlock({ tool: e, data: o = {}, id: i = void 0, tunes: s = {} }) {
  ...
  insert({
    ...
    const l = this.composeBlock({ id: e, tool: o, data: i, tunes: a });
    return (
      r && this.blockDidMutated(In, this.getBlockByIndex(c), { index: c }),
      this._blocks.insert(c, l, r),
      this.blockDidMutated(On, l, { index: c }),
      n
        ? (this.currentBlockIndex = c)
        : c <= this.currentBlockIndex && this.currentBlockIndex++,
      l
    );
  }
  insertMany(e, o = 0) {
  ...
  async update(e, o, i) {
    ...
    return (
      this._blocks.replace(r, n), this.blockDidMutated(An, n, { index: r }), n
    );
  }
  replace(e, o, i) {
    const s = this.getBlockIndex(e);
    return this.insert({ tool: o, data: i, index: s, replace: !0 });
  }
  paste(e, o, i = !1) {
    const s = this.insert({ tool: e, replace: i });
    try {
      window.requestIdleCallback(() => {
        s.call(Je.ON_PASTE, o);
      });
    } catch (n) {
      oe(`${e}: onPaste callback call is failed`, "error", n);
    }
    return s;
  }
  insertDefaultBlockAtIndex(e, o = !1) {
    ...
    return (
      (this._blocks[e] = i),
      this.blockDidMutated(On, i, { index: e }),
      o
  ...
  async mergeBlocks(e, o) {
    ...
    if (e.name === o.name && e.mergeable) {
      ...
      i = n;
    } else if (e.mergeable && xi(o, "export") && xi(e, "import")) {
      const s = await o.exportDataAsString(),
        n = Ke(s, e.tool.sanitizeConfig);
      i = Cn(n, e.tool.conversionConfig);
    }
    i !== void 0 &&
      (await e.mergeWith(i),
      this.removeBlock(o),
  ...
  removeBlock(e, o = !0) {
    return new Promise((i) => {
      ...
      e.destroy(),
        this._blocks.remove(s),
        this.blockDidMutated(In, e, { index: s }),
        this.currentBlockIndex >= s && this.currentBlockIndex--,
        this.blocks.length
          ? s === 0 && (this.currentBlockIndex = 0)
          : (this.unsetCurrentBlock(), o && this.insert()),
        i();
    });
  }
  ...
  split() {
    const e = this.Editor.Caret.extractFragmentFromCaretPosition(),
      o = _.make("div");
    o.appendChild(e);
    const i = { text: _.isEmpty(o) ? "" : o.innerHTML };
  ...
  getBlock(e) {
    ...
    const o = this._blocks.nodes,
      i = e.closest(`.${fe.CSS.wrapper}`),
      s = o.indexOf(i);
    if (s >= 0) return this._blocks[s];
  }
  setCurrentBlockByChildNode(e) {
    _.isElement(e) || (e = e.parentNode);
    const o = e.closest(`.${fe.CSS.wrapper}`);
    if (!o) return;
    const i = o.closest(`.${this.Editor.UI.CSS.editorWrapper}`);
    if (i != null && i.isEqualNode(this.Editor.UI.nodes.wrapper))
      return (
        (this.currentBlockIndex = this._blocks.nodes.indexOf(o)),
  ...
  move(e, o = this.currentBlockIndex) {
    if (isNaN(e) || isNaN(o)) {
      oe("Warning during 'move' call: incorrect indices provided.", "warn");
      return;
    }
    ...
    this._blocks.move(e, o),
      (this.currentBlockIndex = e),
      this.blockDidMutated(Zu, this.currentBlock, { fromIndex: o, toIndex: e });
  }
  async convert(e, o, i) {
    if (!(await e.save()))
      throw new Error(
    ...
    if (!s) throw new Error(`Could not convert Block. Tool «${o}» not found.`);
    const n = await e.exportDataAsString(),
      r = Ke(n, s.sanitizeConfig);
    let a = Cn(r, s.conversionConfig);
  ...
  bindBlockEvents(e) {
    ...
    this.readOnlyMutableListeners.on(e.holder, "keydown", (i) => {
      ...
      e.on("didMutated", (i) =>
        this.blockDidMutated(An, i, { index: this.getBlockIndex(i) })
      );
  }
  disableModuleBindings() {
    this.readOnlyMutableListeners.clearAll();
  ...
  blockDidMutated(e, o, i) {
    const s = new CustomEvent(e, { detail: { target: new Xe(o), ...i } });
    return this.eventsDispatcher.emit(wr, { event: s }), o;
  }
}
class ep extends G {
  constructor() {
  ...
  get anyBlockSelected() {
    ...
    return (
      this.anyBlockSelectedCache === null &&
        (this.anyBlockSelectedCache = e.blocks.some((o) => o.selected === !0)),
  ...
  unSelectBlockByIndex(e) {
    const { BlockManager: o } = this.Editor;
    let i;
    isNaN(e) ? (i = o.currentBlock) : (i = o.getBlockByIndex(e)),
      (i.selected = !1),
      this.clearCache();
  }
  clearSelection(e, o = !1) {
    ...
    if (this.anyBlockSelected && r && a && !H.isSelectionExists) {
      ...
      i.insertDefaultBlockAtIndex(c, !0),
        s.setToBlock(i.currentBlock),
        wi(() => {
          const l = e.key;
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((n) => {
      const r = Ke(n.holder.innerHTML, this.sanitizerConfig),
        a = _.make("p");
...
`),
  ...
  selectBlockByIndex(e) {
    const { BlockManager: o } = this.Editor,
      i = o.getBlockByIndex(e);
    i !== void 0 && this.selectBlock(i);
  }
  selectBlock(e) {
    this.selection.save(),
      H.get().removeAllRanges(),
      (e.selected = !0),
      this.clearCache(),
      this.Editor.InlineToolbar.close();
  }
  ...
  handleCommandA(e) {
    if (
      (this.Editor.RectangleSelection.clearSelection(),
      _.isNativeInput(e.target) && !this.readyToBlockSelection)
    ) {
      this.readyToBlockSelection = !0;
      return;
    }
    const o = this.Editor.BlockManager.getBlock(e.target),
      i = o.inputs;
    ...
    this.needToSelectAll
      ...
      : this.readyToBlockSelection &&
        (e.preventDefault(), this.selectBlock(o), (this.needToSelectAll = !0));
  }
  selectAllBlocks() {
    this.selection.save(),
      H.get().removeAllRanges(),
...
class Bi extends G {
  ...
  setToBlock(e, o = this.positions.DEFAULT, i = 0) {
    ...
    if (!a) return;
    const c = _.getDeepestNode(a, o === this.positions.END),
      l = _.getContentLength(c);
    switch (!0) {
    ...
    this.set(c, i),
      n.setCurrentBlockByChildNode(e.holder),
      (n.currentBlock.currentInput = a);
  }
  setToInput(e, o = this.positions.DEFAULT, i = 0) {
    const { currentBlock: s } = this.Editor.BlockManager,
      n = _.getDeepestNode(e);
    switch (o) {
      case this.positions.START:
        this.set(n, 0);
        break;
  ...
  set(e, o = 0) {
    const { top: i, bottom: s } = H.setCursor(e, o),
  ...
  extractFragmentFromCaretPosition() {
    ...
    if (e.rangeCount) {
      const o = e.getRangeAt(0),
        i = this.Editor.BlockManager.currentBlock.currentInput;
      if ((o.deleteContents(), i))
        if (_.isNativeInput(i)) {
          const s = i,
            n = document.createDocumentFragment(),
            r = s.value.substring(0, s.selectionStart),
            a = s.value.substring(s.selectionStart);
  ...
  navigateNext(e = !1) {
    const { BlockManager: o } = this.Editor,
      { currentBlock: i, nextBlock: s } = o;
    if (i === void 0) return !1;
    const { nextInput: n, currentInput: r } = i,
      a = r !== void 0 ? vi(r) : void 0;
    let c = s;
    const l = e || a || !i.focusable;
    if (n && l) return this.setToInput(n, this.positions.START), !0;
    if (c === null) {
      if (i.tool.isDefault || !l) return !1;
      c = o.insertAtEnd();
    }
  ...
  navigatePrevious(e = !1) {
    ...
    if (!o) return !1;
    const { previousInput: s, currentInput: n } = o,
      r = n !== void 0 ? mi(n) : void 0,
      a = e || r || !o.focusable;
    return s && a
      ? (this.setToInput(s, this.positions.END), !0)
      : i !== null && a
      ? (this.setToBlock(i, this.positions.END), !0)
      : !1;
  }
  createShadow(e) {
    const o = document.createElement("span");
    o.classList.add(Bi.CSS.shadowCaret),
      e.insertAdjacentElement("beforeend", o);
  }
  restoreCaret(e) {
    const o = e.querySelector(`.${Bi.CSS.shadowCaret}`);
    if (!o) return;
    new H().expandToTag(o);
    const i = document.createRange();
  ...
  insertContentAtCaretPosition(e) {
    const o = document.createDocumentFragment(),
      ...
      n = H.range;
    (i.innerHTML = e),
      Array.from(i.childNodes).forEach((l) => o.appendChild(l)),
      o.childNodes.length === 0 && o.appendChild(new Text());
    const r = o.lastChild;
    n.deleteContents(), n.insertNode(o);
    const a = document.createRange(),
      c = r.nodeType === Node.TEXT_NODE ? r : r.firstChild;
    c !== null && c.textContent !== null && a.setStart(c, c.textContent.length),
      s.removeAllRanges(),
      s.addRange(a);
  }
}
class op extends G {
  constructor() {
    super(...arguments),
      ...
      (this.onMouseOver = (e) => {
        ...
        const s =
            o.getBlockByChildNode(e.relatedTarget) || this.lastSelectedBlock,
          n = o.getBlockByChildNode(e.target);
        if (!(!s || !n) && n !== s) {
          ...
          this.Editor.InlineToolbar.close(),
            this.toggleBlocksSelectedState(s, n),
  ...
  watchSelection(e) {
    if (e.button !== yd.LEFT) return;
    const { BlockManager: o } = this.Editor;
    (this.firstSelectedBlock = o.getBlock(e.target)),
  ...
  toggleBlockSelectedState(e = !0) {
    const { BlockManager: o, BlockSelection: i } = this.Editor;
    this.lastSelectedBlock ||
      (this.lastSelectedBlock = this.firstSelectedBlock = o.currentBlock),
      this.firstSelectedBlock === this.lastSelectedBlock &&
        ((this.firstSelectedBlock.selected = !0),
        i.clearCache(),
        H.get().removeAllRanges());
    const s = o.blocks.indexOf(this.lastSelectedBlock) + (e ? 1 : -1),
      n = o.blocks[s];
    n &&
      (this.lastSelectedBlock.selected !== n.selected
        ? ((n.selected = !0), i.clearCache())
        : ((this.lastSelectedBlock.selected = !1), i.clearCache()),
      (this.lastSelectedBlock = n),
      this.Editor.InlineToolbar.close(),
  ...
  clear(e) {
    const { BlockManager: o, BlockSelection: i, Caret: s } = this.Editor,
      n = o.blocks.indexOf(this.firstSelectedBlock),
      r = o.blocks.indexOf(this.lastSelectedBlock);
    if (
      i.anyBlockSelected &&
      n > -1 &&
      r > -1 &&
  ...
  enableCrossBlockSelection(e) {
    ...
    H.isCollapsed || this.Editor.BlockSelection.clearSelection(e),
      o.nodes.redactor.contains(e.target)
        ? this.watchSelection(e)
        : this.Editor.BlockSelection.clearSelection(e);
  }
  toggleBlocksSelectedState(e, o) {
    const { BlockManager: i, BlockSelection: s } = this.Editor,
      n = i.blocks.indexOf(e),
      r = i.blocks.indexOf(o),
      a = e.selected !== o.selected;
    for (let c = Math.min(n, r); c <= Math.max(n, r); c++) {
      const l = i.blocks[c];
      l !== this.firstSelectedBlock &&
        l !== (a ? e : o) &&
        ((i.blocks[c].selected = !i.blocks[c].selected), s.clearCache());
    }
  }
}
class ip extends G {
  ...
  async processDrop(e) {
    const { BlockManager: o, Paste: i, Caret: s } = this.Editor;
    e.preventDefault(),
      o.blocks.forEach((r) => {
        r.dropTarget = !1;
      }),
    ...
    if (n) this.Editor.Caret.setToBlock(n, s.positions.END);
    else {
  ...
  processDragStart() {
    H.isAtEditor && !H.isCollapsed && (this.isStartedAtEditor = !0),
      this.Editor.InlineToolbar.close();
  }
  processDragOver(e) {
    e.preventDefault();
...
class np extends G {
  constructor({ config: e, eventsDispatcher: o }) {
    super({ config: e, eventsDispatcher: o }),
      ...
      this.eventsDispatcher.on(wr, (i) => {
        this.particularBlockChanged(i.event);
      }),
      this.eventsDispatcher.on(jr, () => {
        this.disable();
      }),
    ...
    this.disabled ||
      ...
      (this.batchingTimeout = setTimeout(() => {
        ...
        this.batchingOnChangeQueue.size === 1
          ? (o = this.batchingOnChangeQueue.values().next().value)
          : (o = Array.from(this.batchingOnChangeQueue.values())),
          this.config.onChange &&
            this.config.onChange(this.Editor.API.methods, o),
          this.batchingOnChangeQueue.clear();
      }, this.batchTime)));
  }
  redactorChanged(e) {
    this.eventsDispatcher.emit(jt, { mutations: e });
  }
}
const Wr = class Kr extends G {
  constructor() {
    super(...arguments),
      ...
      (this.handlePasteEvent = async (e) => {
        const { BlockManager: o, Toolbar: i } = this.Editor,
          s = o.setCurrentBlockByChildNode(e.target);
        !s ||
          (this.isNativeBehaviour(e.target) &&
            !e.clipboardData.types.includes("Files")) ||
          (s && this.exceptionList.includes(s.name)) ||
          (e.preventDefault(),
  ...
  async processDataTransfer(e, o = !1) {
    const { Tools: i } = this.Editor,
      s = e.types;
    if (
      (s.includes ? s.includes("Files") : s.contains("Files")) &&
      !He(this.toolsFiles)
    ) {
    ...
    const c = Object.keys(this.toolsTags).reduce(
        (p, u) => (
          (p[u.toLowerCase()] = this.toolsTags[u].sanitizationConfig ?? {}), p
        ),
        {}
      ),
      l = Object.assign({}, c, i.getAllInlineToolsSanitizeConfig(), { br: {} }),
      d = Ke(a, l);
    !d.trim() || d.trim() === r || !_.isHTMLString(d)
      ? await this.processText(r)
      : await this.processText(d, !0);
  }
  async processText(e, o = !1) {
    const { Caret: i, BlockManager: s } = this.Editor,
      n = o ? this.processHTML(e) : this.processPlain(e);
    if (!n.length) return;
    if (n.length === 1) {
      n[0].isBlock
        ? this.processSingleBlock(n.pop())
        : this.processInlinePaste(n.pop());
      return;
    }
    const r =
      s.currentBlock && s.currentBlock.tool.isDefault && s.currentBlock.isEmpty;
    n.map(async (a, c) => this.insertBlock(a, c === 0 && r)),
  ...
  collectTagNames(e) {
    return Qe(e) ? [e] : _e(e) ? Object.keys(e) : [];
  }
  getTagsConfig(e) {
    if (e.pasteConfig === !1) return;
    const o = e.pasteConfig.tags || [],
      i = [];
    o.forEach((s) => {
      ...
      i.push(...n),
        n.forEach((r) => {
          ...
          const a = _e(s) ? s[r] : null;
          this.toolsTags[r.toUpperCase()] = { tool: e, sanitizationConfig: a };
        });
    }),
      ...
      s &&
        (s = s.filter((n) =>
          xd(n)
            ? !0
            : (oe(
                `MIME type value «${n}» for the «${e.name}» Tool is not a valid MIME type`,
                "warn"
              ),
              !1)
        )),
      (this.toolsFiles[e.name] = { extensions: i || [], mimeTypes: s || [] }));
  }
  getPatternsConfig(e) {
    e.pasteConfig === !1 ||
      !e.pasteConfig.patterns ||
      He(e.pasteConfig.patterns) ||
      Object.entries(e.pasteConfig.patterns).forEach(([o, i]) => {
        i instanceof RegExp ||
          oe(
            `Pattern ${i} for «${e.name}» Tool is skipped because it should be a Regexp instance.`,
            "warn"
          ),
          this.toolsPatterns.push({ key: o, pattern: i, tool: e });
      });
  }
  isNativeBehaviour(e) {
    return _.isNativeInput(e);
  ...
  async processFiles(e) {
    const { BlockManager: o } = this.Editor;
    let i;
    (i = await Promise.all(Array.from(e).map((n) => this.processFile(n)))),
      (i = i.filter((n) => !!n));
  ...
  async processFile(e) {
    const o = jd(e),
      i = Object.entries(this.toolsFiles).find(
        ([n, { mimeTypes: r, extensions: a }]) => {
          const [c, l] = e.type.split("/"),
            d = a.find((u) => u.toLowerCase() === o.toLowerCase()),
            p = r.find((u) => {
              const [g, m] = u.split("/");
              return g === c && (m === l || m === "*");
            });
    ...
    if (!i) return;
    const [s] = i;
    return { event: this.composePasteEvent("file", { file: e }), type: s };
  }
  processHTML(e) {
    const { Tools: o } = this.Editor,
      i = _.make("DIV");
            ...
            case Node.ELEMENT_NODE:
              (n = s),
                ...
                this.toolsTags[n.tagName] &&
                  (r = this.toolsTags[n.tagName].tool);
              break;
          }
          const { tags: c } = r.pasteConfig || { tags: [] },
            l = c.reduce(
              (u, g) => (
                this.collectTagNames(g).forEach((m) => {
                  const f = _e(g) ? g[m] : null;
                  u[m.toLowerCase()] = f || {};
                }),
                u
              ),
            ...
            d = Object.assign({}, l, r.baseSanitizeConfig);
          if (n.tagName.toLowerCase() === "table") {
            const u = Ke(n.outerHTML, d);
            n = _.make("div", void 0, { innerHTML: u }).firstChild;
          } else n.innerHTML = Ke(n.innerHTML, d);
          const p = this.composePasteEvent("tag", { data: n });
          return { content: n, isBlock: a, tool: r.name, event: p };
        })
        .filter((s) => {
          const n = _.isEmpty(s.content),
            r = _.isSingleTag(s.content);
          return !n || r;
        })
    );
  }
  processPlain(e) {
    ...
    return e
      ...
      .map((s) => {
        const n = _.make("div");
        n.textContent = s;
        const r = this.composePasteEvent("tag", { data: n });
        return { content: n, tool: i, isBlock: !1, event: r };
      });
  }
  async processSingleBlock(e) {
    ...
    if (
      !s ||
      e.tool !== s.name ||
      !_.containsOnlyInlineElements(e.content.innerHTML)
    ) {
  ...
  async processInlinePaste(e) {
    ...
    if (
      ...
      s.textContent.length < Kr.PATTERN_PROCESSING_MAX_LENGTH
    ) {
    ...
    if (o.currentBlock && o.currentBlock.currentInput) {
      ...
      document.execCommand("insertHTML", !1, Ke(s.innerHTML, n));
  ...
  async processPattern(e) {
    ...
    return o
      ? {
          event: this.composePasteEvent("pattern", { key: o.key, data: e }),
          tool: o.tool.name,
        }
      : void 0;
  }
  insertBlock(e, o = !1) {
    const { BlockManager: i, Caret: s } = this.Editor,
      { currentBlock: n } = i;
    let r;
    if (o && n && n.isEmpty) {
  ...
  insertEditorJSData(e) {
    ...
    qt(e, (n) => s.blockTools.get(n).sanitizeConfig).forEach(
      ({ tool: n, data: r }, a) => {
        let c = !1;
        a === 0 &&
          (c =
            ...
            o.currentBlock.tool.isDefault &&
            o.currentBlock.isEmpty);
        const l = o.insert({ tool: n, data: r, replace: c });
        i.setToBlock(l, i.positions.END);
      }
    );
  }
  processElementNode(e, o, i) {
    const s = Object.keys(this.toolsTags),
      n = e,
      { tool: r } = this.toolsTags[n.tagName] || {},
      a = this.tagsByTool[r == null ? void 0 : r.name] || [],
      c = s.includes(n.tagName),
      l = _.blockElements.includes(n.tagName.toLowerCase()),
      d = Array.from(n.children).some(
        ({ tagName: u }) => s.includes(u) && !a.includes(u)
      ),
      p = Array.from(n.children).some(({ tagName: u }) =>
        _.blockElements.includes(u.toLowerCase())
      );
    if (!l && !c && !d) return i.appendChild(n), [...o, i];
    if ((c && !d) || (l && !p && !d)) return [...o, i, n];
  }
  getNodes(e) {
    const o = Array.from(e.childNodes);
    let i;
    const s = (n, r) => {
      if (_.isEmpty(r) && !_.isSingleTag(r)) return n;
      const a = n[n.length - 1];
      let c = new DocumentFragment();
      switch ((a && _.isFragment(a) && (c = n.pop()), r.nodeType)) {
        case Node.ELEMENT_NODE:
          if (((i = this.processElementNode(r, n, c)), i)) return i;
          break;
        case Node.TEXT_NODE:
...
class ap extends G {
  ...
  async prepare() {
    ...
    Array.from(o.entries()).forEach(([s, n]) => {
      ...
      (this.toolsDontSupportReadOnly = i),
      this.config.readOnly && i.length > 0 && this.throwCriticalError(),
  ...
  async toggle(e = !this.readOnlyEnabled, o = !1) {
    ...
    if (i === e) return this.readOnlyEnabled;
    if (o) return this.readOnlyEnabled;
    this.Editor.ModificationsObserver.disable();
    const s = await this.Editor.Saver.save();
    return (
      await this.Editor.BlockManager.clear(),
      await this.Editor.Renderer.render(s.blocks),
      this.Editor.ModificationsObserver.enable(),
...
class Yo extends G {
  ...
  startSelection(e, o) {
    ...
    i.closest(`.${this.Editor.Toolbar.CSS.toolbar}`) ||
    ...
    const s = [
      ...
      n = i.closest("." + this.Editor.UI.CSS.editorWrapper),
      r = s.some((a) => !!i.closest(a));
  ...
  processMouseDown(e) {
    e.button === this.MAIN_MOUSE_BUTTON &&
      (e.target.closest(_.allInputsSelector) !== null ||
  ...
  genHTML() {
    const { UI: e } = this.Editor,
      o = e.nodes.holder.querySelector("." + e.CSS.editorWrapper),
      i = _.make("div", Yo.CSS.overlay, {}),
      s = _.make("div", Yo.CSS.overlayContainer, {}),
      n = _.make("div", Yo.CSS.rect, {});
    return (
      s.appendChild(n),
      i.appendChild(s),
      o.appendChild(i),
      (this.overlayRectangle = n),
      { container: o, overlay: i }
    );
  }
  scrollVertical(e) {
    ...
    window.scrollBy(0, e),
      (this.mouseY += window.pageYOffset - o),
      setTimeout(() => {
  ...
  genInfoForMouseSelection() {
    ...
    const r = this.Editor.BlockManager.lastBlock.holder.querySelector(
      ...
      c = e - a,
      l = e + a;
    return { index: n, leftPos: c, rightPos: l };
  }
  ...
  trySelectNextBlock(e) {
    const o = this.stackOfSelected[this.stackOfSelected.length - 1] === e,
      i = this.stackOfSelected.length,
      s = 1,
      n = -1,
      r = 0;
    if (o) return;
    ...
    let c = r;
    i > 1 && (c = a ? s : n);
    const l = e > this.stackOfSelected[i - 1] && c === s,
      d = e < this.stackOfSelected[i - 1] && c === n,
      p = !(l || d || c === r);
    if (
      !p &&
      (e > this.stackOfSelected[i - 1] ||
        this.stackOfSelected[i - 1] === void 0)
    ) {
...
class cp extends G {
      ...
      if (e.length === 0) s.insert();
        ...
        const n = e.map(({ type: r, data: a, tunes: c, id: l }) => {
          i.available.has(r) === !1 &&
            ...
            (a = this.composeStubDataForTool(r, a, l)),
            (r = i.stubTool));
          let d;
          try {
            d = s.composeBlock({ id: l, tool: r, data: a, tunes: c });
          } catch (p) {
            oe(`Block «${r}» skipped because of plugins error`, "error", {
              data: a,
              error: p,
            }),
              (a = this.composeStubDataForTool(r, a, l)),
  ...
  composeStubDataForTool(e, o, i) {
    ...
    return { savedData: { id: i, type: e, data: o }, title: n };
  }
}
class lp extends G {
  async save() {
    const { BlockManager: e, Tools: o } = this.Editor,
      i = e.blocks,
      s = [];
    try {
      i.forEach((a) => {
      ...
      const n = await Promise.all(s),
        r = await qt(n, (a) => o.blockTools.get(a).sanitizeConfig);
      return this.makeOutput(r);
    } catch (n) {
      De("Saving failed due to the Error %o", "error", n);
    }
  }
  async getSavedData(e) {
    const o = await e.save(),
      i = o && (await e.validate(o.data));
    return { ...o, isValid: i };
  }
  makeOutput(e) {
    const o = [];
    return (
      e.forEach(({ id: i, tool: s, data: n, tunes: r, isValid: a }) => {
        if (!a) {
          oe(`Block «${s}» skipped because saved data is invalid`);
          return;
        }
        ...
        const c = { id: i, type: s, data: n, ...(!He(r) && { tunes: r }) };
        o.push(c);
      }),
      { time: +new Date(), blocks: o, version: "2.30.7" }
    );
  }
}
(function () {
 ...
 */ class Jt {
  ...
  constructor({ data: e, config: o, api: i, readOnly: s }) {
    (this.api = i),
      ...
      (this._placeholder = o.placeholder
        ? o.placeholder
        : Jt.DEFAULT_PLACEHOLDER),
      (this._data = e ?? {}),
      (this._element = null),
      (this._preserveBlank = o.preserveBlank ?? !1);
  }
  onKeyUp(e) {
  ...
  onPaste(e) {
    const o = { text: e.detail.data.innerHTML };
    (this._data = o),
...
class es {
  ...
  render() {
    return (
      ...
      (this.nodes.button.innerHTML = ju),
      this.nodes.button
    );
  }
  surround() {
...
class os {
  ...
  render() {
    return (
      ...
      (this.nodes.button.type = "button"),
      this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier),
      (this.nodes.button.innerHTML = Bn),
      this.nodes.button
    );
  }
  renderActions() {
  ...
  checkState() {
    ...
    if (e) {
      (this.nodes.button.innerHTML = Cu),
  ...
  enterPressed(e) {
    ...
    if (!this.validateURL(o)) {
      this.notifier.show({
        ...
        oe("Incorrect Link pasted", "warn", o);
      return;
    }
    (o = this.prepareLink(o)),
      this.selection.restore(),
      this.selection.removeFakeBackground(),
      this.insertLink(o),
      e.preventDefault(),
  ...
  insertLink(e) {
    const o = this.selection.findParentTag("A");
    o && this.selection.expandToTag(o),
...
class Yr {
  ...
  async render() {
    const e = H.get(),
      o = this.blocksAPI.getBlockByElement(e.anchorNode);
    if (o === void 0) return [];
    const i = this.toolsAPI.getBlockTools(),
      s = await Er(o, i);
    ...
    const n = s.reduce((l, d) => {
        ...
        return (
          (p = d.toolbox) == null ||
            p.forEach((u) => {
              l.push({
                icon: u.icon,
                title: Ee.t(Oe.toolNames, u.title),
                name: d.name,
                closeOnActivate: !0,
                onActivate: async () => {
                  const g = await this.blocksAPI.convert(o.id, d.name, u.data);
      ...
      r = await o.getActiveToolboxEntry(),
      a = r !== void 0 ? r.icon : Or,
      c = !Mo();
    return {
      icon: a,
      name: "convert-to",
...
class Gr {
  ...
  make() {
    const e = _.make("div", this.CSS.wrapper),
      o = Bu,
      i = _.make("div", this.CSS.info),
      s = _.make("div", this.CSS.title, { textContent: this.title }),
      n = _.make("div", this.CSS.subtitle, { textContent: this.subtitle });
    return (
      (e.innerHTML = o), i.appendChild(s), i.appendChild(n), e.appendChild(i), e
    );
  }
}
Gr.isReadOnlySupported = !0;
class pp extends Zt {
  constructor() {
...
var hp = Object.defineProperty,
  ...
  Xr = (t, e, o, i) => {
    for (var s = mp(e, o), n = t.length - 1, r; n >= 0; n--)
      (r = t[n]) && (s = r(e, o, s) || s);
    return s && hp(e, o, s), s;
  };
class is extends Zt {
  ...
  get toolbox() {
    const e = this.constructable[So.Toolbox],
      o = this.config[hi.Toolbox];
    if (!He(e) && o !== !1)
      return o
        ? Array.isArray(e)
          ? Array.isArray(o)
  ...
  get enabledInlineTools() {
    return this.config[hi.EnabledInlineTools] || !1;
  }
  get enabledBlockTunes() {
    return this.config[hi.EnabledBlockTunes];
  }
  get pasteConfig() {
  ...
  get sanitizeConfig() {
    const e = super.sanitizeConfig,
      o = this.baseSanitizeConfig;
    if (He(e)) return o;
    const i = {};
    for (const s in e)
      if (Object.prototype.hasOwnProperty.call(e, s)) {
        const n = e[s];
        _e(n) ? (i[s] = Object.assign({}, o, n)) : (i[s] = n);
      }
    return i;
  }
  get baseSanitizeConfig() {
    const e = {};
    return (
      Array.from(this.inlineTools.values()).forEach((o) =>
...
Xr([Fo], is.prototype, "sanitizeConfig");
Xr([Fo], is.prototype, "baseSanitizeConfig");
class vp {
  constructor(e, o, i) {
    (this.api = i), (this.config = e), (this.editorConfig = o);
  }
  get(e) {
    const { class: o, isInternal: i = !1, ...s } = this.config[e],
      n = this.getConstructor(o),
      r = o[St.IsTune];
    return new n({
      name: e,
      constructable: o,
...
class Zr {
  ...
  handleClick() {
    ...
    s.top < window.innerHeight && (n = window.scrollY + i.offsetHeight),
      window.scrollTo(0, n),
...
class Qr {
  ...
  handleClick() {
    const e = this.api.blocks.getCurrentBlockIndex(),
      ...
      i = this.api.blocks.getBlockByIndex(e - 1);
    if (e === 0 || !o || !i)
    ...
    let c;
    a.top > 0
      ? (c = Math.abs(r.top) - Math.abs(a.top))
      : (c = Math.abs(r.top) + a.height),
      window.scrollBy(0, -1 * c),
      this.api.blocks.move(e - 1),
      this.api.toolbar.toggleBlockSettings(!0);
  }
}
...
var fp = Object.defineProperty,
  _p = Object.getOwnPropertyDescriptor,
  yp = (t, e, o, i) => {
    for (var s = _p(e, o), n = t.length - 1, r; n >= 0; n--)
      (r = t[n]) && (s = r(e, o, s) || s);
    return s && fp(e, o, s), s;
  };
class ea extends G {
  constructor() {
    super(...arguments),
      (this.stubTool = "stub"),
      (this.toolsAvailable = new we()),
      (this.toolsUnavailable = new we());
  }
  get available() {
  ...
  async prepare() {
    if (
      (this.validateTools(),
      (this.config.tools = bt({}, this.internalTools, this.config.tools)),
      !Object.prototype.hasOwnProperty.call(this.config, "tools") ||
        Object.keys(this.config.tools).length === 0)
    )
      throw Error("Can't start without tools");
    const e = this.prepareConfig();
    this.factory = new vp(e, this.config, this.Editor.API);
  ...
  destroy() {
    Object.values(this.available).forEach(async (e) => {
      re(e.reset) && (await e.reset());
    });
  }
  get internalTools() {
    return {
      convertTo: { class: Yr, isInternal: !0 },
      link: { class: os, isInternal: !0 },
      bold: { class: Qt, isInternal: !0 },
      italic: { class: es, isInternal: !0 },
      paragraph: { class: Jt, inlineToolbar: !0, isInternal: !0 },
      stub: { class: Gr, isInternal: !0 },
      moveUp: { class: Qr, isInternal: !0 },
      delete: { class: Jr, isInternal: !0 },
      moveDown: { class: Zr, isInternal: !0 },
    };
  }
  ...
  getListOfPrepareFunctions(e) {
    ...
    return (
      Object.entries(e).forEach(([i, s]) => {
        o.push({
          function: re(s.class.prepare) ? s.class.prepare : () => {},
          data: { toolName: i, config: s.config },
        });
      }),
      o
    );
  ...
  assignInlineToolsToBlockTool(e) {
    if (this.config.inlineToolbar !== !1) {
      if (e.enabledInlineTools === !0) {
        e.inlineTools = new we(
          Array.isArray(this.config.inlineToolbar)
            ? this.config.inlineToolbar.map((o) => [o, this.inlineTools.get(o)])
      ...
      Array.isArray(e.enabledInlineTools) &&
        (e.inlineTools = new we(
          ["convertTo", ...e.enabledInlineTools].map((o) => [
            o,
            this.inlineTools.get(o),
          ])
        ));
    }
  }
  assignBlockTunesToBlockTool(e) {
    if (e.enabledBlockTunes !== !1) {
      if (Array.isArray(e.enabledBlockTunes)) {
        ...
        e.tunes = new we([...o, ...this.blockTunes.internalTools]);
        return;
      }
...
class kp extends G {
  ...
  get someFlipperButtonFocused() {
    return this.Editor.Toolbar.toolbox.hasFocus()
      ...
      : Object.entries(this.Editor)
          .filter(([e, o]) => o.flipper instanceof yo)
          .some(([e, o]) => o.flipper.hasFocus());
  }
  destroy() {
  ...
  setIsMobile() {
    ...
    e !== this.isMobile &&
      this.eventsDispatcher.emit(Go, { isEnabled: this.isMobile }),
      (this.isMobile = e);
  }
  make() {
    (this.nodes.holder = _.getHolder(this.config.holder)),
      (this.nodes.wrapper = _.make("div", [
        this.CSS.editorWrapper,
        ...(this.isRtl ? [this.CSS.editorRtlFix] : []),
      ])),
      (this.nodes.redactor = _.make("div", this.CSS.editorZone)),
  ...
  loadStyles() {
    ...
    if (_.get(e)) return;
    const o = _.make("style", null, { id: e, textContent: bp.toString() });
    this.config.style &&
      !He(this.config.style) &&
      this.config.style.nonce &&
      o.setAttribute("nonce", this.config.style.nonce),
      _.prepend(document.head, o);
  }
  enableModuleBindings() {
    this.readOnlyMutableListeners.on(
      this.nodes.redactor,
  ...
  defaultBehaviour(e) {
    const { currentBlock: o } = this.Editor.BlockManager,
      i = e.target.closest(`.${this.CSS.editorWrapper}`),
  ...
  backspacePressed(e) {
    ...
    if (i.anyBlockSelected && !H.isSelectionExists) {
      ...
      s.setToBlock(r, s.positions.START),
        i.clearSelection(e),
        e.preventDefault(),
        e.stopPropagation(),
        e.stopImmediatePropagation();
  ...
  documentClicked(e) {
    ...
    const s = e.target;
    this.nodes.holder.contains(s) ||
      H.isAtEditor ||
      (this.Editor.BlockManager.unsetCurrentBlock(),
      this.Editor.Toolbar.close());
    const n =
        (o = this.Editor.BlockSettings.nodes.wrapper) == null
          ? void 0
          : o.contains(s),
      r =
        (i = this.Editor.Toolbar.nodes.settingsToggler) == null
          ? void 0
          : i.contains(s),
      a = n || r;
  ...
  documentTouched(e) {
    ...
    if (o === this.nodes.redactor) {
      const i = e instanceof MouseEvent ? e.clientX : e.touches[0].clientX,
        s = e instanceof MouseEvent ? e.clientY : e.touches[0].clientY;
  ...
  processBottomZoneClick(e) {
    const o = this.Editor.BlockManager.getBlockByIndex(-1),
      i = _.offset(o.holder).bottom,
      s = e.pageY,
      { BlockSelection: n } = this.Editor;
    if (
      ...
      (!r.lastBlock.tool.isDefault || !r.lastBlock.isEmpty) && r.insertAtEnd(),
        a.setToTheLastBlock(),
        c.moveAndOpen(r.lastBlock);
    }
  }
  selectionChanged() {
    const { CrossBlockSelection: e, BlockSelection: o } = this.Editor,
      i = H.anchorElement;
    if (
    ...
    const s = i.closest(`.${fe.CSS.content}`);
    ((s === null ||
      s.closest(`.${H.CSS.editorWrapper}`) !== this.nodes.wrapper) &&
      (this.Editor.InlineToolbar.containsNode(i) ||
        this.Editor.InlineToolbar.close(),
      i.dataset.inlineToolbar !== "true")) ||
      (this.Editor.BlockManager.currentBlock ||
...
const wp = {
  ...
  BlockSelection: ep,
  Caret: Bi,
  CrossBlockSelection: op,
  DragNDrop: ip,
  ModificationsObserver: np,
  Paste: rp,
  ReadOnly: ap,
  RectangleSelection: Yo,
  Renderer: cp,
  Saver: lp,
  Tools: ea,
  UI: kp,
...
class jp {
  constructor(e) {
    (this.moduleInstances = {}), (this.eventsDispatcher = new Jo());
    let o, i;
        ...
        .then(async () => {
          ...
          r.checkEmptiness(),
            ...
            this.configuration.autofocus &&
              n.setToBlock(s.blocks[0], n.positions.START),
            o();
        })
        .catch((s) => {
          oe(`Editor.js is not ready because of ${s}`, "error"), i(s);
        });
  }
  set configuration(e) {
    var o, i;
    _e(e) ? (this.config = { ...e }) : (this.config = { holder: e }),
      kt(!!this.config.holderId, "config.holderId", "config.holder"),
      ...
      this.config.logLevel || (this.config.logLevel = hr.VERBOSE),
      bd(this.config.logLevel),
      kt(
    ...
    const s = { type: this.config.defaultBlock, data: {} };
    (this.config.placeholder = this.config.placeholder || !1),
      ...
      (He(this.config.data) ||
        ...
        (this.config.data = { blocks: [s] }),
      (this.config.readOnly = this.config.readOnly || !1),
      (o = this.config.i18n) != null &&
        o.messages &&
        Ee.setDictionary(this.config.i18n.messages),
  ...
  validate() {
    ...
    if (Qe(o) && !_.get(o))
      throw Error(
        `element with ID «${o}» is missing. Pass correct holder's ID.`
      );
    if (o && _e(o) && !_.isElement(o))
      ...
      (e, o) =>
        e.then(async () => {
          try {
            ...
            if (i instanceof kr) throw new Error(i.message);
            oe(`Module ${o} was skipped because of %o`, "warn", i);
          }
        }),
      Promise.resolve()
    );
  ...
  constructModules() {
    Object.entries(wp).forEach(([e, o]) => {
      try {
        ...
        oe("[constructModules]", `Module ${e} skipped because`, "error", i);
      }
    });
  }
  configureModules() {
    ...
    const o = ["configuration"],
      i = () => {
        Object.values(e.moduleInstances).forEach((s) => {
          re(s.destroy) && s.destroy(), s.listeners.removeAll();
        }),
          pu(),
          (e = null);
        for (const s in this)
...
`,
                ...
                (c.toString = function () {
                  return this.map(function (l) {
                    var d = "",
                      p = l[5] !== void 0;
                    return (
                      l[4] && (d += "@supports (".concat(l[4], ") {")),
                      l[2] && (d += "@media ".concat(l[2], " {")),
                      p &&
                        (d += "@layer".concat(
          ...
          72: (r) => {
            ...
            function l(p, u) {
              for (var g = {}, m = [], f = 0; f < p.length; f++) {
                var x = p[f],
                  w = u.base ? x[0] + u.base : x[0],
                  b = g[w] || 0,
                  T = "".concat(w, " ").concat(b);
                g[w] = b + 1;
                var O = c(T),
                ...
                if (O !== -1) a[O].references++, a[O].updater(A);
                else {
                  var B = d(A, u);
                  (u.byIndex = f),
                    a.splice(f, 0, {
            ...
            r.exports = function (p, u) {
              ...
              return function (m) {
                ...
                for (var w = l(m, u), b = 0; b < g.length; b++) {
                  var T = c(g[b]);
                  a[T].references === 0 && (a[T].updater(), a.splice(T, 1));
                }
                g = w;
              };
            };
          ...
          540: (r) => {
            r.exports = function (a) {
              ...
              return (
                a.setAttributes(c, a.attributes), a.insert(c, a.options), c
              );
            };
          },
          56: (r, a, c) => {
              ...
              return {
                update: function (l) {
                  (function (d, p, u) {
                    var g = "";
                    u.supports &&
                      (g += "@supports (".concat(u.supports, ") {")),
                      u.media && (g += "@media ".concat(u.media, " {"));
...
/*# sourceMappingURL=data:application/json;base64,`.concat(
                      ...
                      p.styleTagTransform(g, d, p.options);
                  })(c, a, l);
                },
                remove: function () {
                  (function (l) {
      ...
      (s.n = (r) => {
        ...
        (s.d = (r, a) => {
          for (var c in a)
            s.o(a, c) &&
              !s.o(r, c) &&
              Object.defineProperty(r, c, { enumerable: !0, get: a[c] });
        }),
          ...
          function A(S, k) {
            for (var L = 0; L < k.length; L++) {
              ...
              (C.enumerable = C.enumerable || !1),
                ...
                Object.defineProperty(S, B(C.key), C);
            }
          }
          function B(S) {
            var k = (function (L, C) {
            ...
            return (
              (S = function C(P, N) {
                ...
                (function (V, K) {
                  ...
                  (this.toolbar = $),
                  (this.borderStyle = N || "1px dashed #aaa"),
                  (this.api = E),
                  (this.holder =
                    typeof y.holder == "string"
                      ? document.getElementById(y.holder)
                      : y.holder),
                  (this.readOnly = y.readOnly),
              ...
              (k = [
                ...
                },
                {
                  ...
                  value: function () {
                    var C = this;
                    if (!this.readOnly) {
                      var P = this.holder.querySelector(
                        ".ce-toolbar__settings-btn"
                      );
                      if (P) this.initializeDragListener(P);
                      else {
                        var N = new MutationObserver(function (y, E) {
                          var $ = C.holder.querySelector(
                            ".ce-toolbar__settings-btn"
                          );
                          $ && (C.initializeDragListener($), E.disconnect());
                        });
                        N.observe(this.holder, { childList: !0, subtree: !0 });
                      }
                    }
                  },
                },
                {
                  ...
                  value: function (C) {
                    ...
                    C.setAttribute("draggable", "true"),
                      ...
                      C.addEventListener("drag", function () {
                        if ((P.toolbar.close(), !P.isTheOnlyBlock())) {
                          var N = P.holder.querySelectorAll(".ce-block"),
                            y = P.holder.querySelector(
                              ".ce-block--drop-target"
                            );
                          P.setElementCursor(y), P.setBorderBlocks(N, y);
                        }
                      });
                  },
                },
                {
                  ...
                  value: function (C, P) {
                    var N = this;
                    Object.values(C).forEach(function (y) {
                      var E = y.querySelector(".ce-block__content");
                      y !== P
                        ? (E.style.removeProperty("border-top"),
                          E.style.removeProperty("border-bottom"))
                        : Object.keys(C).find(function ($) {
                            return C[$] === P;
                          }) > N.startBlock
                        ? (E.style.borderBottom = N.borderStyle)
                        : (E.style.borderTop = N.borderStyle);
                    });
                  },
                },
                {
                  ...
                  value: function () {
                    var C = this;
                    document.addEventListener("drop", function (P) {
                      var N = P.target;
                      if (C.holder.contains(N) && C.startBlock !== null) {
                        var y = C.getDropTarget(N);
                        if (y) {
                          var E = y.querySelector(".ce-block__content");
                          E.style.removeProperty("border-top"),
                            E.style.removeProperty("border-bottom"),
                            (C.endBlock = C.getTargetPosition(y)),
                            C.moveBlocks();
                        }
                      }
                      C.startBlock = null;
                ...
                },
                {
                  key: "getDropTarget",
                  value: function (C) {
                    return C.classList.contains("ce-block")
                      ? C
                      : C.closest(".ce-block");
                  },
                },
      ...
      var o = {
          d: (c, l) => {
            for (var d in l)
              o.o(l, d) &&
                !o.o(c, d) &&
                Object.defineProperty(c, d, { enumerable: !0, get: l[d] });
          },
          o: (c, l) => Object.prototype.hasOwnProperty.call(c, l),
        },
        i = {};
      function s(c, l) {
        for (var d = 0; d < l.length; d++) {
          ...
          (d = [
            {
              ...
              value: function () {
                var p = this,
                  u = this.holder;
                (this.observer = new MutationObserver(function (g) {
                  p.mutationHandler(g);
                })),
            ...
            },
            {
              ...
              value: function (p) {
                ...
                p.forEach(function (m) {
                  switch (m.type) {
                    case "childList":
                      m.target === u.holder ? u.onDestroy() : (g = !0);
                      break;
                    case "characterData":
                      g = !0;
                      break;
                    case "attributes":
                      m.target.classList.contains("ce-block") || (g = !0);
                  }
                }),
                  g && this.mutationDebouncer();
              },
            },
            {
              key: "debounce",
              value: function (p, u) {
                ...
                return function () {
                  for (
                    var f = arguments.length, x = new Array(f), w = 0;
                    w < f;
                    w++
                  )
                    x[w] = arguments[w];
      ...
      var a = (function () {
        function c(u) {
          ...
          var T = {
              maxLength: 30,
              onUpdate: function () {},
              config: { shortcuts: { undo: "CMD+Z", redo: "CMD+Y" } },
            },
            O = m.configuration,
            A = O.holder,
            B = T.config.shortcuts,
            I = x.shortcuts,
            S = I === void 0 ? B : I;
          (this.holder = typeof A == "string" ? document.getElementById(A) : A),
            (this.editor = m),
            (this.shouldSaveHistory = !0),
            (this.readOnly = O.readOnly),
            (this.maxLength = b || T.maxLength),
            (this.onUpdate = w || T.onUpdate),
            (this.config = { shortcuts: S }),
            new n(function () {
              return g.registerChange();
            }, this.holder).setMutationObserver(),
          ...
          (d = [
            {
              key: "truncate",
              value: function (u, g) {
                for (; u.length > g; ) u.shift();
              },
            },
            {
              key: "initialize",
              value: function (u) {
                var g = "blocks" in u ? u.blocks : u,
                  m = { index: g.length - 1, state: g };
              ...
              value: function () {
                (this.stack = this.initialItem
                  ...
                  : [
                      {
                        index: 0,
                        state: [{ type: "paragraph", data: { text: "" } }],
                      },
                    ]),
                  (this.position = 0),
                  this.onUpdate();
            ...
            },
            {
              ...
              value: function () {
                ...
                this.readOnly ||
                  (this.editor &&
                    this.editor.save &&
                    this.shouldSaveHistory &&
                    this.editor.save().then(function (g) {
                      u.editorDidUpdate(g.blocks) && u.save(g.blocks);
                    }),
                  (this.shouldSaveHistory = !0));
              },
            },
            {
              key: "editorDidUpdate",
              value: function (u) {
                var g = this.stack[this.position].state;
                return (
                  !!u.length &&
                  (u.length !== g.length ||
                    JSON.stringify(g) !== JSON.stringify(u))
                );
              },
            },
            {
              ...
              value: function (u) {
                ...
                var g = this.editor.blocks.getCurrentBlockIndex();
                this.stack.push({ index: g, state: u }),
                  (this.position += 1),
                  this.onUpdate();
              },
            },
            {
              ...
              value: function () {
                ...
                if (this.canUndo()) {
                  ...
                  var g = this.stack[(this.position -= 1)],
                    m = g.index,
                    f = g.state;
                  this.onUpdate(),
                    this.editor.blocks.render({ blocks: f }).then(function () {
            ...
            },
            {
              ...
              value: function (u) {
                var g = {
                    CMD: /(Mac)/i.test(navigator.platform)
                      ? "metaKey"
                      : "ctrlKey",
                    ALT: "altKey",
                    SHIFT: "shiftKey",
                  },
                  m = u.slice(0, -1).map(function (x) {
                    return g[x];
                  }),
                  f = m.includes("shiftKey")
                    ? u[u.length - 1].toUpperCase()
                    : u[u.length - 1].toLowerCase();
                return m.push(f), m;
              },
            },
            {
              ...
              value: function () {
                var u = this,
                  ...
                  B = function (S) {
                    A(S, T) && (S.preventDefault(), u.undo());
                  },
                  I = function (S) {
                    A(S, O) && (S.preventDefault(), u.redo());
                  };
                g.addEventListener("keydown", B),
                  ...
                  g.addEventListener("destroy", function () {
                    g.removeEventListener("keydown", B),
                      g.removeEventListener("keydown", I);
                  });
              },
            },
          ]) && r(l.prototype, d),
...
class Tp {
  constructor({ data: e, api: o }) {
    (this.handleKeyDown = (i) => {
      ...
      i.key === "Backspace" &&
        !s &&
        (i.preventDefault(), this.api.blocks.delete());
    }),
      (this.api = o),
      (this.data = e || { url: "", caption: "" }),
  ...
  renderIframe() {
    const e = document.createElement("div");
    e.classList.add("ce-iframe", this.api.styles.block),
      (e.tabIndex = 0),
    ...
    (o.className = "ce-iframe__overlay"),
      (o.style.position = "absolute"),
      (o.style.inset = "0"),
      (o.style.border = "2px solid #00b8b2"),
    ...
    (s.className = "iframe-caption"),
      (s.placeholder = "iframe을 설명해보세요"),
      (s.value = this.data.caption || ""),
      (s.style.marginTop = "8px"),
      (s.style.width = "100%"),
      (s.style.maxWidth = "720px"),
    ...
    const r = () => {
        (o.style.display = "block"),
          ...
          e.classList.add("ce-iframe--active");
      },
      a = () => {
        (o.style.display = "none"),
          (n.style.display = "none"),
          e.classList.remove("ce-iframe--active");
      };
    return (
...
class Pp {
  ...
  drawView() {
    ...
    switch (
      (e.classList.add(this._CSS.wrapper, this._CSS.block),
      (e.style.textAlign = this.data.align),
      (e.style.position = "relative"),
      o.classList.add(this._CSS.delimiter),
      (o.style.display = "block"),
      (o.style.width = "100%"),
      (o.style.height = "24px"),
      (o.style.border = "none"),
      (o.style.backgroundRepeat = "no-repeat"),
      (o.style.backgroundImage = `url(${this.data.url})`),
      this.data.align)
    ) {
      case "left":
    ...
    const s = ["left", "center", "right"],
      n = (r, a = !1) =>
        `https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_96c6313b6d6a405b9511658326418a69/lotte-foundation/${r}${
          a ? "-hover.svg" : ".svg"
        }`;
    return (
      s.forEach((r) => {
        const a = document.createElement("button");
        (a.className = "image-align-modal-button"),
          (a.style.backgroundImage = `url('${n(r)}')`),
      ...
      document.addEventListener(
        "click",
        (r) => {
          this._element.contains(r.target) ||
...
class Ip {
  constructor({ data: e, api: o }) {
    ...
    const { align: i } = he.getState();
    (this.data = { ...e, align: i }), (this._element = this.drawView());
  }
  static get isReadOnlySupported() {
    return !0;
  }
  ...
  drawView() {
    ...
    return (
      e.classList.add(this._CSS.wrapper, this._CSS.block),
      o.classList.add(this._CSS.emoji),
      i.classList.add(this._CSS.emojiIcon),
      o.addEventListener("click", () => {
        i.classList.add(this._CSS.active),
          document.addEventListener("keydown", this.handleKeyDown);
      }),
      document.addEventListener(
        "click",
        (s) => {
          this._element.contains(s.target) ||
            (i.classList.remove(this._CSS.active),
            document.removeEventListener("keydown", this.handleKeyDown));
        },
        !0
      ),
      this.data &&
        ((i.innerText = this.data.emoji), o.appendChild(i), e.appendChild(o)),
      this.applyAlignment(o),
      e
    );
  }
  applyAlignment(e) {
    e.classList.remove("align-left", "align-center"),
      this.data.align === "center" && e.classList.add("align-center"),
      this.data.align === "left" && e.classList.add("align-left");
  }
  render() {
    return this._element;
  }
  save() {
    return { emoji: this.data.emoji, align: this.data.align };
  }
  static get toolbox() {
    return { icon: "🖼️", title: "emoji" };
  }
  static get pasteConfig() {
    return { tags: ["EMOJI"] };
  }
...
class Op {
  ...
  drawView() {
    ...
    return (
      e.classList.add(this._CSS.wrapper, this._CSS.block),
      o.classList.add(this._CSS.file),
      i.classList.add(this._CSS.fileContainer),
      s.classList.add(this._CSS.fileIcon),
      n.classList.add(this._CSS.fileName),
      o.addEventListener("click", () => {
        i.classList.add(this._CSS.active),
          document.addEventListener("keydown", this.handleKeyDown);
      }),
...
class Wp {
    ...
    return (
      this.isHeaderData(e) &&
        ...
        e.level !== void 0 &&
          ...
          (o.level = parseInt(e.level.toString()))),
      o
    );
  }
  render() {
  ...
  set data(e) {
    if (
      ...
      const o = this.getTag();
      (o.innerHTML = this._element.innerHTML),
        this._element.parentNode.replaceChild(o, this._element),
        (this._element = o);
    }
  ...
  get currentLevel() {
    let e = this.levels.find((o) => o.number === this._data.level);
    return e || (e = this.defaultLevel), e;
  }
  get defaultLevel() {
    if (this._settings.defaultLevel) {
      const e = this.levels.find(
        (o) => o.number === this._settings.defaultLevel
      );
      if (e) return e;
      console.warn(
  ...
  get levels() {
    const e = [
      { number: 1, tag: "H1", svg: Ap },
      { number: 2, tag: "H2", svg: Lp },
      { number: 3, tag: "H3", svg: Np },
      { number: 4, tag: "H4", svg: Fp },
      { number: 5, tag: "H5", svg: Mp },
      { number: 6, tag: "H6", svg: Dp },
    ];
    return this._settings.levels
      ? e.filter((o) => this._settings.levels.includes(o.number))
      : e;
  }
  onPaste(e) {
    const o = e.detail;
    if ("data" in o) {
      ...
      this._settings.levels &&
        (s = this._settings.levels.reduce((n, r) =>
          Math.abs(r - s) < Math.abs(n - s) ? r : n
        )),
        (this.data = { level: s, text: i.innerHTML });
    }
  }
  static get pasteConfig() {
...
class Kp {
  ...
  toggleTune(e) {
    ...
    this._elements.wrapper &&
      (this._elements.wrapper.replaceWith(o),
      (this._elements.wrapper = o),
      (this._data.style = e));
  }
  get CSS() {
    return {
  ...
  set data(e) {
    e || (e = { style: "unordered", items: [] }),
      (this._data.style =
        e.style || this.settings.find((i) => i.default === !0).name),
  ...
  get data() {
    ...
    this._data.items = [];
    const e =
      (o = this._elements.wrapper) == null
        ? void 0
        : o.querySelectorAll(`.${this.CSS.item}`);
    return (
      e &&
        e.forEach((i) => {
          var n;
  ...
  _make(e, o = null, i = {}) {
    ...
    for (const n in i) s.setAttribute(n, i[n]);
    return s;
  }
  get currentItem() {
  ...
  getOutofList(e) {
    ...
    if (o.length > 1) {
      const n = o[o.length - 1],
        r = this.currentItem;
      r === n &&
        !((s = n.textContent) != null && s.trim().length) &&
  ...
  pasteHandler(e) {
    ...
    const s = { style: i, items: [] };
    if (o === "LI") s.items = [e.textContent || ""];
    else {
...
class ts {
  constructor({ data: e, config: o = {}, api: i, readOnly: s }) {
    (this.getAlignment = (r) => {
      const a = r.classList.contains("text-align-center")
          ? "center"
          : r.classList.contains("text-align-right")
          ? "right"
          : r.classList.contains("text-align-justify")
          ? "justify"
          : r.classList.contains("text-align-left")
          ? "left"
          : null,
        c = (r.style.textAlign || "").toLowerCase();
      return ["center", "right", "justify", "left"].includes(c)
        ? c
        : a ?? "left";
    }),
      (this.api = i),
      ...
      (this._CSS = { block: this.api.styles.block, wrapper: "ce-paragraph" }),
      this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)),
      (this._placeholder = o.placeholder || ts.DEFAULT_PLACEHOLDER);
    const { align: n } = he.getState();
    (this._data = { ...e, align: e.align ?? n }),
      (this._element = null),
      (this._preserveBlank = o.preserveBlank ?? !1);
  }
  static get DEFAULT_PLACEHOLDER() {
  ...
  update(e) {
    (this._data = { ...this._data, ...e }),
      this._element &&
        ((this._element.innerHTML = e.text || ""),
        this.applyAlignment(this._element));
  }
  onKeyUp(e) {
    (e.code !== "Backspace" && e.code !== "Delete") ||
      !this._element ||
      (this._element.textContent === "" && (this._element.innerHTML = ""));
  }
  drawView() {
    const e = document.createElement("div");
    e.classList.add(this._CSS.wrapper, this._CSS.block),
      (e.dataset.placeholderActive = this.api.i18n.t(this._placeholder)),
      this._data.text && (e.innerHTML = this._data.text),
      this._data.lineHeight && (e.style.lineHeight = this._data.lineHeight),
      this._data.letterSpacing &&
        (e.style.letterSpacing = this._data.letterSpacing),
      this._data.fontSize && (e.style.fontSize = this._data.fontSize),
      this._data.fontFamily && (e.style.fontFamily = this._data.fontFamily),
      this._data.isBold && (e.style.fontWeight = "bold"),
      this._data.isItalic && (e.style.fontStyle = "italic");
    const o = [];
    return (
      this._data.isUnderline && o.push("underline"),
      this._data.isStrikethrough && o.push("line-through"),
      o.length > 0 && (e.style.textDecoration = o.join(" ")),
      this.readOnly
        ? (e.contentEditable = "false")
        : ((e.contentEditable = "true"),
          e.addEventListener("keyup", this.onKeyUp)),
      this.applyAlignment(e),
      e
    );
  }
  applyAlignment(e) {
    ...
    e.classList.remove(
      ...
      i.includes(o)
        ? (e.classList.add(`text-align-${o}`), (e.style.textAlign = o))
        : (e.classList.add("text-align-left"),
    ...
    return (
      ...
      !this.readOnly &&
        ...
        setTimeout(() => {
          var i, s;
          const e =
              (i = this._element) == null ? void 0 : i.closest(".ce-block"),
            o = e == null ? void 0 : e.dataset.id;
          o &&
  ...
  merge(e) {
    ...
    const o = (l) => {
        ...
        const p = [],
          u = (f) => {
            const x = [];
            let w = f;
            for (; w && w.tagName === "SPAN"; )
              x.unshift(w.style), (w = w.parentElement);
            return x;
          },
          g = (f) => {
            const x = new Map();
          ...
          m = (f) => {
            var x;
            if (f.nodeType === Node.ELEMENT_NODE && f.tagName === "SPAN") {
              const w = f;
              if (
                !Array.from(w.children).some((T) => T.tagName === "SPAN") &&
                (x = w.textContent) != null &&
                x.trim()
              ) {
                const T = u(w),
                  O = g(T),
        ...
        return d.childNodes.forEach(m), p;
      },
      i = o(this._element.innerHTML),
      s = o(e.text),
      n = new Set(
        i.map((l) => {
          var d;
          return ((d = l.textContent) == null ? void 0 : d.trim()) || "";
        })
      ),
      r = s.filter((l) => {
        var p;
        const d = (p = l.textContent) == null ? void 0 : p.trim();
        return d && !n.has(d);
      }),
    ...
    (a.style.lineHeight = "normal"),
      ...
      i.forEach((l) => a.appendChild(l.cloneNode(!0)));
    const c = document.createElement("span");
    (c.id = "cursor-marker"),
      a.appendChild(c),
      r.forEach((l) => a.appendChild(l.cloneNode(!0))),
      (this._data.text = a.outerHTML),
      ...
      setTimeout(() => {
        var d;
        const l =
          (d = this._element) == null
            ? void 0
            : d.querySelector("#cursor-marker");
        if (l) {
  ...
  wrapOuterSpan(e) {
    return /^<span[^>]*>[\s\S]*<\/span>$/i.test(e.trim())
      ? e
      : `<span style="display: inline; word-break: break-word;">${e}</span>`;
  }
  save(e) {
    const o = e.innerHTML;
    return {
  ...
  onPaste(e) {
    const o = e.detail.data.innerHTML || e.detail.data.innerText || "",
      s = new DOMParser().parseFromString(o, "text/html"),
      n = s.body.innerText || s.body.textContent || "",
      r = document.createElement("span");
    (r.style.display = "inline-block"),
      (r.style.wordBreak = "break-word"),
      (r.innerText = n);
    const a = r.outerHTML;
    (this._data = { text: a, align: this._data.align }),
      window.requestAnimationFrame(() => {
        this._element && (this._element.innerHTML = this._data.text || "");
      });
  }
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isNativeInput = void 0);
  var e = rs;
  Object.defineProperty(t, "isNativeInput", {
    enumerable: !0,
    get: function () {
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.blockElements = void 0);
  var e = ls;
  Object.defineProperty(t, "blockElements", {
    enumerable: !0,
    get: function () {
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.calculateBaseline = void 0);
  var e = ds;
  Object.defineProperty(t, "calculateBaseline", {
    enumerable: !0,
    get: function () {
...
gs.isContentEditable = Qp;
function Qp(t) {
  return t.contentEditable === "true";
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isContentEditable = void 0);
  var e = gs;
  Object.defineProperty(t, "isContentEditable", {
    enumerable: !0,
    get: function () {
...
function ig(t) {
  ...
  else e = (0, og.isContentEditable)(t);
  return e;
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.canSetCaret = void 0);
  var e = us;
  Object.defineProperty(t, "canSetCaret", {
    enumerable: !0,
    get: function () {
...
var $i = {},
  hs = {};
function tg(t, e, o) {
  const i = o.value !== void 0 ? "value" : "get",
    s = o[i],
    n = `#${e}Cache`;
  if (
    ((o[i] = function (...r) {
...
function ms(t) {
  return (
    t != null && t !== "" && (typeof t != "object" || Object.keys(t).length > 0)
  );
}
function sg(t) {
  return !ms(t);
...
function aa(t) {
  return oo(t) === "function" || oo(t) === "asyncfunction";
}
function ug(t) {
  return aa(t) && /^\s*class\s+/.test(t.toString());
}
function pg(t) {
  return oo(t) === "number";
}
...
function Ct(t, ...e) {
  ...
  if (fi(t) && fi(o))
    for (const i in o)
        ...
        ? (t[i] === void 0 && Object.assign(t, { [i]: {} }), Ct(t[i], o[i]))
        : Object.assign(t, { [i]: o[i] });
  return Ct(t, ...e);
}
function vg(t, e, o) {
...
const yg = {
  ...
  bg = { LEFT: 0, WHEEL: 1, RIGHT: 2, BACKWARD: 3, FORWARD: 4 };
class kg {
  constructor() {
    this.completed = Promise.resolve();
  }
    ...
    Object.defineProperty(
      {
        ...
        cacheable: tg,
        capitalize: ag,
        copyTextToClipboard: cg,
        debounce: lg,
        deepMerge: Ct,
        deprecationAssert: vg,
        getUserOS: ra,
        getValidUrl: fg,
        isBoolean: dg,
        isClass: ug,
...
hs.containsOnlyInlineElements = Eg;
var xg = vs,
  Sg = cs;
function Eg(t) {
  var e;
  (0, xg.isString)(t)
    ? ((e = document.createElement("div")), (e.innerHTML = t))
    : (e = t);
  var o = function (i) {
    return (
      !(0, Sg.blockElements)().includes(i.tagName.toLowerCase()) &&
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.containsOnlyInlineElements = void 0);
  var e = hs;
  Object.defineProperty(t, "containsOnlyInlineElements", {
    enumerable: !0,
    get: function () {
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.fragmentToString = void 0);
  var e = fs;
  Object.defineProperty(t, "fragmentToString", {
    enumerable: !0,
    get: function () {
...
ys.getContentLength = Ig;
var Pg = bo;
function Ig(t) {
  var e, o;
  return (0, Pg.isNativeInput)(t)
    ? t.value.length
    : t.nodeType === Node.TEXT_NODE
    ? t.length
    : (o = (e = t.textContent) === null || e === void 0 ? void 0 : e.length) !==
        null && o !== void 0
    ? o
    : 0;
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.getContentLength = void 0);
  var e = ys;
  Object.defineProperty(t, "getContentLength", {
    enumerable: !0,
    get: function () {
...
ks.getDeepestBlockElements = da;
var Og = $i;
function da(t) {
  return (0, Og.containsOnlyInlineElements)(t)
    ? [t]
    : Array.from(t.children).reduce(function (e, o) {
        return Nn(Nn([], e, !0), da(o), !0);
      }, []);
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.getDeepestBlockElements = void 0);
  var e = ks;
  Object.defineProperty(t, "getDeepestBlockElements", {
    enumerable: !0,
    get: function () {
...
js.isLineBreakTag = Ag;
function Ag(t) {
  return ["BR", "WBR"].includes(t.tagName);
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isLineBreakTag = void 0);
  var e = js;
  Object.defineProperty(t, "isLineBreakTag", {
    enumerable: !0,
    get: function () {
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isSingleTag = void 0);
  var e = xs;
  Object.defineProperty(t, "isSingleTag", {
    enumerable: !0,
    get: function () {
...
function pa(t, e) {
  e === void 0 && (e = !1);
  var o = e ? "lastChild" : "firstChild",
    i = e ? "previousSibling" : "nextSibling";
  if (t.nodeType === Node.ELEMENT_NODE && t[o]) {
    var s = t[o];
    if (
      (0, Mg.isSingleTag)(s) &&
      !(0, Ng.isNativeInput)(s) &&
      !(0, Fg.isLineBreakTag)(s)
    )
      if (s[i]) s = s[i];
      else if (s.parentNode !== null && s.parentNode[i]) s = s.parentNode[i];
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.getDeepestNode = void 0);
  var e = ws;
  Object.defineProperty(t, "getDeepestNode", {
    enumerable: !0,
    get: function () {
...
var Dg = $i,
  ...
  $g = bo;
function zg(t) {
  return Array.from(t.querySelectorAll((0, Hg.allInputsSelector)())).reduce(
    function (e, o) {
      return (0, $g.isNativeInput)(o) || (0, Dg.containsOnlyInlineElements)(o)
        ? ri(ri([], e, !0), [o], !1)
        : ri(ri([], e, !0), (0, Rg.getDeepestBlockElements)(o), !0);
    },
    []
  );
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.findAllInputs = void 0);
  var e = Ss;
  Object.defineProperty(t, "findAllInputs", {
    enumerable: !0,
    get: function () {
...
Es.isCollapsedWhitespaces = Ug;
function Ug(t) {
  return !/[^\t\n\r ]/.test(t);
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isCollapsedWhitespaces = void 0);
  var e = Es;
  Object.defineProperty(t, "isCollapsedWhitespaces", {
    enumerable: !0,
    get: function () {
...
var qg = vs;
function Vg(t) {
  return (0, qg.isNumber)(t)
    ? !1
    : !!t && !!t.nodeType && t.nodeType === Node.ELEMENT_NODE;
}
(function (t) {
...
(function (t) {
  ...
  var e = Is;
  Object.defineProperty(t, "isLeaf", {
    enumerable: !0,
    get: function () {
      return e.isLeaf;
    },
...
function Zg(t, e) {
  var o = "";
  return (0, Xg.isSingleTag)(t) && !(0, Kg.isLineBreakTag)(t)
    ? !1
    : ((0, Yg.isElement)(t) && (0, Gg.isNativeInput)(t)
        ? (o = t.value)
        : t.textContent !== null && (o = t.textContent.replace("​", "")),
      e !== void 0 && (o = o.replace(new RegExp(e, "g"), "")),
      o.trim().length === 0);
}
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isNodeEmpty = void 0);
  var e = As;
  Object.defineProperty(t, "isNodeEmpty", {
    enumerable: !0,
    get: function () {
...
function eh(t, e) {
  ...
  for (var o = [t]; o.length > 0; ) {
    var i = o.shift();
    if (i) {
      if (((t = i), (0, Jg.isLeaf)(t) && !(0, Qg.isNodeEmpty)(t, e))) return !1;
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isFragment = void 0);
  var e = Ls;
  Object.defineProperty(t, "isFragment", {
    enumerable: !0,
    get: function () {
      return e.isFragment;
    },
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.isHTMLString = void 0);
  var e = Ns;
  Object.defineProperty(t, "isHTMLString", {
    enumerable: !0,
    get: function () {
...
function nh(t) {
  var e = t.getBoundingClientRect(),
    ...
    s = e.top + i,
    n = e.left + o;
  return { top: s, left: n, bottom: s + e.height, right: n + e.width };
}
(function (t) {
...
(function (t) {
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.prepend =
      ...
      t.isElement =
      t.isContentEditable =
      t.isCollapsedWhitespaces =
      t.findAllInputs =
      t.isNativeInput =
      t.allInputsSelector =
      t.getDeepestNode =
      t.getDeepestBlockElements =
      t.getContentLength =
      t.fragmentToString =
      t.containsOnlyInlineElements =
      t.canSetCaret =
      t.calculateBaseline =
      t.blockElements =
      t.append =
...
var ba = ((t) => (
  (t.Type1 = "type1"), (t.Type2 = "type2"), (t.Type3 = "type3"), t
))(ba || {});
class Ds {
  constructor({ data: e, config: o, api: i, readOnly: s, block: n }) {
    ...
    (this.api = i),
      ...
      (this._data = {
        text: e.text || "",
        type:
          (Object.values(ba).includes(e.type) && e.type) || o.defaultType || r,
      }),
      (this._CSS = {
  ...
  get settings() {
    return [
      { name: "type1", label: "인용구1" },
      { name: "type2", label: "인용구2" },
      { name: "type3", label: "인용구3" },
    ];
  }
  render() {
    const e = Et.make("div", [this._CSS.baseClass, this._CSS.wrapper]);
    return (
      (this._quoteElement = Et.make(
        "blockquote",
        [this._CSS.input, this._CSS.text, this.getTypeClass(this._data.type)],
        { contentEditable: !this.readOnly, innerHTML: this._data.text }
      )),
      this._quoteElement.addEventListener("keydown", (o) =>
        this.handleKeydown(o)
      ),
      e.appendChild(this._quoteElement),
      e
    );
  }
  get currentItem() {
  ...
  handleKeydown(e) {
    ...
    if (
      (e.key === "Enter" &&
        (e.shiftKey || (e.preventDefault(), this.getOutOfQuote())),
      e.key === "Backspace" &&
        ((i = o.textContent) == null ? void 0 : i.trim().length) === 0)
    ) {
      e.preventDefault();
      const s = this.api.blocks.getCurrentBlockIndex();
      this.api.blocks.delete(s),
        this.api.blocks.insert("paragraph", { text: "" }),
  ...
  _toggleTune(e) {
    (this._data.type = e),
      this._quoteElement &&
        ...
        this._quoteElement.classList.add(this.getTypeClass(e))),
...
const D = class D {
  constructor({ data: e, api: o }) {
    (this.handleKeyDown = (i) => {
      ...
      (this.createImageWrapper = (i, s, n, r) => {
        ...
        a.classList.add(this._CSS.groupImage),
          (a.dataset.index = String(s)),
          c.classList.add(this._CSS.imageItem),
          (c.src = i.url),
          (c.alt = i.name),
          (c.draggable = !0),
          this.addImageEventListeners(a, i, s);
        const l = n > 0 ? `${(i.ratio / n) * 100}%` : "100%";
        if (
          ((a.style.width = r === 1 && i.width < 800 ? `${i.width}px` : l),
          a.appendChild(c),
          r === 1)
        ) {
          const g = ["top-left", "top-right", "bottom-left", "bottom-right"],
            m = a.querySelector("img"),
            f = document.createElement("div");
          (f.className = "image-size-label"), a.appendChild(f);
          const x =
              ((u =
                (p = (d = this.api) == null ? void 0 : d.ui) == null
                  ? void 0
                  : p.nodes) == null
                ? void 0
                : u.redactor) || document.querySelector(".codex-editor"),
            b = x instanceof HTMLElement ? x.clientWidth - 40 : 768;
          m.onload = () => {
            const T = m.naturalWidth || i.width,
              O = m.naturalHeight || i.height,
              A = T / O;
            let B = i.width > b ? b : i.width,
              I = B / A;
            (a.style.width = `${B}px`),
              (a.style.height = `${I}px`),
              (i.width = B),
              (i.height = I),
              (i.ratio = A),
              (f.innerText = `${Math.round(B)} × ${Math.round(I)}`),
              a.offsetHeight,
              (a.style.transform = "translateZ(0)"),
              g.forEach((S) => {
                const k = document.createElement("div");
                (k.className = `resize-handle ${S}`), a.appendChild(k);
                let L = 0,
                  C = 0;
                  ...
                  const y = ($) => {
                      ...
                      if (
                        ...
                        (a.style.width = `${V}px`),
                          ...
                          (i.height = K),
                          (i.ratio = A),
                          (f.innerText = `${Math.round(V)} × ${Math.round(K)}`);
                      }
                    },
                    E = () => {
                      if (
                        ...
                        (a.style.width = `${q}px`),
                          ...
                          (i.width = q),
                          (i.height = V),
                          (f.innerText = `${Math.round(q)} × ${Math.round(V)}`);
                      }
                    };
      ...
      (this.api = o),
      (this.data = { images: [], caption: "", align: "center", ...e }),
  ...
  static get toolbox() {
    return { icon: "🖼️", title: "Unified Image" };
  }
  static get pasteConfig() {
    return { tags: [] };
  }
  ...
  drawView() {
    ...
    e.classList.add(this._CSS.wrapper, this._CSS.block),
      (e.style.position = "relative");
    const o = (c, l = !1) =>
        `https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_96c6313b6d6a405b9511658326418a69/lotte-foundation/${c}${
          l ? "-hover.svg" : ".svg"
        }`,
      i = ["left", "center", "right"],
      s = this.data.align || "center";
    e.style.textAlign = s;
    const n = document.createElement("div");
    (n.className = "image-align-modal"),
      (n.style.display = "none"),
      i.forEach((c) => {
        const l = document.createElement("button");
        (l.className = "image-align-modal-button"),
          (l.style.backgroundImage = `url('${o(c)}')`),
      ...
      e.appendChild(n),
      e.addEventListener("dragover", this.onDragOverBlock.bind(this)),
      e.addEventListener("drop", this.onDropBlock.bind(this));
    const r = document.createElement("div");
    r.classList.add(this._CSS.imageWrapper), this.renderImages(r);
    const a = document.createElement("input");
    return (
      a.classList.add(this._CSS.caption),
      (a.placeholder = "이미지를 설명해보세요"),
      (a.value = this.data.caption || ""),
      a.addEventListener("input", (c) => {
        const l = c.target;
        this.data.caption = l.value;
      }),
      this.updateCaptionVisibility(a),
      ...
      document.addEventListener(
        ...
        (c) => {
          this._element.contains(c.target) ||
            ...
            (n.style.display = "none"),
            a.value === "" ? this.hideCaption(a) : this.showCaption(a),
            document.removeEventListener("keydown", this.handleKeyDown));
        },
        !0
      ),
  ...
  updateCaptionVisibility(e) {
    this.data.caption || (D.activeImageBlock === this && this.activateCaption)
      ? this.showCaption(e)
      : this.hideCaption(e);
  }
  deactivate() {
  ...
  renderImages(e) {
    const o = this.data.images || [],
      i = o.reduce((s, n) => s + n.ratio, 0);
    o.forEach((s, n) => {
      const r = this.createImageWrapper(s, n, i, o.length);
      e.appendChild(r);
    });
  }
  addImageEventListeners(e, o, i) {
    e.addEventListener("dragstart", (s) => this.onDragStart(s, o, i)),
      e.addEventListener("dragover", (s) => this.onDragOver(s, i)),
      e.addEventListener("drop", (s) => this.onDrop(s, i)),
      e.addEventListener("dragleave", this.onDragLeave.bind(this));
  }
  onDragStart(e, o, i) {
    e.dataTransfer &&
      ((e.dataTransfer.effectAllowed = "move"),
      (D.draggedImage = o),
      (D.sourceInstance = this),
      (D.sourceIndex = i),
  ...
  onDragOver(e, o) {
    ...
    if (
      !i ||
      (D.sourceInstance && D.sourceInstance === this && D.sourceIndex === o)
    )
      return;
  ...
  async onDrop(e, o) {
    ...
    if (!i) return;
    const { sourceIndex: s, blockIndex: n } = JSON.parse(i),
      r = this.api.blocks.getBlockByIndex(n),
      a = e.currentTarget;
    if (D.sourceInstance && D.sourceInstance === this && s === o) return;
    const c = a.dataset.dropType,
      l =
        c === "bottom"
          ? this.api.blocks.getCurrentBlockIndex() + 1
          : this.api.blocks.getCurrentBlockIndex();
    if (c === "top" || c === "bottom") this.onDropNewBlock(c, n, o, l);
    else {
      const d = this.getDropPosition(e, a);
      D.sourceInstance === this
        ? this.handleInternalDrop(s, d)
        : D.sourceInstance &&
          D.draggedImage &&
          (await this.handleExternalDrop(r, n, d));
    }
    this.clearDragOverEffects(),
      this.updateView(),
      (D.draggedImage = null),
      (D.sourceInstance = null),
      (D.sourceIndex = null);
  }
  onDropNewBlock(e, o, i, s) {
    if (
      ...
      !D.sourceInstance ||
      (o === s && D.sourceIndex === i) ||
      (D.sourceInstance.data.images.length === 1 &&
        e === "top" &&
        o === s - 1) ||
      (D.sourceInstance.data.images.length === 1 &&
        e === "bottom" &&
    ...
    const a = { images: [n] };
    if (
      (this.api.blocks.insert("unifiedImage", a, {}, s, !0), r.length === 0)
    ) {
      const c = o > s ? o + 1 : o;
  ...
  getDropPosition(e, o) {
    const i = o.getBoundingClientRect(),
      ...
      r = i.width;
    return s < n + r / 2
      ? parseInt(o.dataset.index || "0")
      : parseInt(o.dataset.index || "0") + 1;
  }
  ...
  async handleExternalDrop(e, o, i) {
    var r, a;
    const s = [
        ...(((r = D.sourceInstance) == null ? void 0 : r.data.images) ?? []),
      ],
      n = [...this.data.images];
    if (n.length < 3) {
      s.splice(D.sourceIndex, 1),
        (a = D.sourceInstance) != null &&
          a.data &&
          (D.sourceInstance.data.images = s),
        n.splice(i, 0, D.draggedImage),
        (this.data.images = n),
        D.sourceInstance &&
          (await this.api.blocks.update(e.id, { ...D.sourceInstance.data }));
      const c = this.api.blocks.getBlockByIndex(
        this.api.blocks.getCurrentBlockIndex()
      );
      c
        ? await this.api.blocks.update(c.id, this.data)
        : console.warn("⚠️ currentBlock is undefined; update skipped."),
        s.length === 0 && this.api.blocks.delete(o);
    }
    this.updateView();
  }
  onDragLeave(e) {
  ...
  onDragOverBlock(e) {
    if (
      (e.preventDefault(),
      e.stopPropagation(),
      D.sourceInstance && D.sourceInstance === this)
    )
      return;
  ...
  handleBlockDrop(e) {
    ...
    if (o.length < 3) {
      ...
      a.length > 0 && (r = this.determineDropIndex(e, a)),
        o.splice(r, 0, D.draggedImage),
        (this.data.images = o);
      const c = [
        ...(((i = D.sourceInstance) == null ? void 0 : i.data.images) ?? []),
      ];
      c.splice(D.sourceIndex, 1),
        (s = D.sourceInstance) != null &&
          s.data &&
          (D.sourceInstance.data.images = c),
        this.updateBlocks(),
        (n = D.sourceInstance) == null || n.updateView(),
        this.updateView();
    }
  }
  determineDropIndex(e, o) {
    for (let i = 0; i < o.length; i++) {
      ...
      if (e.clientX < n.left + n.width / 2) return i;
    }
    return o.length;
  }
  updateBlocks() {
    ...
    e &&
      D.sourceInstance &&
      this.api.blocks.update(e.id, D.sourceInstance.data);
...
class ah {
  ...
  drawView() {
    ...
    return (
      e.classList.add(this._CSS.wrapper, this._CSS.block),
      o.classList.add(this._CSS.video),
      i.classList.add(this._CSS.caption),
      o.addEventListener("click", (s) => {
        e.classList.add(this._CSS.active),
          this.showCaption(i),
          document.addEventListener("keydown", this.handleKeyDown);
      }),
      document.addEventListener(
        ...
        (s) => {
          this._element.contains(s.target) ||
            (e.classList.remove(this._CSS.active),
            this.hideCaption(i),
            document.removeEventListener("keydown", this.handleKeyDown));
        },
        !0
      ...
      this.data &&
        ...
        ((o.src = this.data.url),
        (o.controls = !0),
        (i.placeholder = "비디오를 설명해보세요"),
        this.data.caption
          ? ((i.value = this.data.caption), (i.style.display = "block"))
          : (i.style.display = "none"),
        e.appendChild(o),
        e.appendChild(i)),
      e
...
const Ii = class Ii {
  ...
  render() {
    ...
    return (
      (e.type = "button"),
      e.classList.add("cdx-font-size-button"),
      (e.innerText = "A→a"),
      (e.style.padding = "4px"),
  ...
  renderActions() {
    ...
    return (
      (e.className = "font-size-dropdown"),
      this.sizeOptions.forEach((o) => {
        ...
        (n.textContent = "가나다"),
          (n.style.fontSize = o),
          (n.style.marginLeft = "12px"),
          (n.style.fontFamily = "inherit"),
          (i.style.display = "flex"),
          (i.style.alignItems = "center"),
          (i.style.padding = "6px 12px"),
          ...
          i.addEventListener("click", () => {
            if (!this.range || this.range.collapsed) {
              const r = this.api.blocks,
                a = r.getBlocksCount() - 1,
                c = r.getBlockByIndex(a);
              if (c) {
                const d = c.holder.querySelector("[contenteditable=true]");
                if (d) {
                  const p = d.querySelectorAll("span[data-font-size]"),
                    u = p[p.length - 1],
                    g = document.createRange(),
                    m = window.getSelection();
                  if (u) g.selectNodeContents(u), g.collapse(!1);
                  else {
                    const f = d.lastChild;
                    f
                      ? (g.setStartAfter(f), g.collapse(!0))
                      : (g.selectNodeContents(d), g.collapse(!1));
                  }
                  m && (m.removeAllRanges(), m.addRange(g)), (this.range = g);
                }
              }
            }
  ...
  applyFontSize(e) {
    ...
    if (
      ((i = o == null ? void 0 : o.dataset) == null ? void 0 : i.fontSize) !== e
    ) {
      if (o) {
  ...
  wrap(e, o) {
    ...
    (i.style.fontSize = o),
      i.setAttribute("data-font-size", o),
  ...
  flattenSpans(e) {
    (e instanceof DocumentFragment || e instanceof Element) &&
      e.querySelectorAll("span[data-font-size]").forEach((i) => {
        if (i.parentNode) {
  ...
  findAncestorSpan(e) {
    ...
    for (; o; ) {
      if (o.tagName === "SPAN" && o.hasAttribute("data-font-size")) return o;
      o = o.parentElement;
    }
    return null;
  }
  checkState() {
    ...
    } else this.currentFontSize = "14px";
    return !1;
  }
  static get sanitize() {
    return { span: { style: !0, "data-font-size": !0 } };
  }
  get toolboxIcon() {
    return "A→a";
  }
};
(Ii.isInline = !0), (Ii.title = "글자 크기");
let Tt = Ii;
const Oi = class Oi {
  constructor({ api: e }) {
  ...
  render() {
    ...
    return (
      (e.type = "button"),
      e.classList.add("cdx-letter-spacing-button"),
      (e.innerText = "자간"),
  ...
  renderActions() {
    const e = document.createElement("ul");
    return (
      (e.className = "letter-spacing-dropdown"),
      this.spacingOptions.forEach((o) => {
        const i = document.createElement("li");
        (i.className = "letter-spacing-option"), (i.dataset.spacing = o);
        const s = document.createElement("span");
        (s.textContent = o === "normal" ? "기본" : o),
          (s.style.display = "inline-block"),
          (s.style.width = "50px"),
          (s.style.fontFamily = "inherit");
        const n = document.createElement("span");
        (n.textContent = "가나다"),
          (n.style.letterSpacing = o === "normal" ? "normal" : o),
          (n.style.marginLeft = "12px"),
          (n.style.fontFamily = "inherit"),
          (i.style.display = "flex"),
          (i.style.alignItems = "center"),
  ...
  applyLetterSpacing(e) {
    var i;
    if (((this.data.letterSpacing = e), !this.range || this.range.collapsed))
      return;
    const o = this.findAncestorSpan(this.range.startContainer);
    if (
      ((i = o == null ? void 0 : o.dataset) == null
        ? void 0
        : i.letterSpacing) !== e
    ) {
      if (o) {
  ...
  wrap(e, o) {
    const i = document.createElement(this.tag);
    (i.style.letterSpacing = o),
      i.setAttribute("data-letter-spacing", o),
      (i.style.display = "inline-block"),
      (i.style.wordBreak = "break-word");
    const s = e.extractContents();
    this.flattenSpans(s),
  ...
  flattenSpans(e) {
    (e instanceof DocumentFragment || e instanceof Element) &&
      e.querySelectorAll("span[data-letter-spacing]").forEach((i) => {
        if (i.parentNode) {
          const s = document.createTextNode(i.textContent || "");
          i.parentNode.replaceChild(s, i);
        }
  ...
  checkState() {
    const e = this.api.selection.findParentTag(this.tag, "cdx-letter-spacing");
    if (e) {
      const o = e.getAttribute("data-letter-spacing") || "normal";
      this.currentSpacing = o;
    } else this.currentSpacing = "normal";
    return !1;
  }
  static get sanitize() {
    return { span: { style: !0, "data-letter-spacing": !0 } };
  }
  get toolboxIcon() {
    return "자간";
  }
};
(Oi.isInline = !0), (Oi.title = "자간 설정");
let Pt = Oi;
const Ai = class Ai {
  constructor({ api: e }) {
    (this.range = null),
      (this.currentLineHeight = "normal"),
      (this.data = { lineHeight: "normal" }),
      (this.tag = "SPAN"),
  ...
  render() {
    ...
    return (
      (e.type = "button"),
      e.classList.add("cdx-line-height-button"),
      (e.style.padding = "2px 4px"),
      (e.style.marginRight = "12px"),
      (e.style.borderRadius = "4px"),
      (e.style.border = "1px solid black"),
  ...
  renderActions() {
    const e = document.createElement("ul");
    return (
      (e.className = "line-height-dropdown"),
      this.lineHeightOptions.forEach((o) => {
        const i = document.createElement("li");
  ...
  applyLineHeight(e) {
    var i;
    if (((this.data.lineHeight = e), !this.range || this.range.collapsed))
      return;
    const o = this.findAncestorSpan(this.range.startContainer);
    if (
      ((i = o == null ? void 0 : o.dataset) == null ? void 0 : i.lineHeight) !==
      e
    ) {
      if (o) {
  ...
  wrap(e, o) {
    ...
    s.setAttribute("data-line-height", o),
      (s.style.lineHeight = o),
  ...
  flattenSpans(e) {
    (e instanceof DocumentFragment || e instanceof Element) &&
      e.querySelectorAll("span[data-line-height]").forEach((i) => {
        const s = i.parentNode;
        for (; i.firstChild; ) s == null || s.insertBefore(i.firstChild, i);
  ...
  findAncestorSpan(e) {
    let o = e.parentElement;
    for (; o; ) {
      if (o.tagName === "SPAN" && o.hasAttribute("data-line-height")) return o;
      o = o.parentElement;
    }
    return null;
  }
  checkState() {
    ...
    } else this.currentLineHeight = "normal";
    return !1;
  }
  static get sanitize() {
    return { span: { style: !0, "data-line-height": !0 } };
  }
  get toolboxIcon() {
    return "행간";
  }
};
(Ai.isInline = !0), (Ai.title = "줄간격 설정");
let It = Ai;
const Ze = class Ze {
  constructor(e) {
    (this.tag = "SPAN"),
  ...
  render() {
    const e = document.createElement("button");
    e.classList.add("font-picker-wrapper"),
      e.classList.add(this.iconClasses.base),
      (e.type = "button"),
      (this.button = document.createElement("div"));
    const o = document.createElement("span");
    o.classList.add("font-icon"),
      (o.textContent = this.toolboxIcon),
      this.button.appendChild(o);
    const i = document.createElement("div");
    return (
  ...
  renderActions() {
    return (
      ...
      Ze.FONT_OPTIONS.forEach((e) => {
        const o = document.createElement("li");
        o.classList.add("font-label"),
          (o.textContent = e.label),
          (o.style.fontFamily = e.value),
          o.setAttribute("data-value", e.value),
          o.addEventListener("click", () => {
  ...
  customSurround(e) {
    const o = this.api.selection.findParentTag(this.tag, Ze.CSS);
    o ? this.unwrap(o) : this.wrap(e), (this.currentFont = e);
  }
  wrap(e) {
    const o = document.createElement(this.tag);
    if (
      (o.classList.add(Ze.CSS),
      e && ((o.style.fontFamily = e), (this.currentFont = e)),
      this.range)
    ) {
      ...
      this.flattenSpans(i),
        ...
        this.range.insertNode(o),
        this.api.selection.expandToTag(o);
    }
  }
  flattenSpans(e) {
    (e instanceof DocumentFragment || e instanceof Element) &&
      e.querySelectorAll("span.cdx-font-picker").forEach((i) => {
        if (i.parentNode) {
          const s = document.createTextNode(i.textContent || "");
          i.parentNode.replaceChild(s, i);
        }
  ...
  checkState() {
    ...
    if (!e) this.currentFont = "MalgunGothic";
    else {
  ...
  static get sanitize() {
    return { span: { class: Ze.CSS, style: !0 } };
  }
};
(Ze.FONT_OPTIONS = [
...
const ao = class ao {
  ...
  surround(e) {
    if (!e) return;
    const o = this.api.selection.findParentTag(this.tag, ao.CSS);
    o ? this.unwrap(o) : this.wrap(e);
  }
  wrap(e) {
    const o = document.createElement(this.tag);
    o.classList.add(ao.CSS),
      o.appendChild(e.extractContents()),
      e.insertNode(o),
      this.api.selection.expandToTag(o);
  }
  unwrap(e) {
  ...
  checkState() {
    var o;
    const e = this.api.selection.findParentTag(this.tag, ao.CSS);
    return (
      (o = this.button) == null ||
        o.classList.toggle(this.iconClasses.active, !!e),
      !!e
    );
  }
  get toolboxIcon() {
...
const co = class co {
  constructor(e) {
    (this.tag = "SPAN"),
      ...
      e.config &&
        e.config.colorCollections &&
        (this.colors = e.config.colorCollections);
  }
  static get CSS() {
  ...
  render() {
    ...
    return (
      e.classList.add("text-icon"),
      (e.textContent = this.toolboxIcon),
  ...
  renderActions() {
    const e = document.createElement("div");
    return (
      e.classList.add("color-picker-container"),
      this.colors.forEach((o) => {
        const i = document.createElement("div");
        i.classList.add("color-box"),
  ...
  customSurround(e) {
    const o = this.api.selection.findParentTag(this.tag, co.CSS);
    o ? this.unwrap(o) : this.wrap(e), (this.currentColor = e);
  }
  wrap(e) {
    const o = document.createElement(this.tag);
    if (
      (o.classList.add(co.CSS),
      e && ((o.style.backgroundColor = e), (this.currentColor = e)),
      this.range)
    ) {
      const i = this.range.extractContents();
      this.flattenSpans(i),
  ...
  flattenSpans(e) {
    (e instanceof DocumentFragment || e instanceof Element) &&
      e.querySelectorAll("span.cdx-background-color-picker").forEach((i) => {
        if (i.parentNode) {
          const s = document.createTextNode(i.textContent || "");
          i.parentNode.replaceChild(s, i);
        }
  ...
  checkState() {
    ...
    if (
      (e || ((this.currentColor = "transparent"), this.updateToolboxIcon()), e)
    ) {
  ...
  updateToolboxIcon() {
    this.button &&
      ...
      (this.currentColor !== "transparent" || !this.currentColor) &&
  ...
  static get sanitize() {
    return { span: { class: co.CSS, style: !0 } };
  }
};
co.isInline = !0;
let Fn = co;
const lo = class lo {
  ...
  customSurround(e) {
    const o = this.api.selection.findParentTag(this.tag, lo.CSS);
    o ? this.unwrap(o) : this.wrap(e), (this.currentColor = e);
  }
  wrap(e) {
    const o = document.createElement(this.tag);
    if (
      (o.classList.add(lo.CSS),
      e && ((o.style.color = e), (this.currentColor = e)),
      this.range)
    ) {
      const i = this.range.extractContents();
      this.flattenSpans(i),
  ...
  flattenSpans(e) {
    (e instanceof DocumentFragment || e instanceof Element) &&
      e.querySelectorAll("span.cdx-color-picker").forEach((i) => {
        if (i.parentNode) {
          const s = document.createTextNode(i.textContent || "");
          i.parentNode.replaceChild(s, i);
        }
  ...
  static get sanitize() {
    return { span: { class: lo.CSS, style: !0 } };
  }
};
lo.isInline = !0;
let Lt = lo;
const uo = class uo {
  ...
  surround(e) {
    if (!e) return;
    const o = this.api.selection.findParentTag(this.tag, uo.CSS);
    o ? this.unwrap(o) : this.wrap(e);
  }
  wrap(e) {
    const o = document.createElement(this.tag);
    o.classList.add(uo.CSS),
      o.appendChild(e.extractContents()),
      e.insertNode(o),
      this.api.selection.expandToTag(o);
  }
...
const ch = {
  ...
  quote: { class: Ds, inlineToolbar: [] },
  list: { class: Kp, inlineToolbar: [] },
  unifiedImage: Bt,
  video: ah,
  iframe: Tp,
  file: Op,
...
var lh = {
    code: ({ data: t }) => `<pre><code>${t.code}</code></pre>`,
    embed: ({ data: t }) => {
      const e = t.service;
      return e === "vimeo"
        ? `<iframe src="${t.embed}" height="${t.height}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>`
        : e === "youtube"
        ? `<iframe width="${t.width}" height="${t.height}" src="${t.embed}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`
        : (console.error(
            "[editorjs-html]: Only Youtube & Vimeo embeds are available by default. Write your own embed parser for other options."
          ),
          "");
    },
    header: ({ data: t }) => `<h${t.level}>${t.text}</h${t.level}>`,
    image: ({ data: t }) => {
      var o;
      const e = t.caption ? t.caption : "Image";
      return `<img src="${
        ((o = t == null ? void 0 : t.file) == null ? void 0 : o.url) ||
        (t == null ? void 0 : t.url)
      }" alt="${e}" />`;
    },
    list: ({ data: t }) => {
      const e = t.style === "unordered" ? "ul" : "ol",
        o = (i, s) => {
          const n = i.map((r) => {
            var c;
            ...
            let a = "";
            return (
              (c = r.items) != null && c.length && (a = o(r.items, s)),
              r.content ? `<li>${r.content}${a}</li>` : void 0
            );
          });
          return `<${s}>${n.join("")}</${s}>`;
        };
    ...
    paragraph: ({ data: t }) => {
      ...
      return e
        ? `<p style="text-align:${e}"> ${t.text} </p>`
        : `<p>${t.text}</p>`;
    },
    quote: ({ data: t }) => `<blockquote>${t.text}</blockquote> - ${t.caption}`,
    delimiter: ({ data: t }) => "<br/>",
  },
  dh = (t = {}, e = { strict: !1 }) => {
    const o = { ...lh, ...t };
...
const hh = R.memo(({ value: t, onChange: e }) => {
  const { setEditor: o } = he(),
    i = R.useRef(null),
    s = R.useRef(null);
  R.useEffect(() => {
    const r = (a) => {
  ...
  const n = async (r) => {
    ...
    const c = await a.save(),
      l = document.querySelectorAll(".ce-block.block--selected"),
      d = Array.from(document.querySelectorAll(".ce-block"));
    l.forEach((p) => {
      var m;
      const u = d.indexOf(p),
        g = (m = c.blocks[u]) == null ? void 0 : m.data;
      if (g) {
        const f = {
          ...g,
          align: r,
          realText: g.realText || g.text || "",
          letterSpacing: g.letterSpacing ?? "normal",
          lineHeight: g.lineHeight ?? "normal",
          isBold: g.isBold ?? !1,
          isItalic: g.isItalic ?? !1,
          fontSize: g.fontSize ?? "",
          fontFamily: g.fontFamily ?? "",
        };
        a.blocks.update(u.toString(), f), a.caret.setToBlock(u, "end");
      }
    });
  };
  return (
    ...
    R.useEffect(() => {
      if (!i.current) {
        const r = new xp({
          ...
          data: t || void 0,
          onReady: async () => {
            const a = document.querySelector(".codex-editor__redactor");
            a && ((a.style.paddingBottom = "0px"), (a.style.padding = "20px"));
            const c = new Bp({ editor: r });
            c.initialize(t || void 0),
              (s.current = c),
              new Ep(r),
              o(r),
              document.addEventListener("keydown", (d) => {
                ...
                (d.ctrlKey || d.metaKey) &&
                  d.shiftKey &&
                  d.key.toLowerCase() === "z" &&
                  (d.preventDefault(), (p = s.current) == null || p.redo());
              });
    ...
    v.jsx(vd, { id: "editorjs", style: { cursor: "pointer" } })
  );
});
var ka = {
    color: void 0,
  ...
  Mn = R.createContext && R.createContext(ka),
  mh = ["attr", "size", "title"];
function vh(t, e) {
  if (t == null) return {};
  var o = fh(t, e),
...
function Pi(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? Dn(Object(o), !0).forEach(function (i) {
          _h(t, i, o[i]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(o))
      : Dn(Object(o)).forEach(function (i) {
...
function wa(t) {
  return (
    t &&
    t.map((e, o) => R.createElement(e.tag, Pi({ key: o }, e.attr), wa(e.child)))
  );
}
function je(t) {
  return (e) =>
    R.createElement(kh, Ti({ attr: Pi({}, t.attr) }, e), wa(t.child));
}
function kh(t) {
  var e = (o) => {
    var { attr: i, size: s, title: n } = t,
      r = vh(t, mh),
      a = s || o.size || "1em",
      c;
    return (
      o.className && (c = o.className),
      ...
      R.createElement(
        ...
        Ti(
          ...
          {
            className: c,
            style: Pi(Pi({ color: t.color || o.color }, o.style), t.style),
            height: a,
            width: a,
  ...
  return Mn !== void 0
    ? R.createElement(Mn.Consumer, null, (o) => e(o))
    : e(ka);
}
function Rn(t) {
  return je({
    ...
    child: [
      {
        tag: "path",
        attr: {
          d: "M6.19983 14H8.3539L9.55389 11H14.4458L15.6458 14H17.7998L12.9998 2H10.9998L6.19983 14ZM11.9998 4.88517 13.6458 9H10.3539L11.9998 4.88517ZM3 16V22L5 22 4.99992 20H18.9999L19 22 21 22 20.9999 16H18.9999V18H4.99992L5 16 3 16Z",
        },
        child: [],
      },
    ],
...
function zh() {
  const {
    ...
    g = [
      { label: "본문", tag: "paragraph", icon: v.jsx(Rn, {}) },
      { label: "제목", tag: "h1", icon: v.jsx(xh, {}) },
      { label: "인용구", tag: "blockquote", icon: v.jsx(Bh, {}) },
      { label: "리스트", tag: "ul", icon: v.jsx(Eh, {}) },
    ],
    m = ["1", "1.5", "1.75", "2", "2.5", "3"],
    f = ["normal", "0.5px", "1px", "1.5px", "2px"],
    [x, w] = R.useState(!1),
    [b, T] = R.useState(""),
    [O, A] = R.useState({ top: 40, left: 400 }),
    B = {
      fontSize: R.useRef(null),
      fontFamily: R.useRef(null),
      fontColor: R.useRef(null),
      backgroundColor: R.useRef(null),
      blockType: R.useRef(null),
      letterSpacing: R.useRef(null),
      lineHeight: R.useRef(null),
      link: R.useRef(null),
    },
    I = (y) => {
      var E;
      if (n === y) r(null);
        ...
        if ($ != null && $.current) {
          const q = $.current.getBoundingClientRect(),
            V =
              (E = $.current.offsetParent) == null
                ? void 0
                : E.getBoundingClientRect();
          V && c({ top: 40, left: q.left - V.left });
        }
        r(y);
      }
    },
    S = (y) => {
      t &&
        e.forEach((E) => {
          const $ = document.querySelector(`.ce-block[data-id='${E}']`);
          if (!$) return;
          const q = document.querySelectorAll(".ce-block"),
            V = Array.from(q).indexOf($),
            K = t.blocks.getBlockByIndex(V);
          if ((K == null ? void 0 : K.name) === "paragraph") {
            const ve = K.holder.querySelector(".ce-paragraph");
            if (!ve) return;
            const te = ve.innerHTML.trim(),
              X = y(te);
            (ve.innerHTML = X), t.blocks.update(E, { ...K.data, text: X });
          }
        });
    },
    k = (y) => {
      S((E) => {
        const $ = E.replace(/<[^>]+>/g, "");
        return y === "paragraph"
          ? `<div class="ce-paragraph" contenteditable="true">${$}</div>`
          : y === "blockquote"
          ? `<blockquote class="cdx-input cdx-quote__text blockquote_type1" contenteditable="true">${$}</blockquote>`
          : y === "ul"
          ? `<ul class="cdx-block cdx-list cdx-list--unordered" contenteditable="true"><li class="cdx-list__item">${$}</li></ul>`
          : `<h1 class="ce-header">${$}</h1>`;
      });
    },
    L = () => {
      var E;
      const y =
        (E = B.link.current) == null ? void 0 : E.getBoundingClientRect();
      y &&
        A({
    ...
    C = async (y, E) => {
      if (!t) return;
      const q = `<span style="display: inline-block; word-break: break-word;"><a href="${
          y.startsWith("http://") || y.startsWith("https://")
            ? y
            : `https://${y}`
        }" target="_blank" rel="noopener noreferrer">${E}</a></span>`,
        V = t.blocks.getBlocksCount();
      t.blocks.insert(
        "paragraph",
        {
          text: q,
    ...
    P = (y, E, $) => {
      ...
      const q = window.getSelection(),
        V = q && q.rangeCount > 0 && !q.isCollapsed && q.toString().length > 0,
        K = (te) => {
          const X = te.parentNode;
          for (; te.firstChild; ) X.insertBefore(te.firstChild, te);
          X.removeChild(te);
        };
      if (V) {
        const te = q.getRangeAt(0),
          X = te.extractContents(),
          ye = document.createElement("div");
        ye.appendChild(X),
          E && ye.querySelectorAll(`span[${E}]`).forEach((J) => K(J));
        const be = document.createElement("span");
        Object.entries(y).forEach(([ae, J]) => {
          J && (be.style[ae] = J);
        }),
          E && $ && be.setAttribute(E, $),
          (be.innerHTML = ye.innerHTML);
        const le = (ve = q.anchorNode) == null ? void 0 : ve.parentElement,
          ke = le && E && le.getAttribute(E) && le.textContent === q.toString(),
          Ce = !!E && (le == null ? void 0 : le.getAttribute(E)) === $;
        if ((te.deleteContents(), Ce))
          te.insertNode(document.createTextNode(q.toString()));
        else if (ke && le)
          le.setAttribute(E, $),
            Object.entries(y).forEach(([ae, J]) => {
              J && (le.style[ae] = J);
          ...
          if (
            (te.insertNode(be),
            le && E && le.getAttribute(E) && le.contains(be))
          ) {
            const J = le,
              $e = [],
              qe = [];
            let Be = !1;
            if (
              (J.childNodes.forEach((Ve) => {
                if (Ve === be) {
                  Be = !0;
                  return;
                }
                Be ? qe.push(Ve) : $e.push(Ve);
              }),
              (J.innerHTML = ""),
              $e.forEach((Ve) => J.appendChild(Ve)),
              J.parentNode.insertBefore(be, J.nextSibling),
              qe.length > 0)
            ) {
              const Ve = J.cloneNode(!1);
              qe.forEach((Vi) => Ve.appendChild(Vi)),
                J.parentNode.insertBefore(Ve, be.nextSibling);
            }
            J.textContent || J.parentNode.removeChild(J);
          }
          q.removeAllRanges();
          const ae = document.createRange();
          ae.selectNodeContents(be), q.addRange(ae);
        }
      } else
        S((te) => {
          const X = document.createElement("div");
          X.innerHTML = te;
          const ye = X.querySelector(`span[${E}]`);
          if (
            ye &&
            ye.parentElement === X &&
            ...
            return K(ye), X.innerHTML;
          X.querySelectorAll(`span[${E}]`).forEach((Ce) => K(Ce));
          const ke = document.createElement("span");
          return (
            Object.entries(y).forEach(([Ce, ae]) => {
              ae && (ke.style[Ce] = ae);
            }),
            E && $ && ke.setAttribute(E, $),
            (ke.innerHTML = X.innerHTML),
            ke.outerHTML
          );
        });
    },
      ...
      v.jsxs(Ne, {
        ...
        children: [
          v.jsxs(Me, {
            ref: B.blockType,
            onClick: () => I("blockType"),
            children: [v.jsx(Rn, {}), v.jsx(no, {})],
          }),
          v.jsx(Fe, { className: "tooltip", children: "블록 타입" }),
          n === "blockType" &&
            v.jsx(ai, {
              top: a.top,
              left: a.left,
      ...
      v.jsxs(Ne, {
        ...
        children: [
          v.jsxs(Me, {
            ...
            children: [v.jsx(jh, {}), v.jsx(no, {})],
          }),
          v.jsx(Fe, { className: "tooltip", children: "폰트 선택" }),
        ],
      }),
      N("fontFamily", d, "fontFamily", "data-font-family", (y) => ({
        fontFamily: y,
      })),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
        ...
        children: [
          v.jsxs(Me, {
            ref: B.fontSize,
            onClick: () => I("fontSize"),
            children: [v.jsx(Ph, {}), v.jsx(no, {})],
          }),
          v.jsx(Fe, { className: "tooltip", children: "글자 크기" }),
        ],
      }),
      N("fontSize", l, "fontSize", "data-font-size"),
      v.jsx(zn, {}),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
          y.preventDefault(), y.stopPropagation();
        ...
        children: [
          v.jsx(Me, {
            onClick: () => P({ fontWeight: "bold" }, "data-bold", "true"),
            children: v.jsx(wh, {}),
          }),
          v.jsx(Fe, { className: "tooltip", children: "굵게" }),
        ],
      }),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
        ...
        children: [
          v.jsx(Me, {
            onClick: () => P({ fontStyle: "italic" }, "data-italic", "true"),
            children: v.jsx(Sh, {}),
          }),
          v.jsx(Fe, { className: "tooltip", children: "기울임꼴" }),
        ],
      }),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
        ...
        children: [
          v.jsx(Me, {
            onClick: () =>
              P({ textDecoration: "underline" }, "data-underline", "true"),
            children: v.jsx(Ih, {}),
          }),
          v.jsx(Fe, { className: "tooltip", children: "밑줄" }),
        ],
      }),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
        ...
        children: [
          ...
          v.jsx(Fe, { className: "tooltip", children: "취소선" }),
        ],
      }),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
        ...
        children: [
          ...
          v.jsx(Fe, { className: "tooltip", children: "글자 색상" }),
          n === "fontColor" &&
            v.jsx(ai, {
              top: a.top,
              left: a.left,
      ...
      v.jsxs(Ne, {
        ...
        children: [
          v.jsxs(Me, {
            ...
            children: [v.jsx(Ch, {}), v.jsx(no, {})],
          }),
          v.jsx(Fe, { className: "tooltip", children: "배경 색상" }),
          n === "backgroundColor" &&
            v.jsx(ai, {
              top: a.top,
              left: a.left,
              children: v.jsx($n, {
                colors: p,
                onSelect: (y) => {
                  P({ backgroundColor: y }, "data-bg", y), r(null);
                },
              }),
            }),
        ],
      ...
      v.jsxs(Ne, {
        ...
        children: [
          v.jsxs(Me, {
            ...
            children: [v.jsx(Lh, {}), v.jsx(no, {})],
          }),
          v.jsx(Fe, { className: "tooltip", children: "자간 설정" }),
          N("letterSpacing", f, "letterSpacing", "data-letter-spacing"),
        ],
      }),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
        ...
        children: [
          v.jsxs(Me, {
            ...
            children: [v.jsx(Oh, {}), v.jsx(no, {})],
          }),
          v.jsx(Fe, { className: "tooltip", children: "줄 간격 설정" }),
          N("lineHeight", m, "lineHeight", "data-line-height"),
        ],
      }),
      v.jsxs(Ne, {
        onMouseDown: (y) => {
        ...
        children: [
          v.jsx(Me, {
            onClick: L,
            children: x ? v.jsx(Hn, { color: "#1aff00" }) : v.jsx(Hn, {}),
          }),
          v.jsx(Fe, { className: "tooltip", children: "링크 추가" }),
        ],
      }),
      x &&
        v.jsxs(Mh, {
...
function Uh({ value: t, onUpload: e, width: o, onChange: i }) {
  const s = R.useRef(null),
    [n, r] = R.useState(0),
    { editor: a, setSelectedBlockIds: c } = he();
  return (
    R.useEffect(() => {
      const l = () => {
        if (s.current) {
    ...
    R.useEffect(() => {
      ...
      const d = (u) => {
        ...
        p = (u) => {
          const g = u.target.closest(".ce-block");
          if (!l || !g) return;
          const m = Array.from(document.querySelectorAll(".ce-block")),
            f = m.indexOf(l),
            x = m.indexOf(g);
          if (f === -1 || x === -1) return;
          const [w, b] = [Math.min(f, x), Math.max(f, x)],
            O = m
              .slice(w, b + 1)
              .map((B) => B.getAttribute("data-id"))
              .filter(Boolean);
          he.getState().setSelectedBlockIds(O),
            console.log("[정확한 드래그 선택 블럭 ID]", O);
          const A = m[b];
          if (A) {
            const B = A.getBoundingClientRect();
            he.getState().setToolbarPosition({
    ...
    v.jsxs(ol, {
      ...
      children: [
        v.jsx(zh, {}),
        v.jsx(hh, { value: t, onChange: i }),
        v.jsx(md, { toolbarTop: n, onUpload: e, width: o }),
      ],
    })
  );
}
const qh = { EditorSection: Uh, useEditorStore: he };
module.exports = qh;
